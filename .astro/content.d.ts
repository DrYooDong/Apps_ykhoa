...
declare module 'astro:content' {
	...
	type DataEntryMap = {
		"biochemistry": Record<string, {
  id: string;
  body?: string;
  collection: "biochemistry";
  data: InferEntrySchema<"biochemistry">;
  rendered?: RenderedContent;
  filePath?: string;
  digest?: string | number;
}>;
"epidemiology": Record<string, {
  id: string;
  body?: string;
  collection: "epidemiology";
  data: InferEntrySchema<"epidemiology">;
  rendered?: RenderedContent;
  filePath?: string;
  digest?: string | number;
}>;
...
"pathophysiology": Record<string, {
  id: string;
  body?: string;
  collection: "pathophysiology";
  data: InferEntrySchema<"pathophysiology">;
  rendered?: RenderedContent;
  filePath?: string;
  digest?: string | number;
}>;
"physiology": Record<string, {
  id: string;
  body?: string;
  collection: "physiology";
  data: InferEntrySchema<"physiology">;
  rendered?: RenderedContent;
  filePath?: string;
  digest?: string | number;
}>;
