---
name: swift-protocol-based-dependency-injection-for-testing
description: Dependency Injection dựa trên Protocol cho Swift: trừu tượng hóa I/O, file system, network để viết unit test độc lập và tin cậy.
---
