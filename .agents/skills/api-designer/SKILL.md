---
name: api-designer
description: Chuẩn thiết kế interface và API endpoint: Định hình cấu trúc dữ liệu, tham số đầu vào, mã phản hồi và tài liệu API nhất quán.
---
...
```json
{
  ...
  "field2": "type â€” description"
}
```

**Success Response** â€” `STATUS_CODE Description`
```json
{
  "field": "value or type"
}
...
| `404` | Not Found |
| `409` | Conflict â€” e.g. duplicate resource |
...
7. **Error codes**: List the relevant subset per endpoint â€” don't always paste all 7. Use judgement.
...
- Be **comprehensive but scannable** â€” use tables and code blocks consistently.
