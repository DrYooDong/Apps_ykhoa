...
description: Nguyên tắc nghiên cứu trước khi viết mã (Search First - Research Before You Code): Kiểm tra kho mã nguồn và giải pháp sẵn có trong dự án trước khi viết code mới.
---
