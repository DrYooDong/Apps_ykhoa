---
name: azure-cosmos-typescript-javascript
description: Sử dụng Azure Cosmos DB NoSQL SDK (@azure/cosmos) cho TypeScript/JavaScript: CRUD documents, query SQL, stored procedures và bulk operations.
---
