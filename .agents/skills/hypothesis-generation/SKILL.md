...
description: Khung tạo lập và kiểm thử giả thuyết khoa học: Cấu trúc IF [Hành động/Can thiệp] - THEN [Kết quả lâm sàng] - BECAUSE [Cơ chế bệnh sinh/Dược lý].
---
