...
description: Mẫu thiết kế quản lý trạng thái, lưu trữ bền vững (Atomic JSON/localStorage), xử lý crash-recovery và đồng bộ dữ liệu người dùng không phụ thuộc framework.
---
