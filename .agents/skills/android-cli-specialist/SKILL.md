---
name: android-cli-specialist
description: Chuyên gia CLI Android: tạo project, build gradle, tương tác thiết bị adb, chụp màn hình và triển khai ứng dụng Android.
---
