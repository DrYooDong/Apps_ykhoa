...
description: Build high-performance content-driven websites, blogs, documentation, and web apps with Astro (.astro components, Content Collections, Islands architecture, and MDX).
---
