...
description: Trích xuất tri thức có cấu trúc từ AI và tài liệu (Knowledge Extraction): Chuẩn hóa các thực thể y khoa (bệnh học, triệu chứng, thuốc, phác đồ) thành kho dữ liệu nguyên tử.
---
