---
name: api-sdk-codegen
description: Sinh mã tự động SDK và thư viện wrapper: Tạo client code chuẩn TypeScript/JavaScript kết nối các dịch vụ dữ liệu y tế.
---
...
```
sdk/
â”œâ”€â”€ client.{ext}          â€” main client class with base URL, auth, retry
â”œâ”€â”€ resources/
â”‚   â”œâ”€â”€ users.{ext}       â€” one file per API resource
â”‚   â”œâ”€â”€ orders.{ext}
â”‚   â””â”€â”€ ...
â”œâ”€â”€ models/
â”‚   â”œâ”€â”€ user.{ext}        â€” request/response data models
â”‚   â””â”€â”€ ...
â”œâ”€â”€ errors.{ext}          â€” typed error classes
â””â”€â”€ utils/
    â”œâ”€â”€ retry.{ext}
    â””â”€â”€ pagination.{ext}
```
