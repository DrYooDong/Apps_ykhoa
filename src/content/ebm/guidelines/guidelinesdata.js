    ...
    const SAMPLE_STUDIES = [
...

      {
        ...
        detailedConclusion: "",
        sourceUrl: "",
        file: "kho-guidelines/tom-tat-huong-dan-byt-vgsvb-2026.html",
        asianData: true,
        bookmarked: false
      },

      {
        id: "study_TÓM TẮT HƯỚNG DẪN BYT VGSVB 2026",
        title: "Tóm tắt Hướng Dẫn Lâm Sàng",
        drug: "",
        sourceType: "intl-guideline",
        specialty: "infect",
        ...
        detailedConclusion: "",
        sourceUrl: "",
        file: "kho-guidelines/TÓM TẮT HƯỚNG DẪN BYT VGSVB 2026.html",
        asianData: true,
        bookmarked: false
      },
...

      {
        ...
        specialty: "pulmo",
        design: "guideline",
        grade: { strength: "strong-for", certainty: "moderate" },
        pico: {
          population: "",
        ...
        statistics: { type: "HR", value: 0.85, ciLower: 0.70, ciUpper: 0.95, pValue: 0.04 },
      ...
      },
      {
        ...
        pico: {
          ...
          comparator: "Standard of Care / Placebo",
          outcome: "Tỷ lệ chậm nhịp tim nặng, block AV độ II/III và nhập viện do suy tim cấp"
        },
        statistics: { type: "HR", value: 0.85, ciLower: 0.70, ciUpper: 0.95, pValue: 0.04 },
        vnAdaptationStatus: "adapted",
        oldKeyResults: "HR 2.45 (95% CI 1.80-3.34, p<0.001) — Nguy cơ block AV độ III tăng gấp 2.45 lần khi phối hợp Metoprolol + Verapamil",
        impact: "practice-changing",
        year: 2026,
      ...
      },
      {
        ...
        pico: {
          ...
          comparator: "Standard of Care / Placebo",
          outcome: "Tiến triển suy thận giai đoạn cuối (ESRD), giảm eGFR >= 50% hoặc tử vong tim mạch"
        },
        statistics: { type: "HR", value: 0.85, ciLower: 0.70, ciUpper: 0.95, pValue: 0.04 },
        vnAdaptationStatus: "adapted",
        oldKeyResults: "HR 0.64 (95% CI 0.52-0.79, p<0.001) — Phối hợp SGLT2i + Finerenone giảm 36% biến cố thận-tim mạch",
        impact: "practice-changing",
        year: 2026,
      ...
      },
      {
        ...
        pico: {
          ...
          comparator: "Standard of Care / Placebo",
          outcome: "Cải thiện tử vong tim mạch và giảm nhập viện do suy tim"
        },
        statistics: { type: "HR", value: 0.85, ciLower: 0.70, ciUpper: 0.95, pValue: 0.04 },
        vnAdaptationStatus: "adapted",
        oldKeyResults: "Khuyến cáo mức chỉ định Class I (Bằng chứng A)",
        impact: "practice-changing",
        year: 2023,
      ...
      },
      {
        ...
        pico: {
          ...
          comparator: "Standard of Care / Placebo",
          outcome: "Kiểm soát HbA1c và bảo vệ tim mạch/thận"
        },
        statistics: { type: "HR", value: 0.85, ciLower: 0.70, ciUpper: 0.95, pValue: 0.04 },
        vnAdaptationStatus: "adapted",
        oldKeyResults: "Phác đồ ưu tiên hàng đầu cho bệnh nhân kèm suy tim, bệnh thận mạn",
        impact: "practice-changing",
        year: 2020,
        organization: "Bộ Y tế Việt Nam",
        phase: "Guidelines",
