    ...
    const SAMPLE_STUDIES = [
      ...
      },
      {
        ...
        primaryEndpoint: "Giảm tỷ lệ tử vong do mọi nguyên nhân, tử vong tim mạch, đột quỵ, suy tim và bảo vệ chức năng thận / ngăn ngừa sa sút trí tuệ",
        keyResults: "Thay thế Hướng dẫn 2017: Đưa vào thang điểm PREVENT thay PCEs; Ưu tiên viên phối hợp SPC; Đồng thuận RDN cho HA kháng trị Độ 2; Bãi bỏ thuật ngữ Hypertensive Urgency thay bằng Severe HTN; Hạ áp khẩn thai kỳ trong 30-60 phút",
        impact: "practice-changing",
        year: 2025,
      ...
      },
      {
        ...
        primaryEndpoint: "Dự phòng đột quỵ thiếu máu não, giảm biến cố thuyên tắc mạch, kiểm soát triệu chứng mEHRA và cải thiện chất lượng sống/tỷ lệ tử vong",
        keyResults: "Thay thế ESC 2020: Đưa ra thang điểm CHA2DS2-VA (OAC khi >= 2 điểm Class I, 1 điểm Class IIa); Nâng triệt đốt AF kịch phát lên Class I hàng đầu; SGLT2i cho suy tim kèm AF bất kể LVEF; Ngừng Aspirin sớm <= 1 tuần sau PCI",
        impact: "practice-changing",
        year: 2024,
      ...
      },
      {
        ...
        primaryEndpoint: "Cắt cơn sốt nhanh, tiệt căn ký sinh trùng, hạn chế lây lan dịch tễ và phòng ngừa tử vong do sốt rét ác tính",
        keyResults: "Thay thế các hướng dẫn cũ: Chọn Pyramax 3 ngày làm ưu tiên số 1 cho P.f và P.v; Primaquin 1 liều cho P.f và 7-14 ngày cho P.v/P.o (chống chỉ định G6PD/thai kỳ); Artesunat tiêm TM/bắp cho Sốt rét ác tính",
        impact: "practice-changing",
        year: 2023,
      ...
      },
      {
        ...
        primaryEndpoint: "Loại bỏ hoàn toàn các vụ dịch vi khuẩn, giảm 50% số ca mắc và 70% số ca tử vong do các tác nhân có thể phòng bằng vắc-xin, giảm tối đa di chứng tàn tật thính lực và nhận thức",
        keyResults: "1-hour window tiêu chuẩn vàng khởi đầu kháng sinh TM. Ceftriaxone/Cefotaxime làm hàng đầu; thêm Ampicillin ở người >60t/suy giảm miễn dịch (Listeria); thêm Vancomycin nếu phế cầu kháng thuốc. Dexamethasone TM 0.15 mg/kg q6h x 4 ngày tiêm trước/đồng thời liều kháng sinh 1. Chống chỉ định CT thường quy & Glycerol uống. Sàng lọc thính lực bắt buộc trước xuất viện.",
        impact: "practice-changing",
        year: 2025,
