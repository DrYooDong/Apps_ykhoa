...
const CLINICAL_CONDITIONS = {
  'heart-failure': { id: 'heart-failure', name: 'Suy tim', icd10: ['I50', 'I50.1', 'I50.9'], icon: '🫀', color: '#dc2626', bg: '#fef2f2' },
  'diabetes-t2d': { id: 'diabetes-t2d', name: 'Đái tháo đường Tip 2', icd10: ['E11', 'E11.9', 'E11.2'], icon: '🩸', color: '#7c3aed', bg: '#faf5ff' },
  ...
  'hemorrhagic-fever': { id: 'hemorrhagic-fever', name: 'Sốt xuất huyết (Marburg/Ebola/Nipah)', icd10: ['A98.3', 'A98.4', 'A98'], icon: '⚠️', color: '#be185d', bg: '#fce7f3' },
  'icu': { id: 'icu', name: 'Nhiễm trùng Hồi sức (ICU)', icd10: ['A41', 'R65.2'], icon: '💉', color: '#059669', bg: '#ecfdf5' }
};
