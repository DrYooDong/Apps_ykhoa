...
<ul style="margin-left: 1.25rem; margin-bottom: 1rem; line-height: 1.65;">
          ...
          <div class="clin-card">
            <div class="clin-card-accent" style="background: var(--purple);"></div>
...
<ul style="margin-left: 1.25rem; margin-bottom: 1rem; line-height: 1.65;">
          ...
          <div class="clin-card">
            <div class="clin-card-accent" style="background: var(--teal);"></div>
...
<ul style="margin-left: 1.25rem; margin-bottom: 1rem; line-height: 1.65;">
          ...
          <div class="clin-card">
            <div class="clin-card-accent" style="background: var(--orange);"></div>
...
<ul style="margin-left: 1.25rem; margin-bottom: 1rem; line-height: 1.65;">
        ...
        <div class="diagram-container">
          <svg viewBox="0 0 940 380" width="100%" height="100%" style="max-width: 900px; font-family: 'Plus Jakarta Sans', sans-serif;">
            ...
            <text x="140" y="145" font-size="12" font-weight="700" fill="var(--text)" text-anchor="middle">Gen mecA (Đảo SCCmec)</text>
            <text x="140" y="165" font-size="11" fill="var(--text-muted)" text-anchor="middle">Mã hóa protein biến đổi PBP2a</text>
            ...
            <text x="340" y="145" font-size="12" font-weight="700" fill="var(--text)" text-anchor="middle">Gen mecC (Đồng dạng 69%)</text>
            <text x="340" y="165" font-size="11" fill="var(--text-muted)" text-anchor="middle">Mã hóa PBP2a biến thể</text>
            ...
            <text x="615" y="145" font-size="12" font-weight="700" fill="var(--text)" text-anchor="middle">BORSA (Borderline)</text>
            <text x="615" y="165" font-size="11" fill="var(--text-muted)" text-anchor="middle">Tăng tiết quá mức &amp;beta;-lactamase</text>
            ...
            <text x="805" y="145" font-size="12" font-weight="700" fill="var(--text)" text-anchor="middle">MOD-SA (Modified)</text>
            <text x="805" y="165" font-size="11" fill="var(--text-muted)" text-anchor="middle">Đột biến gdpP/yjbH &amp;rarr; Tăng PBP4</text>
            ...
            <text x="240" y="282" font-size="11" font-weight="600" fill="var(--text)" text-anchor="middle">Kháng toàn bộ Penicillin chống tụ cầu &amp; Cephalosporin thế hệ 1–4</text>
            ...
            <text x="140" y="356" font-size="10" fill="var(--text-muted)" text-anchor="middle">Kháng Oxacillin &amp; Cefoxitin</text>
            ...
            <text x="710" y="292" font-size="11" fill="var(--text)" text-anchor="middle">&amp;bull; Sử dụng CEFOXITIN làm chất cảm ứng tốt nhất</text>
            <text x="710" y="312" font-size="11" fill="var(--text)" text-anchor="middle">&amp;bull; Phát hiện chính xác cả mecA và mecC</text>
            <text x="710" y="332" font-size="11" fill="var(--text)" text-anchor="middle">&amp;bull; Cefoxitin kích thích biểu hiện gen PBP2a mạnh mẽ</text>
...
<ul style="margin-left: 1.25rem; margin-bottom: 1rem; line-height: 1.65;">
          ...
          <div class="clin-card">
            <div class="clin-card-accent" style="background: var(--green);"></div>
      ...
      <div class="sec-body">
        <div class="diagram-container">
          <svg viewBox="0 0 960 520" width="100%" height="100%" style="max-width: 940px; font-family: 'Plus Jakarta Sans', sans-serif;">
            ...
            <text x="120" y="165" font-size="10.5" fill="var(--text-muted)" text-anchor="middle">Mủ hoại tử, tụ cầu vàng</text>

            <path d="M 120 180 L 120 210" fill="none" stroke="#d97706" stroke-width="2"/>
            <rect x="25" y="210" width="190" height="90" rx="8" fill="var(--surface-2)" stroke="var(--border)" stroke-width="1"/>
            <text x="120" y="232" font-size="11" font-weight="700" fill="#dc2626" text-anchor="middle">RẠCH DẪN LƯU NGOẠI KHOA</text>
            <text x="120" y="252" font-size="10" fill="var(--text-muted)" text-anchor="middle">&amp;bull; Áp-xe nông: Dẫn lưu là đủ</text>
            <text x="120" y="270" font-size="10" fill="var(--text-muted)" text-anchor="middle">&amp;bull; Lan tỏa/Nặng: KS uống/IV</text>
            ...
            <text x="360" y="165" font-size="10.5" fill="var(--text-muted)" text-anchor="middle">Hoại tử PVL, sau cúm</text>

            <path d="M 360 180 L 360 210" fill="none" stroke="#2563eb" stroke-width="2"/>
            <rect x="265" y="210" width="190" height="90" rx="8" fill="var(--surface-2)" stroke="var(--border)" stroke-width="1"/>
            <text x="360" y="232" font-size="11" font-weight="700" fill="#2563eb" text-anchor="middle">LINEZOLID HOẶC VANCO</text>
            <text x="360" y="252" font-size="10" fill="var(--text-muted)" text-anchor="middle">&amp;bull; Linezolid 600mg q12h (Ưu tiên)</text>
            <text x="360" y="270" font-size="10" fill="var(--text-muted)" text-anchor="middle">&amp;bull; Vanco (AUC/MIC 400–600)</text>
            ...
            <text x="600" y="165" font-size="10.5" fill="var(--text-muted)" text-anchor="middle">Nguy cơ sùi van, di căn</text>

            <path d="M 600 180 L 600 210" fill="none" stroke="#dc2626" stroke-width="2"/>
            <rect x="505" y="210" width="190" height="90" rx="8" fill="var(--surface-2)" stroke="var(--border)" stroke-width="1"/>
            <text x="600" y="232" font-size="11" font-weight="700" fill="#dc2626" text-anchor="middle">DAPTOMYCIN HOẶC VANCO</text>
            <text x="600" y="252" font-size="10" fill="var(--text-muted)" text-anchor="middle">&amp;bull; Dapto 8–10 mg/kg/ngày</text>
            <text x="600" y="270" font-size="10" fill="var(--text-muted)" text-anchor="middle">&amp;bull; Siêu âm tim TTE/TEE bắt buộc</text>
            ...
            <text x="840" y="165" font-size="10.5" fill="var(--text-muted)" text-anchor="middle">Biofilm, tiêu xương RANKL</text>

            <path d="M 840 180 L 840 210" fill="none" stroke="#7c3aed" stroke-width="2"/>
            <rect x="745" y="210" width="190" height="90" rx="8" fill="var(--surface-2)" stroke="var(--border)" stroke-width="1"/>
            <text x="840" y="232" font-size="11" font-weight="700" fill="#7c3aed" text-anchor="middle">PHẪU THUẬT &amp; KHÁNG SINH</text>
            <text x="840" y="252" font-size="10" fill="var(--text-muted)" text-anchor="middle">&amp;bull; Nạo viêm / Tháo bỏ khớp</text>
            <text x="840" y="270" font-size="10" fill="var(--text-muted)" text-anchor="middle">&amp;bull; Vanco / Dapto / Ceftobiprole</text>
            <text x="840" y="288" font-size="10" fill="var(--text-muted)" text-anchor="middle">&amp;bull; Liệu trình dài 6–12 tuần</text>

            
            <path d="M 120 300 L 120 330 L 480 330" fill="none" stroke="var(--border)" stroke-width="1.5"/>
            <path d="M 360 300 L 360 330 L 480 330" fill="none" stroke="var(--border)" stroke-width="1.5"/>
            <path d="M 600 300 L 600 330 L 480 330" fill="none" stroke="var(--border)" stroke-width="1.5"/>
            <path d="M 840 300 L 840 330 L 480 330" fill="none" stroke="var(--border)" stroke-width="1.5"/>
            <path d="M 480 330 L 480 360" fill="none" stroke="#059669" stroke-width="2.5"/>

            <rect x="180" y="360" width="600" height="135" rx="12" fill="var(--green-bg)" stroke="#059669" stroke-width="2"/>
            ...
            <text x="480" y="412" font-size="11" fill="var(--text)" text-anchor="middle">&amp;bull; <tspan font-weight="700">Cấy máu lặp lại mỗi 24–48h</tspan> cho đến khi âm tính để xác định thời điểm bắt đầu tính độ dài liệu trình.</text>
            <text x="480" y="434" font-size="11" fill="var(--text)" text-anchor="middle">&amp;bull; <tspan font-weight="700">Rút bỏ catheter tĩnh mạch</tspan> nhiễm trùng ngay khi phát hiện; dẫn lưu triệt để ổ mủ tụ.</text>
            <text x="480" y="456" font-size="11" fill="var(--text)" text-anchor="middle">&amp;bull; <tspan font-weight="700">Xuống thang đường uống:</tspan> Khi lâm sàng ổn định, hết sốt &gt;48h, không có di căn sâu (Linezolid, TMP-SMX, Clindamycin).</text>
            <text x="480" y="478" font-size="11" fill="var(--text)" text-anchor="middle">&amp;bull; <tspan font-weight="700">Khử trùng dự phòng (Decolonization):</tspan> Mupirocin tra mũi + tắm Chlorhexidine ở bệnh nhân tái phát hoặc phòng ICU.</text>
          </svg>
    ...
    <div class="sec-card" id="sec-citation">
      ...
      <div class="sec-body">
        ...
        <div class="btn-row">
          ...
          <a href="../../../docspace/tools/scores/antibiotic-dosing.ts" class="btn">
            <i class="fa-solid fa-calculator"></i> Công Cụ Tính Liều Vancomycin &amp; Kháng Sinh
          </a>
          <a href="../../../ebm/ebm.html" class="btn">
