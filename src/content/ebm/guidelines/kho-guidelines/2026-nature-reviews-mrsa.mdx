...
<div class="module-badge-group study-badges">
  <span class="badge badge-indigo"><i class="fa-solid fa-bacteria"></i> Nature Reviews Microbiology Synthesis</span>
  <span class="badge badge-blue"><i class="fa-solid fa-newspaper"></i> Nature Reviews Microbiology</span>
  <span class="badge badge-emerald"><i class="fa-solid fa-shield-virus"></i> Methicillin-Resistant S. aureus (MRSA)</span>
  <span class="badge badge-rose"><i class="fa-solid fa-capsules"></i> Cơ Chế Đề Kháng &amp; Kháng Sinh Mới</span>
</div>
        ...
        <div class="flowchart-editorial-card">
          <div class="flowchart-editorial-hdr">
            <div class="flowchart-editorial-title">
              <i class="fa-solid fa-dna" style="color: #7c3aed;"></i>
              <span>SƠ ĐỒ 1: CƠ CHẾ SINH HỌC PHÂN TỬ ĐỀ KHÁNG &beta;-LACTAM Ở MRSA (NATURE REVIEWS 2026)</span>
            </div>
            <span class="flow-step-badge flow-badge-purple">Mechanism Map</span>
          </div>
          <div class="flowchart-editorial-canvas">
            <svg class="med-svg" viewBox="0 0 940 380" width="100%" height="100%" style="max-width: 900px; font-family: 'Plus Jakarta Sans', sans-serif;">
            <defs>
            ...
            <rect x="50" y="240" width="380" height="55" rx="10" fill="var(--red-bg, #fef2f2)" stroke="#dc2626" stroke-width="2"/>
            ...
            <rect x="50" y="320" width="180" height="48" rx="8" fill="var(--surface, #ffffff)" stroke="#059669" stroke-width="1.5"/>
            ...
            <rect x="250" y="320" width="180" height="48" rx="8" fill="var(--surface, #ffffff)" stroke="#7c3aed" stroke-width="1.5"/>
            ...
            <rect x="530" y="240" width="360" height="128" rx="10" fill="var(--blue-bg, #eff6ff)" stroke="#2563eb" stroke-width="1.5"/>
          ...
          <div class="flowchart-legend-row">
            <div class="flowchart-legend-item"><span class="legend-dot" style="background: #dc2626;"></span> mecA / mecC &rarr; PBP2a: Giảm ái lực với hầu hết &beta;-lactam thông thường</div>
            <div class="flowchart-legend-item"><span class="legend-dot" style="background: #0284c7;"></span> Ceftaroline: &beta;-lactam thế hệ mới gắn chọn lọc và ức chế PBP2a</div>
            <div class="flowchart-legend-item"><span class="legend-dot" style="background: #f59e0b;"></span> Heteroresistance (Dị kháng): EUCAST khuyến cáo sàng lọc bằng Cefoxitin</div>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="flowchart-editorial-card">
          <div class="flowchart-editorial-hdr">
            <div class="flowchart-editorial-title">
              ...
              <span>LƯU ĐỒ THUẬT TOÁN PHÂN TẦNG ĐIỀU TRỊ &amp; KIỂM SOÁT NGUỒN LÂY MRSA (NATURE REVIEWS 2026)</span>
            </div>
            <span class="flow-step-badge flow-badge-green">Editorial SVG Studio 2.0</span>
          </div>
          <div class="flowchart-editorial-canvas">
            <svg class="med-svg" viewBox="0 0 960 540" width="100%" height="100%" style="max-width: 940px; font-family: 'Plus Jakarta Sans', sans-serif;">
            <defs>
            ...
            <text x="120" y="252" font-size="10" fill="var(--color-text-muted, #64748b)" text-anchor="middle">• Áp-xe nông: Dẫn lưu là đủ</text>
            <text x="120" y="270" font-size="10" fill="var(--color-text-muted, #64748b)" text-anchor="middle">• Lan tỏa/Nặng: KS uống/IV</text>
            ...
            <text x="360" y="252" font-size="10" fill="var(--color-text-muted, #64748b)" text-anchor="middle">• Linezolid 600mg q12h (Ưu tiên)</text>
            <text x="360" y="270" font-size="10" fill="var(--color-text-muted, #64748b)" text-anchor="middle">• Vanco (AUC/MIC 400–600)</text>
            ...
            <text x="600" y="252" font-size="10" fill="var(--color-text-muted, #64748b)" text-anchor="middle">• Dapto 8–10 mg/kg/ngày</text>
            <text x="600" y="270" font-size="10" fill="var(--color-text-muted, #64748b)" text-anchor="middle">• Siêu âm tim TTE/TEE bắt buộc</text>
            ...
            <text x="840" y="252" font-size="10" fill="var(--color-text-muted, #64748b)" text-anchor="middle">• Nạo viêm / Tháo bỏ khớp</text>
            <text x="840" y="270" font-size="10" fill="var(--color-text-muted, #64748b)" text-anchor="middle">• Vanco / Dapto / Ceftobiprole</text>
            <text x="840" y="288" font-size="10" fill="var(--color-text-muted, #64748b)" text-anchor="middle">• Liệu trình dài 6–12 tuần</text>
            ...
            <rect x="180" y="360" width="600" height="165" rx="12" fill="rgba(16, 185, 129, 0.08)" stroke="#059669" stroke-width="2"/>
            <text x="480" y="385" font-size="13" font-weight="800" fill="#065f46" text-anchor="middle">KIỂM SOÁT NGUỒN NHIỄM TRÙNG &amp; CHIẾN LƯỢC DÀI HẠN</text>
            <text x="480" y="406" font-size="11" fill="var(--color-text, #0f172a)" text-anchor="middle">• <tspan font-weight="700">Cấy máu lặp lại mỗi 24–48h</tspan> cho đến khi âm tính,</text>
            <text x="480" y="420" font-size="10.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">để xác định thời điểm bắt đầu tính độ dài liệu trình.</text>
            <text x="480" y="440" font-size="11" fill="var(--color-text, #0f172a)" text-anchor="middle">• <tspan font-weight="700">Rút bỏ catheter tĩnh mạch</tspan> nhiễm trùng ngay khi phát hiện;</text>
            <text x="480" y="454" font-size="10.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">dẫn lưu triệt để ổ mủ tụ.</text>
            <text x="480" y="474" font-size="11" fill="var(--color-text, #0f172a)" text-anchor="middle">• <tspan font-weight="700">Xuống thang đường uống:</tspan> Khi lâm sàng ổn định, hết sốt &gt;48h,</text>
            <text x="480" y="488" font-size="10.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">không có di căn sâu (Linezolid, TMP-SMX, Clindamycin).</text>
            <text x="480" y="508" font-size="11" fill="var(--color-text, #0f172a)" text-anchor="middle">• <tspan font-weight="700">Khử trùng dự phòng (Decolonization):</tspan> Mupirocin tra mũi + tắm Chlorhexidine</text>
            <text x="480" y="522" font-size="10.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">ở bệnh nhân tái phát hoặc phòng ICU.</text>
          </svg>
          </div>
          <div class="flowchart-legend-row">
            <div class="flowchart-legend-item"><span class="legend-dot" style="background: #0284c7;"></span> Phân tầng nguy cơ: Phân biệt nhiễm trùng phức tạp vs không phức tạp</div>
            <div class="flowchart-legend-item"><span class="legend-dot" style="background: #10b981;"></span> Lựa chọn kháng sinh: Vancomycin (AUC/MIC 400-600) hoặc Daptomycin liều cao</div>
            <div class="flowchart-legend-item"><span class="legend-dot" style="background: #dc2626;"></span> Can thiệp nguồn lây: Dẫn lưu ổ áp xe, rút catheter, bóc tách mô hoại tử</div>
          </div>
        </div>
      </div>
    </div>
