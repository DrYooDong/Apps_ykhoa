  ...
  <div class="sec-card" id="sec-4">
    ...
    <div class="sec-body">
      ...
      <div style="background: var(--color-surface, #ffffff); border: 1px solid var(--color-border, #cbd5e1); border-radius: 12px; padding: 1.5rem 1rem; margin-bottom: 1.5rem; overflow-x: auto;">
        <svg viewBox="0 0 1000 860" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" style="font-family: system-ui, -apple-system, sans-serif; display: block; margin: 0 auto; max-width: 1000px;">
          <defs>
            <linearGradient id="g-red-hdr" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stop-color="#dc2626" />
              <stop offset="100%" stop-color="#b91c1c" />
            </linearGradient>
            <marker id="arrow-gray" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto">
          ...
          <!-- ================= 1. ENTRY POINT ================= -->
          <!-- Top Pill: PATIENT WITH ASCVD -->
          <rect x="280" y="20" width="440" height="46" rx="23" fill="url(#g-red-hdr)" />
          <text x="500" y="49" font-size="15" font-weight="800" fill="#ffffff" text-anchor="middle" letter-spacing="0.5">
            BỆNH NHÂN ĐÃ XÁC LẬP ASCVD
          </text>

          <path d="M 500 66 L 500 95" stroke="#64748b" stroke-width="2" marker-end="url(#arrow-gray)" />

          <!-- Decision Node: Phân nhóm đặc biệt -->
          <rect x="170" y="95" width="660" height="46" rx="23" fill="var(--color-surface, #ffffff)" stroke="var(--color-danger, #dc2626)" stroke-width="2" />
          <text x="500" y="123" font-size="13" font-weight="700" fill="var(--color-text, #0f172a)" text-anchor="middle">
            ACS, HeFH, Nguy cơ cực cao, Đái tháo đường, hoặc Bất dung nạp statin?
          </text>

          <!-- Branch NO (Left) -->
          <path d="M 330 141 L 330 162" stroke="#64748b" stroke-width="2" />
          <circle cx="330" cy="172" r="13" fill="var(--color-surface, #ffffff)" stroke="#16a34a" stroke-width="2" />
          <text x="330" y="176" font-size="11" font-weight="800" fill="#16a34a" text-anchor="middle">KHÔNG</text>
          <path d="M 330 185 L 330 205" stroke="#64748b" stroke-width="2" marker-end="url(#arrow-gray)" />

          <!-- Branch YES (Right) -->
          <path d="M 670 141 L 670 162" stroke="#64748b" stroke-width="2" />
          <circle cx="670" cy="172" r="13" fill="var(--color-surface, #ffffff)" stroke="#ca8a04" stroke-width="2" />
          <text x="670" y="176" font-size="11" font-weight="800" fill="#ca8a04" text-anchor="middle">CÓ</text>
          <path d="M 670 185 L 670 205" stroke="#64748b" stroke-width="2" marker-end="url(#arrow-gray)" />

          <!-- Special Pathways Box (Right) -->
          <rect x="540" y="205" width="260" height="50" rx="10" fill="var(--color-warning-hl, #fefce8)" stroke="#ca8a04" stroke-width="1.5" />
          <text x="670" y="226" font-size="12" font-weight="800" fill="#a16207" text-anchor="middle">Phác Đồ Chuyên Biệt (Special Pathways)</text>
          <text x="670" y="243" font-size="10.5" fill="#854d0e" text-anchor="middle">Chi tiết Mục 5: Extreme Risk, SAMS, ĐTĐ ➔</text>

          <!-- Upfront Combined LLT Box (Left) -->
          <rect x="120" y="205" width="390" height="50" rx="10" fill="#fef08a" stroke="#ca8a04" stroke-width="2" />
          <text x="315" y="226" font-size="13" font-weight="800" fill="#713f12" text-anchor="middle">
            KHỞI TRỊ PHỐI HỢP THUỐC SỚM (UPFRONT LLT)
          </text>
          <text x="315" y="243" font-size="11" font-weight="600" fill="#854d0e" text-anchor="middle">
            Ưu tiên hàng đầu dạng viên kết hợp liều cố định (FDC)
          </text>

          <!-- Green Exclamation Badge -->
          <circle cx="115" cy="205" r="13" fill="#16a34a" stroke="#ffffff" stroke-width="2" />
          <text x="115" y="210" font-size="15" font-weight="900" fill="#ffffff" text-anchor="middle">!</text>

          <!-- Curved Arrow from Upfront Box to Step 1 -->
          <path d="M 230 255 C 230 275, 200 275, 200 288" fill="none" stroke="#0284c7" stroke-width="2.5" marker-end="url(#arrow-blue)" />

          <!-- ================= 2. MAIN 3-STEP CONTAINER ================= -->
          <rect x="110" y="290" width="650" height="335" rx="10" fill="var(--color-surface-2, #f8fafc)" stroke="var(--color-border, #cbd5e1)" stroke-width="1.5" />

          <!-- BƯỚC I: Phối hợp đôi (Dual LLT) -->
          <rect x="125" y="305" width="125" height="75" rx="6" fill="var(--color-surface, #ffffff)" stroke="var(--color-border, #cbd5e1)" />
          <text x="187" y="338" font-size="13" font-weight="800" fill="var(--color-text, #0f172a)" text-anchor="middle">BƯỚC I</text>
          <text x="187" y="358" font-size="11" font-weight="600" fill="var(--color-text-muted, #64748b)" text-anchor="middle">(Phối hợp đôi)</text>

          <rect x="260" y="305" width="485" height="75" rx="6" fill="var(--color-surface, #ffffff)" stroke="var(--color-border, #cbd5e1)" />
          <text x="275" y="348" font-size="12.5" font-weight="700" fill="#dc2626">Statin hoạt lực cao liều dung nạp tối đa</text>
          <text x="525" y="348" font-size="15" font-weight="700" fill="#64748b">+</text>
          <text x="545" y="348" font-size="12.5" font-weight="700" fill="#16a34a">Ezetimibe (10 mg)</text>

          <!-- FDC Badge on Step 1 -->
          <rect x="665" y="312" width="70" height="22" rx="4" fill="#dcfce7" stroke="#16a34a" stroke-width="1" />
          <text x="700" y="327" font-size="10.5" font-weight="800" fill="#15803d" text-anchor="middle">VIÊN FDC</text>

          <!-- BƯỚC II: Phối hợp ba (Triple LLT) -->
          <rect x="125" y="390" width="125" height="120" rx="6" fill="var(--color-surface, #ffffff)" stroke="var(--color-border, #cbd5e1)" />
          <text x="187" y="445" font-size="13" font-weight="800" fill="var(--color-text, #0f172a)" text-anchor="middle">BƯỚC II</text>
          <text x="187" y="465" font-size="11" font-weight="600" fill="var(--color-text-muted, #64748b)" text-anchor="middle">(Phối hợp ba)</text>

          <rect x="260" y="390" width="485" height="120" rx="6" fill="var(--color-surface, #ffffff)" stroke="var(--color-border, #cbd5e1)" />

          <!-- Step 2 Option A -->
          <rect x="270" y="398" width="95" height="42" rx="4" fill="#fef08a" stroke="#eab308" stroke-width="1" />
          <text x="317" y="415" font-size="10.5" font-weight="700" fill="#713f12" text-anchor="middle">Statin tối đa</text>
          <text x="317" y="430" font-size="9" fill="#854d0e" text-anchor="middle">(hoạt lực cao)</text>
          <text x="378" y="424" font-size="14" font-weight="700" fill="#64748b">+</text>
          <rect x="390" y="398" width="345" height="42" rx="4" fill="#e0f2fe" stroke="#0284c7" stroke-width="1" />
          <text x="562" y="416" font-size="11" font-weight="700" fill="#0369a1" text-anchor="middle">Ezetimibe 10mg  +  Axit Bempedoic 180mg</text>
          <text x="562" y="431" font-size="9.5" font-weight="800" fill="#0284c7" text-anchor="middle">★ VIÊN KẾT HỢP CỐ ĐỊNH LIỀU (FDC) ★</text>

          <!-- Dashed divider line with OR -->
          <line x1="270" y1="449" x2="735" y2="449" stroke="var(--color-border, #cbd5e1)" stroke-dasharray="4 3" />
          <rect x="475" y="441" width="55" height="16" rx="8" fill="var(--color-surface, #ffffff)" stroke="var(--color-border, #cbd5e1)" />
          <text x="502" y="453" font-size="9.5" font-weight="800" fill="var(--color-text-muted, #64748b)" text-anchor="middle">HOẶC</text>

          <!-- Step 2 Option B -->
          <rect x="270" y="460" width="280" height="42" rx="4" fill="#e0f2fe" stroke="#0284c7" stroke-width="1" />
          <text x="410" y="477" font-size="11" font-weight="700" fill="#0369a1" text-anchor="middle">Statin tối đa  +  Ezetimibe 10mg (FDC)</text>
          <text x="410" y="493" font-size="9.5" fill="#0284c7" text-anchor="middle">Viên kết hợp liều cố định 2 thành phần</text>
          <text x="560" y="485" font-size="14" font-weight="700" fill="#64748b">+</text>
          <rect x="572" y="460" width="163" height="42" rx="4" fill="#fae8ff" stroke="#c026d3" stroke-width="1" />
          <text x="653" y="477" font-size="11" font-weight="700" fill="#86198f" text-anchor="middle">Ức Chế PCSK9</text>
          <text x="653" y="493" font-size="9" fill="#a21caf" text-anchor="middle">(Evolocumab / Alirocumab / siRNA)</text>

          <!-- BƯỚC III: Phối hợp bốn (Quadruple LLT) -->
          <rect x="125" y="520" width="125" height="90" rx="6" fill="var(--color-surface, #ffffff)" stroke="var(--color-border, #cbd5e1)" />
          <text x="187" y="560" font-size="13" font-weight="800" fill="var(--color-text, #0f172a)" text-anchor="middle">BƯỚC III</text>
          <text x="187" y="580" font-size="11" font-weight="600" fill="var(--color-text-muted, #64748b)" text-anchor="middle">(Phối hợp bốn)</text>

          <rect x="260" y="520" width="485" height="90" rx="6" fill="var(--color-surface, #ffffff)" stroke="var(--color-border, #cbd5e1)" />
          <rect x="270" y="528" width="92" height="38" rx="4" fill="#fef08a" stroke="#eab308" stroke-width="1" />
          <text x="316" y="551" font-size="10.5" font-weight="700" fill="#713f12" text-anchor="middle">Statin tối đa</text>
          <text x="372" y="551" font-size="14" font-weight="700" fill="#64748b">+</text>
          <rect x="384" y="528" width="190" height="38" rx="4" fill="#e0f2fe" stroke="#0284c7" stroke-width="1" />
          <text x="479" y="544" font-size="10" font-weight="700" fill="#0369a1" text-anchor="middle">Ezetimibe + Bempedoic</text>
          <text x="479" y="558" font-size="9" font-weight="800" fill="#0284c7" text-anchor="middle">VIÊN KẾT HỢP FDC</text>
          <text x="584" y="551" font-size="14" font-weight="700" fill="#64748b">+</text>
          <rect x="596" y="528" width="139" height="38" rx="4" fill="#fae8ff" stroke="#c026d3" stroke-width="1" />
          <text x="665" y="551" font-size="10.5" font-weight="700" fill="#86198f" text-anchor="middle">Ức Chế PCSK9</text>

          <text x="502" y="593" font-size="11" font-weight="600" fill="var(--color-danger, #dc2626)" text-anchor="middle">
            Phối hợp đồng thời 4 cơ chế dược lý ➔ Hạ LDL-C tối đa &gt; 85%
          </text>

          <!-- ================= 3. WEDGE & INTENSIFICATION (RIGHT) ================= -->
          <!-- Vertical Polygon Wedge -->
          <polygon points="775,610 775,305 805,305" fill="#e2e8f0" stroke="#94a3b8" stroke-width="1" />
          <rect x="762" y="275" width="118" height="22" rx="4" fill="var(--color-surface, #ffffff)" stroke="#64748b" stroke-width="1" />
          <text x="821" y="290" font-size="9.5" font-weight="800" fill="#334155" text-anchor="middle">TĂNG CƯỜNG LLT</text>

          <!-- Arrows from wedge to Step II & Step III -->
          <path d="M 775 450 L 748 450" stroke="#dc2626" stroke-width="2" marker-end="url(#arrow-red)" />
          <path d="M 775 565 L 748 565" stroke="#dc2626" stroke-width="2" marker-end="url(#arrow-red)" />

          <!-- ================= 4. EXIT FROM STEP I TO MONITORING ROW ================= -->
          <path d="M 110 342 L 50 342 L 50 685 L 105 685" fill="none" stroke="#0284c7" stroke-width="2" marker-end="url(#arrow-blue)" />
          <rect x="25" y="490" width="50" height="22" rx="4" fill="var(--color-surface, #ffffff)" stroke="var(--color-border, #cbd5e1)" />
          <text x="50" y="505" font-size="10" font-weight="700" fill="#0284c7" text-anchor="middle">4–6 TUẦN</text>

          <!-- ================= 5. MONITORING & GOAL ROW ================= -->
          <!-- Monitor Box -->
          <rect x="110" y="660" width="240" height="50" rx="25" fill="var(--color-surface, #ffffff)" stroke="var(--color-primary, #0284c7)" stroke-width="2" />
          <text x="230" y="683" font-size="12" font-weight="800" fill="#0369a1" text-anchor="middle">ĐO LẠI LIPID MÁU</text>
          <text x="230" y="699" font-size="11" font-weight="600" fill="#0284c7" text-anchor="middle">Sau 4 – 6 tuần điều trị</text>

          <path d="M 350 685 L 385 685" stroke="#64748b" stroke-width="2" marker-end="url(#arrow-gray)" />

          <!-- Decision Box -->
          <rect x="385" y="660" width="255" height="50" rx="25" fill="var(--color-surface, #ffffff)" stroke="var(--color-primary, #0284c7)" stroke-width="2" />
          <text x="512" y="683" font-size="12.5" font-weight="800" fill="#0369a1" text-anchor="middle">MỨC LDL-C &lt; 55 mg/dL?</text>
          <text x="512" y="699" font-size="10.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">(&lt; 40 mg/dL nếu Nguy cơ cực cao)</text>

          <!-- Exit YES (Down) -->
          <path d="M 512 710 L 512 730" stroke="#16a34a" stroke-width="2" />
          <circle cx="512" cy="742" r="13" fill="var(--color-surface, #ffffff)" stroke="#16a34a" stroke-width="2" />
          <text x="512" y="746" font-size="10" font-weight="800" fill="#16a34a" text-anchor="middle">✓ ĐẠT</text>
          <path d="M 512 755 L 512 775" stroke="#16a34a" stroke-width="2" marker-end="url(#arrow-green)" />

          <rect x="385" y="775" width="255" height="55" rx="10" fill="#dcfce7" stroke="#16a34a" stroke-width="2" />
          <text x="512" y="798" font-size="12" font-weight="800" fill="#15803d" text-anchor="middle">TÁI KHÁM ĐỊNH KỲ MỖI 3 THÁNG</text>
          <text x="512" y="816" font-size="10.5" fill="#166534" text-anchor="middle">Duy trì phác đồ hiện tại lâu dài</text>

          <!-- Exit NO (Right) -->
          <path d="M 640 685 L 675 685" stroke="#dc2626" stroke-width="2" />
          <circle cx="688" cy="685" r="13" fill="var(--color-surface, #ffffff)" stroke="#dc2626" stroke-width="2" />
          <text x="688" y="689" font-size="10" font-weight="800" fill="#dc2626" text-anchor="middle">✗ CHƯA</text>
          <path d="M 701 685 L 725 685" stroke="#dc2626" stroke-width="2" marker-end="url(#arrow-red)" />

          <!-- Escalation Box -->
          <rect x="725" y="660" width="250" height="55" rx="10" fill="#fee2e2" stroke="#dc2626" stroke-width="2" />
          <text x="850" y="683" font-size="12" font-weight="800" fill="#991b1b" text-anchor="middle">TĂNG CƯỜNG ĐIỀU TRỊ (LLT)</text>
          <text x="850" y="701" font-size="10.5" font-weight="700" fill="#b91c1c" text-anchor="middle">VÀ/HOẶC CHUYỂN TRUNG TÂM LIPID</text>

          <!-- Feedback Loop Path (Up to Wedge) -->
          <path d="M 850 660 L 850 450 L 780 450" fill="none" stroke="#dc2626" stroke-width="2" marker-end="url(#arrow-red)" />
          <path d="M 850 565 L 780 565" fill="none" stroke="#dc2626" stroke-width="2" marker-end="url(#arrow-red)" />

          <rect x="805" y="500" width="90" height="22" rx="4" fill="var(--color-surface, #ffffff)" stroke="#dc2626" stroke-width="1" />
          <text x="850" y="515" font-size="10" font-weight="800" fill="#dc2626" text-anchor="middle">▲ NÂNG BẬC LLT</text>
        </svg>
      </div>
...
<script is:inline dangerouslySetInnerHTML={{ __html: `
  function calculateILEP() {
    ...
    let recsHtml = recs.map(function(r) { return '<li style="margin-bottom: 0.35rem;">' + r + '</li>'; }).join('');
    let alertsHtml = '';
    if (alerts.length > 0) {
