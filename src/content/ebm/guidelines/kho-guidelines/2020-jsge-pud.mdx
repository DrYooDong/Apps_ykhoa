...
<div class="stats-strip">
  ...
  <div class="page-content">
    ...
    <div class="sec-card" id="sec-svg-overview">
      <div class="sec-hdr"><span class="sec-hdr-icon"><i class="fa-solid fa-diagram-project" style="color: var(--color-primary, #0284c7);"></i></span> <h2 class="sec-title">Lưu Đồ Thuật Toán Tiếp Cận &amp; Điều Trị Bệnh Loét Dạ Dày - Tá Tràng (JSGE 2020)</h2></div>
      <div class="sec-body">
        <p style="font-size: 0.86rem; color: var(--color-text-muted, #64748b); margin-bottom: 1.25rem;">Sơ đồ phác đồ trực quan hóa toàn bộ lộ trình ra quyết định lâm sàng theo Hướng dẫn JSGE 2020: phân luồng cấp cứu biến chứng (Thủng, Hẹp, Xuất huyết), tiếp cận loét theo căn nguyên (NSAIDs, <em>H. pylori</em>, Vô căn, Mỏm cắt) và chiến lược duy trì phòng ngừa tái phát.</p>
  ...
  <div class="flowchart-card-header">
    <div class="flowchart-badge-title">
      ...
      <span class="flowchart-badge-text">Lưu Đồ Thuật Toán Tiếp Cận &amp; Điều Trị Bệnh Loét Dạ Dày - Tá Tràng (JSGE 2020)</span>
    </div>
    <span class="flowchart-version-tag">JSGE 2020 • PUD Guidelines</span>
  </div>
  
  <div class="flowchart-svg-scroll">
    <svg class="med-svg" viewBox="0 0 940 500" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
    <defs>
      <marker id="arr-pud" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
        <path d="M 0 1.5 L 8 5 L 0 8.5 z" fill="var(--color-text-muted, #64748b)" />
      </marker>
      <marker id="arr-pud-act" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
    ...
    <!-- Root -->
    <g class="flow-node">
      <rect x="250" y="15" width="440" height="52" rx="8" fill="var(--color-primary-subtle, rgba(2,132,199,0.12))" stroke="var(--color-primary, #0284c7)" stroke-width="2"/>
      <text x="470" y="36" font-size="13.5" font-weight="700" fill="var(--color-primary, #0284c7)" text-anchor="middle">BỆNH NHÂN ĐAU THƯỢNG VỊ / LOÉT DẠ DÀY - TÁ TRÀNG</text>
      <text x="470" y="53" font-size="11" fill="var(--color-text-muted, #64748b)" text-anchor="middle">Sàng lọc biến chứng cấp tính đe dọa tính mạng trước tiên</text>
    </g>

    <path d="M 470 67 L 470 95" fill="none" stroke="var(--color-primary, #0284c7)" stroke-width="2" marker-end="url(#arr-pud-act)"/>

    <!-- Emergency Decision -->
    <g class="flow-node">
      <polygon points="470,95 660,128 470,161 280,128" fill="var(--color-warning-subtle, rgba(245,158,11,0.12))" stroke="var(--color-warning, #f59e0b)" stroke-width="2"/>
      <text x="470" y="124" font-size="12" font-weight="700" fill="var(--color-warning, #d97706)" text-anchor="middle">Khảo Sát Biến Chứng Cấp Tính?</text>
      <text x="470" y="140" font-size="10.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">Thủng tạng rỗng, hẹp môn vị, xuất huyết tiêu hóa?</text>
    </g>

    <!-- Left: Perforation / Stenosis -->
    <path d="M 280 128 L 130 128 L 130 190" fill="none" stroke="var(--color-danger, #ef4444)" stroke-width="2" marker-end="url(#arr-pud-act)"/>
    <g class="flow-node">
      <rect x="20" y="190" width="220" height="65" rx="8" fill="var(--color-danger-subtle, rgba(239,68,68,0.12))" stroke="var(--color-danger, #ef4444)" stroke-width="1.8"/>
      <text x="130" y="213" font-size="12" font-weight="700" fill="var(--color-danger, #ef4444)" text-anchor="middle">Thủng Ổ Loét / Hẹp Môn Vị</text>
      <text x="130" y="231" font-size="10" fill="var(--color-text, #334155)" text-anchor="middle">X-quang / CT hơi tự do</text>
      <text x="130" y="245" font-size="9.5" fill="var(--color-danger, #ef4444)" text-anchor="middle">Phẫu thuật cấp cứu ngoại khoa</text>
    </g>

    <!-- Mid: Bleeding -->
    <path d="M 470 161 L 470 190" fill="none" stroke="var(--color-danger, #ef4444)" stroke-width="2" marker-end="url(#arr-pud-act)"/>
    <g class="flow-node">
      <rect x="360" y="190" width="220" height="65" rx="8" fill="var(--color-danger-subtle, rgba(239,68,68,0.12))" stroke="var(--color-danger, #ef4444)" stroke-width="1.8"/>
      <text x="470" y="213" font-size="12" font-weight="700" fill="var(--color-danger, #ef4444)" text-anchor="middle">Loét Xuất Huyết Tiêu Hóa</text>
      <text x="470" y="231" font-size="10" fill="var(--color-text, #334155)" text-anchor="middle">Nôn máu / Phân đen</text>
      <text x="470" y="245" font-size="9.5" font-weight="600" fill="var(--color-primary, #0284c7)" text-anchor="middle">Soi can thiệp cầm máu trong 24h</text>
    </g>

    <!-- Right: Uncomplicated -->
    <path d="M 660 128 L 810 128 L 810 190" fill="none" stroke="var(--color-success, #22c55e)" stroke-width="2" marker-end="url(#arr-pud-act)"/>
    <g class="flow-node">
      <rect x="700" y="190" width="220" height="65" rx="8" fill="var(--color-success-subtle, rgba(34,197,94,0.12))" stroke="var(--color-success, #22c55e)" stroke-width="1.8"/>
      <text x="810" y="213" font-size="12" font-weight="700" fill="var(--color-success, #16a34a)" text-anchor="middle">Loét Không Biến Chứng</text>
      <text x="810" y="231" font-size="10" fill="var(--color-text, #334155)" text-anchor="middle">Huyết động ổn định</text>
      <text x="810" y="245" font-size="9.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">Phân luồng điều trị theo căn nguyên</text>
    </g>

    <!-- Bleeding and Uncomplicated connect to 4 Etiologies -->
    <path d="M 470 255 L 470 285 M 120 285 L 820 285" fill="none" stroke="var(--color-border, #cbd5e1)" stroke-width="1.8"/>
    <path d="M 810 255 L 810 285" fill="none" stroke="var(--color-border, #cbd5e1)" stroke-width="1.8"/>
    <path d="M 120 285 L 120 310" fill="none" stroke="var(--color-border, #cbd5e1)" stroke-width="1.8" marker-end="url(#arr-pud)"/>
    <path d="M 350 285 L 350 310" fill="none" stroke="var(--color-border, #cbd5e1)" stroke-width="1.8" marker-end="url(#arr-pud)"/>
    <path d="M 590 285 L 590 310" fill="none" stroke="var(--color-border, #cbd5e1)" stroke-width="1.8" marker-end="url(#arr-pud)"/>
    <path d="M 820 285 L 820 310" fill="none" stroke="var(--color-border, #cbd5e1)" stroke-width="1.8" marker-end="url(#arr-pud)"/>

    <!-- Etio 1: NSAID -->
    <g class="flow-node">
      <rect x="20" y="310" width="200" height="150" rx="8" fill="var(--color-warning-subtle, rgba(245,158,11,0.12))" stroke="var(--color-warning, #f59e0b)" stroke-width="1.8"/>
      <text x="120" y="333" font-size="12" font-weight="700" fill="var(--color-warning, #d97706)" text-anchor="middle">1. Loét Do Thuốc NSAIDs</text>
      <text x="120" y="353" font-size="10.5" font-weight="600" fill="var(--color-danger, #ef4444)" text-anchor="middle">Ngừng ngay NSAIDs</text>
      <text x="120" y="371" font-size="10" fill="var(--color-text, #334155)" text-anchor="middle">Khởi trị PPI hoặc Vonoprazan</text>
      <text x="120" y="389" font-size="10" fill="var(--color-text, #334155)" text-anchor="middle">Nếu bắt buộc dùng tiếp:</text>
      <text x="120" y="405" font-size="9.5" font-weight="600" fill="var(--color-primary, #0284c7)" text-anchor="middle">Chuyển sang Celecoxib</text>
      <text x="120" y="421" font-size="9.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">+ PPI bảo vệ dạ dày</text>
    </g>

    <!-- Etio 2: HP -->
    <g class="flow-node">
      <rect x="250" y="310" width="200" height="150" rx="8" fill="var(--color-primary-subtle, rgba(2,132,199,0.12))" stroke="var(--color-primary, #0284c7)" stroke-width="1.8"/>
      <text x="350" y="333" font-size="12" font-weight="700" fill="var(--color-primary, #0284c7)" text-anchor="middle">2. Nhiễm H. Pylori (+)</text>
      <text x="350" y="353" font-size="10.5" font-weight="600" fill="var(--color-primary, #0284c7)" text-anchor="middle">Tiệt trừ bước 1 (7 ngày):</text>
      <text x="350" y="371" font-size="10" fill="var(--color-text, #334155)" text-anchor="middle">Vonoprazan + Amox + Clari</text>
      <text x="350" y="389" font-size="10" fill="var(--color-text, #334155)" text-anchor="middle">Thất bại -> Bước 2:</text>
      <text x="350" y="405" font-size="9.5" fill="var(--color-text, #334155)" text-anchor="middle">VPZ + Amox + Metro (PAM)</text>
      <text x="350" y="421" font-size="9.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">Bước 3: Phác đồ Sitafloxacin</text>
    </g>

    <!-- Etio 3: LDA -->
    <g class="flow-node">
      <rect x="490" y="310" width="200" height="150" rx="8" fill="var(--color-warning-subtle, rgba(245,158,11,0.12))" stroke="var(--color-warning, #f59e0b)" stroke-width="1.8"/>
      <text x="590" y="333" font-size="12" font-weight="700" fill="var(--color-warning, #d97706)" text-anchor="middle">3. Dùng Aspirin (LDA)</text>
      <text x="590" y="353" font-size="10.5" font-weight="600" fill="var(--color-primary, #0284c7)" text-anchor="middle">Dự phòng tim mạch</text>
      <text x="590" y="371" font-size="10" font-weight="700" fill="var(--color-danger, #ef4444)" text-anchor="middle">TIẾP TỤC DÙNG LDA</text>
      <text x="590" y="389" font-size="10" fill="var(--color-text, #334155)" text-anchor="middle">Phối hợp PPI hoặc Vonoprazan</text>
      <text x="590" y="405" font-size="9.5" fill="var(--color-text, #334155)" text-anchor="middle">duy trì liên tục</text>
      <text x="590" y="421" font-size="9.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">Tránh ngừng LDA đột ngột</text>
    </g>

    <!-- Etio 4: Special -->
    <g class="flow-node">
      <rect x="720" y="310" width="200" height="150" rx="8" fill="var(--color-surface, #ffffff)" stroke="var(--color-border, #cbd5e1)" stroke-width="1.8"/>
      <text x="820" y="333" font-size="12" font-weight="700" fill="var(--color-text, #334155)" text-anchor="middle">4. Loét Vô Căn / Sau Mổ</text>
      <text x="820" y="353" font-size="10.5" fill="var(--color-text, #334155)" text-anchor="middle">Không NSAID &amp; HP (-)</text>
      <text x="820" y="371" font-size="10" fill="var(--color-text, #334155)" text-anchor="middle">• Loét vô căn: PPI dài hạn</text>
      <text x="820" y="389" font-size="10" fill="var(--color-text, #334155)" text-anchor="middle">• Loét mỏm cắt sau mổ:</text>
      <text x="820" y="405" font-size="9.5" fill="var(--color-text, #334155)" text-anchor="middle">Khởi trị ngay bằng PPI</text>
      <text x="820" y="421" font-size="9.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">Đánh giá loại trừ u Gastrinoma</text>
    </g>
  </svg>
  </div>
  ...
  <div class="flowchart-legend-row">
      <div class="legend-item">
        ...
        <span>Biến chứng cấp tính: Thủng ổ loét hoặc Xuất huyết tiêu hóa</span>
      </div>
      <div class="legend-item">
        <span class="legend-swatch" style="background: rgba(2,132,199,0.12); border-color: #0284c7;"></span>
        <span>Tiệt trừ H. pylori bước 1 với Vonoprazan (VPZ + A + C 7 ngày)</span>
      </div>
      <div class="legend-item">
        <span class="legend-swatch" style="background: rgba(245,158,11,0.12); border-color: #f59e0b;"></span>
        <span>Loét do NSAIDs / Bệnh nhân dùng Aspirin dự phòng tim mạch</span>
      </div>
  </div>
</div>
      </div>
    ...
    <div class="sec-card" id="sec-3">
      <div class="sec-hdr"><span class="sec-hdr-icon"><i class="fa-solid fa-bacterium" style="color: var(--color-success, #10b981);"></i></span> <h2 class="sec-title">3. Liệu Pháp Tiệt Trừ Helicobacter pylori &amp; Điều Trị Không Tiệt Trừ (CQ-5 &amp;rarr; CQ-10)</h2></div>
      <div class="sec-body">
        <p style="font-size: 0.86rem; color: var(--color-text-muted, #64748b); margin-bottom: 1.25rem;">Mức độ và thời gian ức chế acid dạ dày là yếu tố quyết định hàng đầu tỷ lệ thành công của liệu pháp kháng sinh tiệt trừ <em>H. pylori</em>. JSGE 2020 đánh dấu bước ngoặt lớn với sự xuất hiện của chất ức chế acid cạnh tranh kali (P-CAB, Vonoprazan).</p>
    ...
    <div class="sec-card" id="sec-4">
      <div class="sec-hdr"><span class="sec-hdr-icon"><i class="fa-solid fa-pills" style="color: var(--color-warning, #f59e0b);"></i></span> <h2 class="sec-title">4. Sinh Lý Bệnh, Điều Trị &amp; Dự Phòng Loét Do Thuốc NSAIDs (CQ-11 &amp;rarr; CQ-17)</h2></div>
      <div class="sec-body">
        <p style="font-size: 0.86rem; color: var(--color-text-muted, #64748b); margin-bottom: 1.25rem;">Thuốc kháng viêm không steroid không chọn lọc (nonselective NSAIDs) phá hủy hàng rào chất nhầy và biểu mô bảo vệ dạ dày tá tràng qua ức chế COX-1 làm cạn kiệt prostaglandin sinh lý.</p>
    ...
    <div class="sec-card" id="sec-5">
      <div class="sec-hdr"><span class="sec-hdr-icon"><i class="fa-solid fa-heart-pulse" style="color: var(--color-teal, #0d9488);"></i></span> <h2 class="sec-title">5. Sinh Lý Bệnh &amp; Dự Phòng Loét Do Aspirin Liều Thấp (LDA) (CQ-18 &amp;rarr; CQ-25)</h2></div>
      <div class="sec-body">
        <p style="font-size: 0.86rem; color: var(--color-text-muted, #64748b); margin-bottom: 1.25rem;">Aspirin liều thấp (LDA, 75 - 100 mg/ngày) ức chế không hồi phục enzyme COX-1 tiểu cầu, làm suy giảm dòng máu nuôi niêm mạc và gia tăng nguy cơ loét cũng như chảy máu tiêu hóa nghiêm trọng.</p>
    ...
    <div class="sec-card" id="sec-6">
      <div class="sec-hdr"><span class="sec-hdr-icon"><i class="fa-solid fa-hospital-user" style="color: var(--color-purple, #8b5cf6);"></i></span> <h2 class="sec-title">6. Xử Trí Loét Vô Căn, Loét Mỏm Cắt Dạ Dày, Phẫu Thuật &amp; Thiếu Máu Cục Bộ (CQ-26 &amp;rarr; CQ-28, FRQ-1)</h2></div>
      <div class="sec-body">
