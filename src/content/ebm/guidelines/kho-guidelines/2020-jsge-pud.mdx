  ...
  <div class="page-content">
    ...
    <div class="sec-card" id="sec-svg-overview">
      ...
      <div class="sec-body">
        ...
        <FlowchartViewer 
          title="Lưu Đồ Thuật Toán Tiếp Cận & Điều Trị Bệnh Loét Dạ Dày - Tá Tràng (JSGE 2020)"
          code={`flowchart TD
            START([Bệnh nhân đau thượng vị / Loét dạ dày - tá tràng | start | badge: Đánh giá ban đầu])
            EMERG{Khảo sát biến chứng cấp tính ngoại khoa? | question}

            PERF[Thủng ổ loét hoặc Hẹp môn vị 🚨 | danger | badge: Ngoại khoa | subtitle: Chụp X-quang bụng đứng / CT bụng có hơi tự do - Phẫu thuật cấp cứu hoặc điều trị bảo tồn Taylor]
            BLEED[Loét biến chứng xuất huyết tiêu hóa 🚨 | danger | badge: Cấp cứu nội soi | subtitle: Nôn ra máu / Đi phân đen - Hồi sức huyết động + Nội soi can thiệp cầm máu trong 24h]
            UNCOMP[Loét không biến chứng cấp tính | success | subtitle: Thể trạng ổn định, huyết động vững - Phân luồng điều trị theo căn nguyên]

            HEMO_TX[Can thiệp nội soi + PPI liều cao TM ⭐ | action | subtitle: Kẹp Hemoclip / Đốt điện nhiệt / Tiêm xơ + PPI tĩnh mạch - Duy trì LDA nếu nguy cơ huyết khối cao]

            ETIOLOGY{Khảo sát căn nguyên gây loét? | question}
            NSAID[1. Loét do thuốc NSAIDs 💊 | warning | badge: Căn nguyên thuốc | subtitle: Ngừng NSAIDs ngay + Khởi trị PPI hoặc Vonoprazan; nếu bắt buộc dùng tiếp: Chuyển sang Celecoxib + PPI]
            HP[2. Nhiễm H. pylori (+) 🔬 | action | badge: Vi sinh vật | subtitle: Phác đồ bước 1: VPZ + Amoxicillin + Clarithromycin trong 7 ngày -> Bước 2: PAM -> Bước 3: Sitafloxacin]
            LDA[3. Bệnh nhân dùng Aspirin liều thấp (LDA) 🫀 | warning | badge: Dự phòng tim mạch | subtitle: TIẾP TỤC LDA + Phối hợp PPI / Vonoprazan liên tục để phòng ngừa tái xuất huyết]
            SPEC[4. Loét vô căn / Loét mỏm cắt sau mổ ⚙️ | action | badge: Thể đặc biệt | subtitle: Loét vô căn: PPI dài hạn hoặc H2RA; Loét mỏm cắt: Khởi trị ngay bằng PPI]

            START --> EMERG
            EMERG -->|Thủng / Hẹp| PERF
            EMERG ==>|Xuất huyết tiêu hóa| BLEED
            EMERG -->|Không biến chứng| UNCOMP
