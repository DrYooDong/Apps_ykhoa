          ...
          <svg viewBox="0 0 920 540" xmlns="http://www.w3.org/2000/svg" font-family="'Plus Jakarta Sans', 'Inter', sans-serif">
            <defs>
              <marker id="arrow" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
                <path d="M 0 1.5 L 8 5 L 0 8.5 z" fill="var(--text-faint, #94a3b8)"/>
              </marker>
            ...
            <rect x="330" y="20" width="260" height="48" rx="10" fill="var(--color-surface-2, #f8fafc)" stroke="var(--color-primary, #0284c7)" stroke-width="2"/>
            <text x="460" y="42" font-size="13" font-weight="700" fill="var(--color-text, #0f172a)" text-anchor="middle">BỆNH NHÂN LOÉT DẠ DÀY - TÁ TRÀNG</text>
            <text x="460" y="56" font-size="10.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">Đánh giá ban đầu &amp; Khảo sát biến chứng</text>

            
            <path d="M 460 68 L 460 105" stroke="var(--text-faint, #94a3b8)" stroke-width="1.8" fill="none" marker-end="url(#arrow)"/>

            
            
            <rect x="40" y="115" width="220" height="58" rx="10" fill="var(--red-bg, #fef2f2)" stroke="var(--red-light, #fecaca)" stroke-width="1.5"/>
            <text x="150" y="137" font-size="12" font-weight="700" fill="#991b1b" text-anchor="middle">THỦNG HOẶC HẸP MÔN VỊ</text>
            <text x="150" y="155" font-size="10.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">Phẫu thuật / Điều trị bảo tồn</text>

            
            <rect x="340" y="115" width="240" height="58" rx="10" fill="var(--red-bg, #fef2f2)" stroke="#dc2626" stroke-width="2"/>
            <text x="460" y="137" font-size="12" font-weight="700" fill="#991b1b" text-anchor="middle">LOÉT BIẾN CHỨNG XUẤT HUYẾT</text>
            <text x="460" y="155" font-size="10.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">Nội soi can thiệp cầm máu</text>

            
            <rect x="650" y="115" width="230" height="58" rx="10" fill="rgba(16, 185, 129, 0.08)" stroke="var(--green-light, #bbf7d0)" stroke-width="1.5"/>
            <text x="765" y="137" font-size="12" font-weight="700" fill="#065f46" text-anchor="middle">KHÔNG CÓ BIẾN CHỨNG</text>
            <text x="765" y="155" font-size="10.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">Điều trị nội khoa tức thì</text>

            
            <path d="M 460 90 L 150 90 L 150 115" stroke="var(--text-faint, #94a3b8)" stroke-width="1.5" fill="none" marker-end="url(#arrow)"/>
            <path d="M 460 90 L 765 90 L 765 115" stroke="var(--text-faint, #94a3b8)" stroke-width="1.5" fill="none" marker-end="url(#arrow)"/>

            
            <path d="M 460 173 L 460 210" stroke="var(--text-faint, #94a3b8)" stroke-width="1.5" fill="none" marker-end="url(#arrow)"/>
            <rect x="330" y="210" width="260" height="54" rx="10" fill="var(--color-surface-2, #f8fafc)" stroke="var(--color-border, #cbd5e1)" stroke-width="1.5"/>
            <text x="460" y="231" font-size="11.5" font-weight="700" fill="var(--color-text, #0f172a)" text-anchor="middle">PPI Liều Chuẩn + Xem xét IVR/TAE</text>
            <text x="460" y="249" font-size="10" fill="var(--color-text-muted, #64748b)" text-anchor="middle">Duy trì Aspirin nếu nguy cơ huyết khối cao</text>

            
            <path d="M 460 264 L 460 300" stroke="var(--text-faint, #94a3b8)" stroke-width="1.5" fill="none"/>
            <path d="M 765 173 L 765 300 L 140 300" stroke="var(--text-faint, #94a3b8)" stroke-width="1.5" fill="none"/>

            
            
            <path d="M 140 300 L 140 330" stroke="var(--text-faint, #94a3b8)" stroke-width="1.5" fill="none" marker-end="url(#arrow)"/>
            <rect x="30" y="330" width="200" height="175" rx="10" fill="var(--surface, #ffffff)" stroke="var(--color-warning, #f59e0b)" stroke-width="1.5"/>
            <rect x="30" y="330" width="200" height="30" rx="10" fill="rgba(245, 158, 11, 0.08)"/>
            <text x="130" y="350" font-size="11.5" font-weight="700" fill="#92400e" text-anchor="middle">1. LOÉT DO NSAIDs</text>
            <text x="42" y="380" font-size="10.5" font-weight="700" fill="var(--color-text, #0f172a)">• Ngừng NSAIDs + PPI/VPZ</text>
            <text x="42" y="400" font-size="10" fill="var(--color-text-muted, #64748b)">• Nếu bắt buộc dùng tiếp:</text>
            <text x="50" y="418" font-size="10" fill="#2563eb">• Ưu tiên PPI hàng đầu</text>
            <text x="42" y="438" font-size="10" fill="var(--color-text-muted, #64748b)">• Bệnh nhân có tiền sử loét:</text>
            <text x="50" y="456" font-size="10" fill="#059669">• Celecoxib + PPI</text>
            <text x="42" y="478" font-size="10" fill="var(--color-text-muted, #64748b)">• Tiệt trừ H. pylori nếu naïve</text>

            
            <path d="M 360 300 L 360 330" stroke="var(--text-faint, #94a3b8)" stroke-width="1.5" fill="none" marker-end="url(#arrow)"/>
            <rect x="250" y="330" width="205" height="175" rx="10" fill="var(--surface, #ffffff)" stroke="var(--color-success, #10b981)" stroke-width="1.5"/>
            <rect x="250" y="330" width="205" height="30" rx="10" fill="rgba(16, 185, 129, 0.08)"/>
            ...
            <text x="270" y="398" font-size="10" fill="var(--color-text-muted, #64748b)">(Hoặc Amox + Metro)</text>
            <text x="262" y="420" font-size="10.5" font-weight="700" fill="#2563eb">• Bước 2: PAM (VPZ/PPI +</text>
            <text x="270" y="438" font-size="10" fill="var(--color-text-muted, #64748b)">Amox + Metronidazole)</text>
            <text x="262" y="460" font-size="10.5" font-weight="700" fill="#d97706">• Bước 3: Chứa Sitafloxacin</text>
            <text x="262" y="482" font-size="10" fill="var(--color-text-muted, #64748b)">• Thử lại UBT sau 4-8 tuần</text>

            
            <path d="M 580 300 L 580 330" stroke="var(--text-faint, #94a3b8)" stroke-width="1.5" fill="none" marker-end="url(#arrow)"/>
            <rect x="475" y="330" width="205" height="175" rx="10" fill="var(--surface, #ffffff)" stroke="var(--blue, #0284c7)" stroke-width="1.5"/>
            <rect x="475" y="330" width="205" height="30" rx="10" fill="var(--blue-bg, #eff6ff)"/>
            <text x="577" y="350" font-size="11.5" font-weight="700" fill="#1e40af" text-anchor="middle">3. DÙNG ASPIRIN (LDA)</text>
            <text x="487" y="380" font-size="10.5" font-weight="700" fill="var(--color-text, #0f172a)">• TIẾP TỤC LDA + PPI</text>
            <text x="487" y="400" font-size="10" fill="var(--color-text-muted, #64748b)">• Dự phòng chảy máu:</text>
            <text x="495" y="418" font-size="10" fill="#059669">• PPI hoặc Vonoprazan</text>
            <text x="487" y="438" font-size="10" fill="var(--color-text-muted, #64748b)">• Tiền sử chảy máu loét:</text>
            <text x="495" y="456" font-size="10" fill="#2563eb">• Tiệt trừ HP + Duy trì PPI</text>
            <text x="487" y="478" font-size="10" fill="var(--color-text-muted, #64748b)">• Nếu phối hợp NSAIDs:</text>
            ...
            <rect x="700" y="330" width="195" height="175" rx="10" fill="var(--surface)" stroke="var(--color-purple, #8b5cf6)" stroke-width="1.5"/>
            <rect x="700" y="330" width="195" height="30" rx="10" fill="rgba(139, 92, 246, 0.08)"/>
            <text x="797" y="350" font-size="11.5" font-weight="700" fill="#5b21b6" text-anchor="middle">4. THỂ ĐẶC BIỆT</text>
            <text x="710" y="380" font-size="10" font-weight="700" fill="var(--color-text, #0f172a)">• Loét vô căn (Idiopathic):</text>
            <text x="718" y="398" font-size="9.5" fill="var(--color-text-muted, #64748b)">PPI dài hạn / Duy trì H2RA</text>
            <text x="710" y="420" font-size="10" font-weight="700" fill="var(--color-text, #0f172a)">• Loét mỏm cắt sau mổ:</text>
            <text x="718" y="438" font-size="9.5" fill="var(--color-text-muted, #64748b)">Khởi trị ngay bằng PPI</text>
            <text x="710" y="460" font-size="10" font-weight="700" fill="var(--color-text, #0f172a)">• Loét do thiếu máu:</text>
            <text x="718" y="478" font-size="9.5" fill="var(--color-text-muted, #64748b)">PPI/Misoprostol + Chụp mạch</text>
          </svg>
        </div>
      </div>
    </div>
