  ...
  <div class="flowchart-editorial-card">
    <div class="flowchart-editorial-hdr">
      <div class="flowchart-editorial-title">
        ...
        <span>SƠ ĐỒ TRỰC QUAN HÓA 6 GIAI ĐOẠN BIẾN ĐỔI ĐIỆN TIM &amp; NGƯỠNG KALI MÁU</span>
      </div>
      <span class="flow-step-badge flow-badge-red">Editorial ECG Studio 2.0</span>
    </div>
    <div class="flowchart-editorial-canvas">
      <svg viewBox="0 0 900 320" width="100%" height="100%" class="med-svg svg-diagram" xmlns="http://www.w3.org/2000/svg">
        <defs>
    ...
    <div class="flowchart-legend-row">
      <div class="flowchart-legend-item"><span class="legend-dot" style="background: #10b981;"></span> Giai đoạn 1-2 (5.5 - 6.5 mmol/L): Sóng T cao nhọn, đối xứng</div>
      <div class="flowchart-legend-item"><span class="legend-dot" style="background: #f59e0b;"></span> Giai đoạn 3-4 (6.5 - 8.0 mmol/L): PR kéo dài, P dẹt/mất, QRS giãn rộng</div>
      <div class="flowchart-legend-item"><span class="legend-dot" style="background: #dc2626;"></span> Giai đoạn 5-6 (&gt; 8.0 mmol/L): Sóng hình sin (Sine wave), Rung thất / Vô tâm thu</div>
    </div>
  </div>
</section>
  ...
  <div class="flowchart-editorial-card">
    <div class="flowchart-editorial-hdr">
      <div class="flowchart-editorial-title">
        ...
        <span>LƯU ĐỒ THUẬT TOÁN XỬ TRÍ TĂNG KALI MÁU CẤP CỨU (VUNA 2026)</span>
      </div>
      <span class="flow-step-badge flow-badge-green">Editorial SVG Studio 2.0</span>
    </div>
    <div class="flowchart-editorial-canvas">
      <svg viewBox="0 0 920 620" width="100%" height="100%" class="med-svg svg-diagram" xmlns="http://www.w3.org/2000/svg">
        <defs>
    ...
    <div class="flowchart-legend-row">
      <div class="flowchart-legend-item"><span class="legend-dot" style="background: #dc2626;"></span> Ổn định màng tế bào: Calcium gluconate / chloride tiêm TM tức thì</div>
      <div class="flowchart-legend-item"><span class="legend-dot" style="background: #0284c7;"></span> Dịch chuyển K vào nội bào: Insulin + Glucose 20%, Khí dung Salbutamol</div>
      <div class="flowchart-legend-item"><span class="legend-dot" style="background: #10b981;"></span> Đào thải K khỏi cơ thể: Lợi tiểu quai, Nhựa trao đổi ion, Thận nhân tạo</div>
    </div>
  </div>
</section>
...
<section id="sec-luo-do-ckd5" class="guideline-section">
  ...
  <div class="flowchart-editorial-card">
    <div class="flowchart-editorial-hdr">
      <div class="flowchart-editorial-title">
        <i class="fa-solid fa-hospital-user" style="color: var(--color-primary, #0284c7);"></i>
        <span>LƯU ĐỒ PHÂN TẦNG XỬ TRÍ CKD GIAI ĐOẠN 5 THEO NỒNG ĐỘ KALI &amp; CHỈ ĐỊNH LỌC MÁU</span>
      </div>
      <span class="flow-step-badge flow-badge-blue">Editorial SVG Studio 2.0</span>
    </div>
    <div class="flowchart-editorial-canvas">
      <svg viewBox="0 0 920 480" width="100%" height="100%" class="med-svg svg-diagram" xmlns="http://www.w3.org/2000/svg">
        {/* Top Title */}
    ...
    <div class="flowchart-legend-row">
      <div class="flowchart-legend-item"><span class="legend-dot" style="background: #10b981;"></span> K &lt; 6.0 mmol/L: Điều trị nội khoa bảo tồn, chỉnh dịch thẩm phân</div>
      <div class="flowchart-legend-item"><span class="legend-dot" style="background: #f59e0b;"></span> K 6.0 - 6.5 mmol/L: Cân nhắc lọc máu cấp nếu kém đáp ứng nội khoa</div>
      <div class="flowchart-legend-item"><span class="legend-dot" style="background: #dc2626;"></span> K &gt; 6.5 mmol/L hoặc có biến đổi ECG: Chỉ định lọc máu cấp cứu tức thì</div>
    </div>
  </div>
</section>
