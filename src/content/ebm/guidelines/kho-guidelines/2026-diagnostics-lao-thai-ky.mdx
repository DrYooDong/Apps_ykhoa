...
cor: "I"
loe: "A"
description: "Tổng quan cập nhật EBM 2026 trên tạp chí Diagnostics về bệnh lao trong thai kỳ: dịch tễ học, biến chứng mẹ - thai, thuật toán chẩn đoán tích hợp, phác đồ hàng 1, quản lý lao kháng thuốc MDR-TB, đồng nhiễm HIV, lao bẩm sinh và chăm sóc chu sinh."
tags:
  - "Lao thai kỳ"
...
sections:
  ...
  - id: "sec-sosinh-hauphu"
    number: 7
    title: "Lao sơ sinh, Thời kỳ sau sinh & Ngừa thai"
...
<section class="stats-strip theme-trial">
  <div class="stats-grid">
    ...
    <div class="stat-card">
      ...
      <div class="stat-lbl">Gia tăng nguy cơ tử vong chu sinh do lao hoạt động trong thai kỳ</div>
    </div>
    <div class="stat-card">
    ...
    <div class="stat-card">
      ...
      <div class="stat-lbl">Tăng tỷ lệ mắc lao bùng phát trong 180 ngày đầu sau sinh (Postpartum)</div>
    </div>
  </div>
</section>
...
<div class="quickmenu" id="quickmenu">
  <div class="quickmenu-inner">
    ...
    <a href="#sec-luodo-chandoan" class="quickmenu-item">4. Lưu đồ tích hợp</a>
    <a href="#sec-dieutri-hang1" class="quickmenu-item">5. Phác đồ hàng 1</a>
    <a href="#sec-mdr-hiv" class="quickmenu-item">6. MDR-TB &amp; HIV</a>
    <a href="#sec-sosinh-hauphu" class="quickmenu-item">7. Sơ sinh &amp; Hậu sản</a>
...
<div class="page-content">
  ...
  <div class="sec-card" id="sec-dichte">
    <div class="sec-hdr">
      ...
      <h2 class="sec-title">1. Dịch Tễ Học Toàn Cầu, Gánh Nặng Lao Thai Kỳ &amp; Phương Pháp Tổng Quan (PRISMA)</h2>
    </div>
    <div class="sec-body">
      ...
      <div class="updates-grid" style="margin-top: 1.25rem;">
        <div class="update-card">
          ...
          <div class="update-card-header">
            ...
            <div class="update-card-title">Phân Bố Dân Số &amp; Địa Lý</div>
          </div>
      ...
      <!-- FIGURE 1: PRISMA SELECTION PROCESS VISUAL DIAGRAM -->
      <div style="margin-top: 1.5rem; background: var(--color-surface); border: 1px solid var(--color-border); border-radius: 8px; padding: 1.25rem;">
        <h3 style="margin-top: 0; font-size: 1.05rem; color: var(--color-primary); display: flex; align-items: center; gap: 0.5rem;">
          <i class="fa-solid fa-filter"></i> Sơ đồ PRISMA: Quy Trình Lựa Chọn Tài Liệu Tổng Quan (Figure 1)
        </h3>
        <p style="font-size: 0.9rem; color: var(--color-text-muted); margin-bottom: 1rem;">
          Tổng quan tự sự (narrative review) thực hiện tìm kiếm trên cơ sở dữ liệu PubMed/MEDLINE, Scopus và Web of Science giai đoạn tháng 1/2000 – tháng 5/2026:
        </p>

        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1rem;">
          <div style="background: var(--color-bg); border-left: 4px solid #0284c7; padding: 0.75rem; border-radius: 4px;">
            <div style="font-weight: 600; color: #0284c7;">1. Nhận diện (Identification)</div>
            <div style="font-size: 0.85rem; margin-top: 0.25rem;">
              • Databases: n = 2<br />
              • Registers: n = 131<br />
              • Tổ chức quốc tế: n = 17<br />
              <em>Loại n = 7 trùng lặp, n = 32 lý do khác</em>
            </div>
          </div>

          <div style="background: var(--color-bg); border-left: 4px solid #f59e0b; padding: 0.75rem; border-radius: 4px;">
            <div style="font-weight: 600; color: #f59e0b;">2. Sàng lọc (Screening)</div>
            <div style="font-size: 0.85rem; margin-top: 0.25rem;">
              • Sàng lọc tiêu đề/abstract: n = 94 (loại n = 5)<br />
              • Tìm kiếm toàn văn: n = 89 (database) + n = 17 (khác)<br />
              <em>Loại n = 34 không lấy được toàn văn</em>
            </div>
          </div>

          <div style="background: var(--color-bg); border-left: 4px solid #8b5cf6; padding: 0.75rem; border-radius: 4px;">
            <div style="font-weight: 600; color: #8b5cf6;">3. Đủ điều kiện (Eligibility)</div>
            <div style="font-size: 0.85rem; margin-top: 0.25rem;">
              • Đánh giá toàn văn: n = 55 (DB) + n = 17 (khác)<br />
              <em>Loại n = 9 từ DB (ngôn ngữ, trùng, sai kết cục)<br />
              Loại n = 4 từ nguồn khác (lỗi thời, sai đối tượng)</em>
            </div>
          </div>

          <div style="background: var(--color-bg); border-left: 4px solid #10b981; padding: 0.75rem; border-radius: 4px;">
            <div style="font-weight: 600; color: #10b981;">4. Đưa vào nghiên cứu (Included)</div>
            <div style="font-size: 0.85rem; margin-top: 0.25rem;">
              <strong>Tổng cộng 46 nghiên cứu</strong> thuộc 13 báo cáo tổng hợp được phân tích chuyên sâu về dịch tễ, chẩn đoán, dược lý và kết cục thai kỳ.
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="updates-grid">
        <div class="update-card">
          ...
          <div class="update-card-header">
            ...
            <div class="update-card-title">Tác Nhân &amp; 3 Kịch Bản Tự Nhiên</div>
          </div>
          <div class="update-card-body">
            <ul style="margin-left: 1rem; line-height: 1.7;">
              <li><strong>Phức hợp M. tuberculosis (MTBC):</strong> Lây truyền qua các hạt khí dung khi bệnh nhân ho, hắt hơi. <em>M. bovis</em> có đặc tính đề kháng tự nhiên với Pyrazinamide.</li>
              <li><strong>1. Loại bỏ sớm / Kháng vi khuẩn:</strong> Nhờ hệ miễn dịch bẩm sinh và đại thực bào phế nang.</li>
              <li><strong>2. Nhiễm lao (Tuberculosis Infection):</strong> Phản ứng miễn dịch qua trung gian tế bào tồn tại dai dẳng (TST hoặc IGRA dương tính) nhưng <strong>không có triệu chứng hay tổn thương hoạt động</strong> (chiếm 1/4 – 1/3 dân số thế giới).</li>
          ...
          <div class="update-verdict verdict-blue">Diễn tiến sinh bệnh học</div>
        </div>
        ...
        <div class="update-card">
          ...
          <div class="update-card-header">
            ...
            <div class="update-card-title">Sự Thay Đổi Miễn Dịch Trong Thai Kỳ</div>
          </div>
          <div class="update-card-body">
            <ul style="margin-left: 1rem; line-height: 1.7;">
              <li>Thai kỳ tạo ra trạng thái dung nạp miễn dịch sinh lý để bảo vệ thai nhi (dị ghép bán phần), với sự <strong>chuyển dịch cán cân miễn dịch từ Th1 sang ưu thế Th2</strong>.</li>
              <li>Sự ức chế đáp ứng Th1 (giảm sản xuất IFN-γ và TNF-α) làm suy yếu khả năng kiểm soát vi khuẩn lao trong u hạt, làm tăng nguy cơ bùng phát từ nhiễm lao tiềm ẩn thành lao hoạt động.</li>
              <li>Các yếu tố nguy cơ phối hợp: Đồng nhiễm HIV, Đái tháo đường (DM/GDM), suy dinh dưỡng, nghèo đói và điều kiện sống chật chội.</li>
            </ul>
          </div>
          ...
          <table class="regimen-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>Thiếu máu nặng (tăng gấp 4 lần), suy dinh dưỡng, suy kiệt và tăng nguy cơ nhiễm trùng huyết.</td>
              </tr>
              <tr>
                ...
                <td>Viêm mạn tính gây rối loạn chức năng nội mạc mạch máu nhau thai. <em>Tương tác thuốc:</em> Rifampicin cảm ứng mạnh CYP450 làm giảm hiệu quả của Methyldopa; khuyến cáo ưu tiên dùng chẹn beta hoặc chẹn kênh calci (Nifedipine).</td>
              </tr>
              <tr>
                <td class="source-cell"><strong>Lao nhau thai &amp; Viêm màng ối</strong></td>
                <td><span class="rx-tag preferred">Đặc thù thai kỳ</span></td>
                <td>Vi khuẩn lan theo đường máu vào bánh nhau: Đại thể thấy bánh nhau phì đại, có ổ hoại tử bã đậu vàng-trắng; vi thể thấy nang củ hoại tử với tế bào khổng lồ Langhans hoặc viêm màng thai thâm nhiễm bạch cầu trung tính.</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>Động tác rặn đẻ kéo dài làm tăng vọt áp lực trong lồng ngực gây vỡ bóng khí xơ sẹo, dẫn đến tràn khí màng phổi áp lực. <strong>Chỉ định:</strong> Cân nhắc thủ thuật giúp sinh (giác hút/vacuum) để rút ngắn giai đoạn 2 chuyển dạ.</td>
              </tr>
            </tbody>
          </table>
        </div>
  ...
  <div class="sec-card" id="sec-luodo-chandoan">
    <div class="sec-hdr">
      <span class="sec-hdr-icon">🔀</span>
      <h2 class="sec-title">4. Lưu Đồ Thuật Toán Chẩn Đoán Tích Hợp (Figure 6 &amp; Interactive Flowchart)</h2>
    </div>
    <div class="sec-body">
      ...
      <div class="infobox info">
        ...
        <div>
          ...
          Phối hợp chặt chẽ giữa <strong>Đánh giá lâm sàng</strong>, <strong>Điều tra vi sinh phân tử</strong>, <strong>Chẩn đoán hình ảnh an toàn</strong> và <strong>Phối hợp liên chuyên khoa</strong> (Sản khoa – Truyền nhiễm – Hô hấp – Sơ sinh).
        </div>
      </div>
      ...
      <div class="fig-card" style="margin-top: 1.25rem;">
        ...
        <div class="fig-caption">
          ...
          Lưu đồ thuật toán chẩn đoán tích hợp cho thai phụ nghi ngờ mắc bệnh lao: Kết hợp đánh giá lâm sàng, xét nghiệm vi sinh/phân tử, đánh giá hình ảnh học và tiêu chuẩn hội chẩn/chuyển viện chuyên khoa.
        </div>
      </div>

      <!-- VISUAL CLINICAL FLOWCHART COMPONENT -->
      <div style="margin-top: 1.5rem; background: var(--color-surface); border: 1px solid var(--color-border); border-radius: 8px; padding: 1.25rem;">
        <h3 style="font-size: 1.05rem; color: var(--color-primary); margin-top: 0; margin-bottom: 1rem; display: flex; align-items: center; gap: 0.5rem;">
          <i class="fa-solid fa-network-wired"></i> Mô Hình Hóa Thuật Toán Chẩn Đoán 6 Bước Thực Chiến
        </h3>

        <div style="display: flex; flex-direction: column; gap: 1rem;">
          
          <!-- BƯỚC 1 -->
          <div style="border: 1px solid #0284c7; background: rgba(2, 132, 199, 0.05); border-radius: 6px; padding: 1rem;">
            <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap;">
              <span style="font-weight: 700; color: #0284c7; font-size: 0.95rem;">BƯỚC 1: NHẬN DIỆN THAI PHỤ CÓ NGUY CƠ CAO HOẶC TRIỆU CHỨNG NGHI NGỜ</span>
              <span style="background: #0284c7; color: #fff; font-size: 0.75rem; padding: 2px 8px; border-radius: 12px;">Sàng lọc đầu vào</span>
            </div>
            <p style="margin: 0.5rem 0 0 0; font-size: 0.9rem; line-height: 1.6;">
              Thai phụ có <strong>bất kỳ dấu hiệu nào sau đây:</strong><br />
              • Ho kéo dài ≥ 2 tuần &nbsp;|&nbsp; • Sốt nhẹ về chiều / Sốt không rõ nguyên nhân &nbsp;|&nbsp; • Sụt cân hoặc không tăng cân thai kỳ &nbsp;|&nbsp; • Đổ mồ hôi đêm<br />
              • Tiền sử tiếp xúc trực tiếp nguồn lây lao &nbsp;|&nbsp; • Nhiễm HIV hoặc cơ địa suy giảm miễn dịch nặng
            </p>
          </div>

          <div style="text-align: center; color: var(--color-text-muted); font-size: 1.2rem;"><i class="fa-solid fa-arrow-down"></i></div>

          <!-- BƯỚC 2 & 3: SONG HÀNH VI SINH VÀ HÌNH ẢNH -->
          <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1rem;">
            
            <div style="border: 1px solid #10b981; background: rgba(16, 185, 129, 0.05); border-radius: 6px; padding: 1rem;">
              <div style="font-weight: 700; color: #10b981; font-size: 0.95rem;">BƯỚC 2: ĐIỀU TRA VI SINH &amp; PHÂN TỬ</div>
              <ul style="margin: 0.5rem 0 0 1rem; font-size: 0.88rem; line-height: 1.6;">
                <li>Thu thập <strong>2–3 mẫu đờm</strong> (ưu tiên sáng sớm).</li>
                <li><strong>GeneXpert MTB/RIF</strong> hoặc <strong>Xpert Ultra</strong>: Bắt buộc để xác định nhanh vi khuẩn &amp; gen kháng Rifampicin trong 2 giờ.</li>
                <li><strong>Nhuộm soi AFB</strong> (Ziehl-Neelsen) đánh giá tải lượng.</li>
                <li><strong>Nuôi cấy MGIT/LJ</strong>: Làm kháng sinh đồ (DST).</li>
                <li><em>Nếu CD4 &lt; 100/µL hoặc HIV nặng:</em> Làm thêm LF-LAM nước tiểu.</li>
              </ul>
            </div>

            <div style="border: 1px solid #8b5cf6; background: rgba(139, 92, 246, 0.05); border-radius: 6px; padding: 1rem;">
              <div style="font-weight: 700; color: #8b5cf6; font-size: 0.95rem;">BƯỚC 3: ĐÁNH GIÁ HÌNH ẢNH AN TOÀN</div>
              <ul style="margin: 0.5rem 0 0 1rem; font-size: 0.88rem; line-height: 1.6;">
                <li><strong>Chụp X-quang ngực (CXR)</strong> tư thế thẳng &amp; nghiêng: Bắt buộc sử dụng <strong>tấm chì chắn bụng (Abdominal shielding)</strong>.</li>
                <li><em>Trường hợp CXR bình thường nhưng lâm sàng nghi ngờ cao:</em> Cân nhắc chụp <strong>CT ngực liều thấp</strong> không thuốc cản quang (nghi lao kê, hạch trung thất, lao ngoài phổi).</li>
                <li>Liều bức xạ thai nhi từ CXR chắn bụng &lt; 0,01 mGy (ngưỡng dị tật &gt; 100 mGy).</li>
              </ul>
            </div>
          ...
          <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1rem;">
            ...
            <div style="border-left: 4px solid #10b981; background: var(--color-bg); padding: 1rem; border-radius: 4px;">
              <div style="font-weight: 700; color: #10b981;">Nhánh 1: GeneXpert (+) &amp; Không kháng Rifampicin</div>
              <p style="margin: 0.25rem 0 0 0; font-size: 0.88rem;">
                &rarr; Khởi trị ngay phác đồ lao nhạy cảm hàng 1 chuẩn 6 tháng (<strong>2HRZE / 4HR</strong>).<br />
                &rarr; Bắt buộc bổ sung Pyridoxine (B6) 25–50 mg/ngày.<br />
                &rarr; Tiêm Vitamin K gần ngày dự sinh.
              </p>
            </div>

            <div style="border-left: 4px solid #ef4444; background: var(--color-bg); padding: 1rem; border-radius: 4px;">
              <div style="font-weight: 700; color: #ef4444;">Nhánh 2: Kháng Rifampicin (MDR-TB) hoặc Diễn tiến nặng</div>
              <p style="margin: 0.25rem 0 0 0; font-size: 0.88rem;">
                &rarr; Kích hoạt <strong>Hội chẩn đa chuyên khoa khẩn cấp</strong>.<br />
                &rarr; Chuyển tuyến chuyên khoa Lao &amp; Bệnh Phổi / Bệnh Truyền nhiễm.<br />
                &rarr; Thiết lập phác đồ hoàn toàn đường uống (All-oral MDR-TB).
              </p>
            </div>
          ...
          <!-- BƯỚC 5 & 6: CHĂM SÓC ĐA CHUYÊN KHOA -->
          <div style="border: 1px solid #f59e0b; background: rgba(245, 158, 11, 0.05); border-radius: 6px; padding: 1rem;">
            <div style="font-weight: 700; color: #b45309; font-size: 0.95rem;">BƯỚC 5 &amp; 6: QUẢN LÝ LIÊN CHUYÊN KHOA &amp; KẾ HOẠCH SINH AN TOÀN</div>
            <p style="margin: 0.5rem 0 0 0; font-size: 0.9rem; line-height: 1.6;">
              • <strong>Sản khoa:</strong> Theo dõi tăng trưởng thai qua siêu âm mỗi 3–4 tuần (phát hiện sớm thai chậm tăng trưởng IUGR, viêm màng ối, đờ tử cung); rút ngắn giai đoạn 2 chuyển dạ nếu có bóng khí phổi.<br />
              • <strong>Truyền nhiễm &amp; Hô hấp:</strong> Giám sát đáp ứng vi sinh (soi đờm tháng 2, 5, 6), theo dõi men gan AST/ALT định kỳ.<br />
              • <strong>Sơ sinh:</strong> Đánh giá bánh nhau giải phẫu bệnh; tầm soát lao bẩm sinh theo tiêu chuẩn Cantwell; cách ly tạm thời nếu mẹ còn AFB dương tính.
            </p>
          </div>
  ...
  <div class="sec-card" id="sec-sosinh-hauphu">
    <div class="sec-hdr">
      <span class="sec-hdr-icon">👶</span>
      <h2 class="sec-title">7. Lao Sơ Sinh, Bẩm Sinh (Cantwell Criteria), Chăm Sóc Hậu Sản &amp; Ngừa Thai</h2>
    </div>
    <div class="sec-body">
