...
<div class="page-content">
  ...
  <div class="sec-card" id="sec-hop-cong-cu-toolbox">
    ...
    <div class="sec-body">
      ...
      <FlowchartViewer 
        title="Lưu Đồ Tiếp Cận Đánh Giá & Can Thiệp Suy Yếu - Teo Cơ Trong Xơ Gan (AASLD 2021 Toolbox)"
        code={`flowchart TD
          CIRR([Bệnh nhân xơ gan còn bù hoặc mất bù | start | badge: AASLD 2021 | subtitle: Tầm soát bắt buộc ngay khi chẩn đoán])
          SCREEN[1. Sàng lọc Suy yếu & Nguy cơ Dinh dưỡng | action | subtitle: Thang điểm RFH-NPT + Thang điểm Liver Frailty Index (LFI) tại giường]
          
          LFI_SCORE{Phân tầng Liver Frailty Index (LFI)? | question}
          ROBUST[LFI < 3.2: Thể trạng Khỏe (Robust) | success | subtitle: Đánh giá lại mỗi 12 tháng còn bù hoặc mỗi 6 tháng mất bù]
          PREFRAIL[LFI 3.2 - 4.4: Tiền suy yếu (Prefrail) ⚠️ | warning | subtitle: Đánh giá lại mỗi 3-6 tháng + Khởi động phòng ngừa cấp 2]
          FRAIL[LFI ≥ 4.5: Suy yếu nặng (Frail) 🚨 | danger | badge: Tiên lượng nặng | subtitle: Tăng nguy cơ tử vong chờ ghép & biến cố mất bù - Đánh giá mỗi 8-12 tuần]

          CT_SARCO{Có sẵn phim chụp CT bụng L3? | question}
          SARCO_YES[Xác chẩn Teo cơ (Sarcopenia) trên CT L3 | danger | badge: SMI L3 | subtitle: Diện tích cơ xương < 50 cm²/m² ở nam, < 39 cm²/m² ở nữ]
          SARCO_NO[Đo gián tiếp qua Lực bóp tay & Khám teo cơ thái dương/gốc chi | action]

          TREATMENT[HỘP CÔNG CỤ CAN THIỆP ĐA MÔ THỨC (MANAGEMENT TOOLBOX) ⭐ | action | subtitle: 3 Trục can thiệp cốt lõi AASLD 2021]

          AXIS1[Trục 1: Dinh dưỡng tích cực 🍲 | success | subtitle: 35 kcal/kg/ngày + Đạm 1.2-1.5 g/kg/ngày (CẤM kiêng đạm trong não gan) + Bắt buộc bữa phụ đêm LES]
          AXIS2[Trục 2: Tập luyện F.I.T.T 🏃 | action | subtitle: Aerobic 150-300 min/tuần + Kháng lực 2-3 buổi/tuần sau khi cổ trướng & xuất huyết ổn định]
          AXIS3[Trục 3: Bù vi chất & Nội khoa 💊 | warning | subtitle: Bù Kẽm 50mg, Vitamin D > 30 ng/mL, B1; Cân nhắc Testosterone nếu suy sinh dục nam]

          CIRR --> SCREEN
          SCREEN --> LFI_SCORE
          LFI_SCORE -->|LFI < 3.2| ROBUST
          LFI_SCORE ==>|LFI 3.2-4.4| PREFRAIL
          LFI_SCORE ==>|LFI ≥ 4.5| FRAIL

          PREFRAIL --> CT_SARCO
          FRAIL --> CT_SARCO
          CT_SARCO -->|Có phim CT| SARCO_YES
          CT_SARCO -->|Không có phim CT| SARCO_NO
