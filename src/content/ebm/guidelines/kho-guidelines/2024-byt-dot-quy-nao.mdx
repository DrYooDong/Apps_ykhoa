...
<section id="sec-tong-quan-dich-te" class="guideline-section">
  ...
  <ul>
    ...
    <li><strong>Cơ cấu các thể đột quỵ:</strong>
      <ul>
        <li><strong>Nhồi máu não cấp (Ischemic Stroke):</strong> Chiếm tỷ lệ cao nhất với <strong>76.2%</strong> tổng số ca đột quỵ.</li>
        <li><strong>Chảy máu não tự phát (Intracerebral Hemorrhage — ICH):</strong> Chiếm khoảng <strong>15 – 20%</strong> (cao hơn đáng kể so với các nước phương Tây, liên quan mật thiết đến tỷ lệ tăng huyết áp không kiểm soát).</li>
        <li><strong>Chảy máu dưới nhện (Subarachnoid Hemorrhage — SAH) do vỡ phình mạch:</strong> Chiếm khoảng <strong>3 – 5%</strong>.</li>
        <li><strong>Huyết khối tĩnh mạch não (Cerebral Venous Sinus Thrombosis — CVST):</strong> Chiếm khoảng <strong>0.5 – 1%</strong>, ưu thế ở phụ nữ trẻ tuổi.</li>
      </ul>
    </li>
  </ul>
  ...
  <div class="fig-card my-4">
    ...
    <div class="fig-body text-center">
      <img 
        ...
        alt="Lưu đồ tiếp cận chẩn đoán phân loại nguyên nhân đột quỵ theo TOAST"
  ...
  <div class="fig-card my-4">
    ...
    <div class="fig-body text-center">
      <img 
        ...
        alt="Sơ đồ chẩn đoán cơn thiếu máu não thoáng qua và đột quỵ nhẹ"
        class="img-fluid rounded border shadow-sm"
        loading="lazy"
      />
      <p class="fig-caption mt-2 text-muted">
        <em>Hình 2: Phân nhánh chẩn đoán xác định TIA vs Nhồi máu não dựa trên thời gian kéo dài triệu chứng lâm sàng (&lt; 24h vs &gt; 24h) và sự xuất hiện của tổn thương trên MRI xung DWI. (Nguồn: Quyết định 3312/QĐ-BYT).</em>
      </p>
    </div>
  </div>
  ...
  <div class="fig-card my-4">
    ...
    <div class="fig-body text-center">
      <img 
        ...
        alt="Sơ đồ điều trị thuốc chống kết tập tiểu cầu trong TIA và nhồi máu não"
        class="img-fluid rounded border shadow-sm"
        loading="lazy"
      />
      <p class="fig-caption mt-2 text-muted">
  ...
  <div class="fig-card my-4">
    ...
    <div class="fig-body text-center">
      <img 
        ...
        alt="Sơ đồ khuyến cáo điều trị thuốc chống đông trong đột quỵ do tim"
        class="img-fluid rounded border shadow-sm"
        loading="lazy"
      />
      <p class="fig-caption mt-2 text-muted">
...
<section id="sec-nhoi-mau-nao-cap" class="guideline-section">
  ...
  <ul>
    ...
    <li><strong>Kiểm soát đường huyết:</strong>
      <ul>
        <li>Hạ đường huyết: Bù Glucose tĩnh mạch nhanh ngay khi glucose máu <strong>&lt; 60 mg/dL (&lt; 3.3 mmol/L)</strong> để loại trừ tình trạng giả đột quỵ (Stroke mimic).</li>
        <li>Tăng đường huyết: Sử dụng Insulin hạ đường huyết khi glucose máu <strong>&gt; 180 mg/dL (&gt; 10.0 mmol/L)</strong>; duy trì khoảng đích an toàn từ <strong>140 – 180 mg/dL (7.8 – 10.0 mmol/L)</strong>. Tránh tuyệt đối hạ đường huyết do điều chỉnh quá tay.</li>
      </ul>
    </li>
  </ul>
  ...
  <div class="fig-card my-4">
    ...
    <div class="fig-body text-center">
      <img 
        ...
        alt="Lưu đồ quy trình chẩn đoán nhồi máu não cấp tính"
        class="img-fluid rounded border shadow-sm"
        loading="lazy"
      />
      <p class="fig-caption mt-2 text-muted">
  ...
  <div class="fig-card my-4">
    ...
    <div class="fig-body text-center">
      <img 
        ...
        alt="Lưu đồ định hướng điều trị tiêu sợi huyết và lấy huyết khối cơ học"
        class="img-fluid rounded border shadow-sm"
        loading="lazy"
      />
      <p class="fig-caption mt-2 text-muted">
  ...
  <div class="fig-card my-4">
    ...
    <div class="fig-body text-center">
      <img 
        ...
        alt="Lưu đồ thuật toán lựa chọn hình ảnh học trong nhồi máu não cấp"
        class="img-fluid rounded border shadow-sm"
        loading="lazy"
      />
      <p class="fig-caption mt-2 text-muted">
...
<section id="sec-tieu-soi-huyet" class="guideline-section">
  ...
  <ul>
    ...
    <li><strong>Mở rộng cửa sổ tiêu sợi huyết (4.5 – 9 giờ & Đột quỵ thức giấc):</strong>
      <ul>
        <li><em>Đột quỵ thức giấc (Wake-up stroke):</em> Chỉ định dựa trên tiêu chuẩn <strong>Bất tương xứng DWI-FLAIR (DWI-FLAIR Mismatch)</strong> trên MRI (tổn thương rõ trên DWI nhưng chưa xuất hiện trên FLAIR, chứng tỏ nhồi máu mới xuất hiện &lt; 4.5 giờ).</li>
        <li><em>Cửa sổ 4.5 – 9 giờ:</em> Chỉ định khi có hình ảnh tưới máu não tự động (CTP/PWI) đáp ứng tiêu chuẩn lõi hoại tử &lt; 70 mL, tỷ lệ Penumbra/Lõi &gt; 1.2 và thể tích Penumbra &gt; 10 mL.</li>
      </ul>
    </li>
    <li><strong>Các chống chỉ định tuyệt đối sống còn:</strong>
      <ul>
        <li>Tiền sử xuất huyết não hoặc có hình ảnh xuất huyết trên phim chụp CT/MRI cấp.</li>
        <li>Chấn thương đầu nặng hoặc phẫu thuật sọ não/cột sống trong vòng 3 tháng.</li>
        <li>Huyết áp không hạ được xuống dưới 185/110 mmHg dù đã dùng thuốc hạ áp tĩnh mạch.</li>
        <li>Đang dùng thuốc chống đông có <strong>INR &gt; 1.7</strong>, dùng NOAC trong 48 giờ, hoặc Heparin có aPTT kéo dài &gt; 40 giây.</li>
        <li>Số lượng tiểu cầu <strong>&lt; 100 &times; 10⁹/L</strong>; nồng độ Glucose máu &lt; 50 mg/dL (&lt; 2.7 mmol/L).</li>
      </ul>
    </li>
  </ul>
...
<section id="sec-lay-huyet-khoi-co-hoc" class="guideline-section">
  ...
  <ul>
    <li><strong>Cửa sổ chuẩn &le; 6 giờ đầu:</strong>
      <ul>
        <li>Tuổi &ge; 18, điểm mRS trước đột quỵ &le; 1.</li>
        <li>Tắc động mạch lớn tuần hoàn trước: Đoạn tận động mạch cảnh trong (ICA), đoạn M1 hoặc nhánh lớn M2 động mạch não giữa, hoặc đoạn A1/A2 động mạch não trước.</li>
        <li>Điểm <strong>NIHSS &ge; 6 điểm</strong> và điểm <strong>ASPECTS &ge; 6 điểm</strong> trên phim CT không cản quang.</li>
      </ul>
    </li>
    <li><strong>Cửa sổ mở rộng 6 – 24 giờ đầu (Tiêu chuẩn DAWN & DEFUSE 3):</strong>
      <ul>
        <li><em>Tiêu chuẩn DAWN (6 – 24 giờ):</em> Dựa trên bất tương xứng giữa mức độ thiếu hụt lâm sàng (NIHSS) và thể tích lõi hoại tử trên CTP/DWI (Nhóm &ge; 80 tuổi: NIHSS &ge; 10 và lõi &lt; 21 mL; Nhóm &lt; 80 tuổi: NIHSS &ge; 10 và lõi &lt; 31 mL, hoặc NIHSS &ge; 20 và lõi &lt; 51 mL).</li>
        <li><em>Tiêu chuẩn DEFUSE 3 (6 – 16 giờ):</em> Tuổi 18 – 90, NIHSS &ge; 6, thể tích lõi nhồi máu &lt; 70 mL, thể tích Penumbra &ge; 15 mL và tỷ số Penumbra/Lõi &ge; 1.8.</li>
      </ul>
    </li>
    <li><strong>Tắc động mạch thân nền (Tuần hoàn sau):</strong> Chỉ định lấy huyết khối cơ học trong cửa sổ <strong>12 – 24 giờ</strong> cho bệnh nhân có NIHSS &ge; 6 điểm để cứu sống vùng thân não.</li>
  </ul>
...
<section id="sec-phinh-mach-nao" class="guideline-section">
  ...
  <ul>
    ...
    <li><strong>Kiểm soát tối cấp:</strong>
      <ul>
        <li>Hạ huyết áp tâm thu xuống <strong>&lt; 160 mmHg (hoặc HATB &lt; 110 mmHg)</strong> bằng Nicardipine trước khi túi phình được bít tắc.</li>
        <li>Chống co thắt mạch não: <strong>Nimodipine 60 mg uống mỗi 4 giờ</strong> (kéo dài liên tục đến hết ngày thứ 21).</li>
        <li><strong>Bít tắc túi phình sớm:</strong> Tiến hành can thiệp nút vòng xoắn kim loại (Coiling) hoặc phẫu thuật kẹp cổ túi phình (Clipping) trong vòng <strong>24 – 72 giờ đầu</strong> để phòng ngừa biến cố chảy máu tái phát (vốn có tỷ lệ tử vong lên tới 50%).</li>
      </ul>
    </li>
  </ul>
  ...
  <div class="fig-card my-4">
    ...
    <div class="fig-body text-center">
      <img 
        ...
        alt="Lưu đồ quy trình chẩn đoán và điều trị vỡ phình động mạch não"
        class="img-fluid rounded border shadow-sm"
        loading="lazy"
      />
      <p class="fig-caption mt-2 text-muted">
...
<section id="sec-hktmn" class="guideline-section">
  ...
  <div class="fig-card my-4">
    ...
    <div class="fig-body text-center">
      <img 
        ...
        alt="Lưu đồ chẩn đoán và điều trị huyết khối tĩnh mạch não"
        class="img-fluid rounded border shadow-sm"
        loading="lazy"
      />
      <p class="fig-caption mt-2 text-muted">
  ...
  <ul>
    ...
    <li><strong>Thời gian duy trì chống đông đường uống (Warfarin đích INR 2.0 – 3.0 hoặc DOACs):</strong>
      <ul>
        <li>Duy trì <strong>3 tháng:</strong> Có yếu tố nguy cơ tạm thời đã giải quyết dứt điểm (sau sinh, nhiễm trùng cấp).</li>
        <li>Duy trì <strong>6 – 12 tháng:</strong> HKTMN tự phát không rõ nguyên nhân hoặc tăng đông nhẹ.</li>
        <li>Duy trì <strong>suốt đời:</strong> Có tình trạng tăng đông nặng do di truyền (đột biến gen Prothrombin, thiếu hụt Antithrombin III, Protein C/S) hoặc HKTMN tái phát.</li>
      </ul>
    </li>
  </ul>
</section>
...
<section id="sec-sa-sut-tri-tue" class="guideline-section">
  ...
  <ul>
    ...
    <li><strong>Điều trị nội khoa:</strong>
      <ul>
        <li>Kiểm soát nghiêm ngặt các yếu tố nguy cơ mạch máu (Huyết áp &lt; 130/80 mmHg, Statin liều cao, kiểm soát đái tháo đường).</li>
        <li>Thuốc ức chế men acetylcholinesterase: <strong>Donepezil</strong> (Khuyến cáo Loại I, Hạng A) hoặc Galantamine cho thể sa sút trí tuệ hỗn hợp.</li>
        <li>Thuốc đối vận thụ thể NMDA: <strong>Memantine</strong> (Khuyến cáo Loại I, Hạng A) giúp làm chậm suy thoái nhận thức.</li>
        <li>Bổ sung các hợp chất nuôi dưỡng và dinh dưỡng thần kinh: Citicoline, Cerebrolysin concentrate, Ginkgo biloba chuẩn hóa EGb761 (240 mg/ngày), Vinpocetine.</li>
      </ul>
    </li>
  </ul>
</section>
  ...
  <div class="fig-card my-4">
    ...
    <div class="fig-body text-center">
      <img 
        ...
        alt="Lưu đồ hướng dẫn xử trí nhồi máu não kèm PFO ở bệnh nhân 18 đến 60 tuổi"
        class="img-fluid rounded border shadow-sm"
        loading="lazy"
      />
      <p class="fig-caption mt-2 text-muted">
