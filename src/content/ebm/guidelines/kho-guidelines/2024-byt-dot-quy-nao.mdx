  ...
  <div class="fig-card my-4">
    ...
    <div class="fig-body">
      <FlowchartViewer
        ...
        code={`graph TD
  START["Nghi Ngờ Đột Quỵ Nhồi Máu Não Cấp<br/><small>Khám thần kinh cấp cứu • Xác định Last Known Well (LKW)</small>"]:::start --> IMG["1. Chụp CT Không Cản Quang (NCCT) hoặc MRI Não Cấp<br/><small>Mục tiêu: Loại trừ xuất huyết não (ICH/SAH) • Đánh giá điểm ASPECTS</small>"]:::action
  
  IMG --> BLEED{"Có xuất huyết não trên NCCT / T2* GRE?"}:::question
  BLEED -- "Có (+)" --> ICH["Xuất Huyết Não (ICH / SAH)<br/><small>Chuyển phác đồ xử trí xuất huyết nội sọ / vỡ phình mạch</small>"]:::danger
  BLEED -- "Không (-)" --> WIN{"Cửa Sổ Thời Gian Tính Từ LKW?"}:::question
  
  WIN -- "Cửa sổ 0 – 6 Giờ" --> W06["Cửa Sổ 0 – 6 Giờ: NCCT + CTA Mạch Não<br/><small>• ASPECTS ≥ 6: Đủ điều kiện EVT tiêu chuẩn<br/>• CTA: Tìm tắc ĐM lớn (ICA, M1, M2, Basilar)<br/>• Không bắt buộc chụp tưới máu CTP/MRP</small>"]:::success
  WIN -- "Cửa sổ 6 – 24 Giờ / Wake-up" --> W624["Cửa Sổ Kéo Dài 6 – 24H: BẮT BUỘC CTP / MRP<br/><small>• Đánh giá Lõi (Core): CBF < 30% (hoại tử)<br/>• Đánh giá Vùng đe dọa (Penumbra): Tmax > 6s<br/>• Thỏa tiêu chuẩn DAWN / DEFUSE 3 (Mismatch > 15ml)</small>"]:::warning
  
  W06 --> EVT1["Chỉ Định Can Thiệp EVT Ngay (Class I, Level A)"]:::success
  W624 --> EVT2["Chỉ Định EVT Cửa Sổ Mở Rộng Thần Tốc"]:::danger
