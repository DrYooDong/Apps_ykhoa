...
<div class="stats-strip">
  ...
  <div class="page-content">
      ...
      <div class="sec-body">
        ...
        <div class="matrix-grid">
          <div class="matrix-card">
            <div class="matrix-card-title"><span>Độ nhạy &amp; Độ đặc hiệu của GBS</span> <i class="fa-solid fa-chart-line" style="color: var(--color-primary, #0284c7);"></i></div>
          ...
          <div class="matrix-card">
            <div class="matrix-card-title"><span>Cá thể hóa Quyết định Xuất viện</span> <i class="fa-solid fa-user-shield" style="color: var(--color-teal, #0d9488);"></i></div>
            <div class="matrix-card-body">
    ...
    <section class="sec-card" id="sec-3">
      <div class="sec-hdr"><i class="fa-solid fa-clock sec-hdr-icon" style="color: var(--color-success, #10b981);"></i> <h2 class="sec-title">3. Thời Điểm Tối Ưu Nội Soi &amp; Lưu Đồ Tiếp Cận Toàn Diện</h2></div>
      <div class="sec-body">
  ...
  <div class="flowchart-card-header">
    <div class="flowchart-badge-title">
      ...
      <span class="flowchart-badge-text">Lưu Đồ Xử Trí Tiếp Cận UGIB Từ Cấp Cứu Đến Sau Nội Soi (ACG 2021)</span>
    </div>
    <span class="flowchart-version-tag">ACG 2021 • UGIB Guidelines</span>
  </div>
  ...
  <div class="flowchart-svg-scroll">
    ...
    <defs>
      <marker id="arr-u1" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
        <path d="M 0 1.5 L 8 5 L 0 8.5 z" fill="var(--color-text-muted, #64748b)" />
      </marker>
      <marker id="arr-u1-act" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
    ...
    <g class="flow-node">
      ...
      <text x="460" y="36" font-size="13.5" font-weight="700" fill="var(--color-danger, #ef4444)" text-anchor="middle">TIẾP NHẬN XUẤT HUYẾT TIÊU HÓA TRÊN (UGIB)</text>
      <text x="460" y="53" font-size="11" fill="var(--color-text-muted, #64748b)" text-anchor="middle">Bệnh nhân nôn ra máu tươi/máu cục hoặc đi cầu phân đen</text>
    </g>

    <path d="M 460 67 L 460 95" fill="none" stroke="var(--color-primary, #0284c7)" stroke-width="2" marker-end="url(#arr-u1-act)"/>
    ...
    <g class="flow-node">
      ...
      <text x="460" y="126" font-size="12" font-weight="700" fill="var(--color-warning, #d97706)" text-anchor="middle">Phân Tầng Thang Điểm Glasgow-Blatchford</text>
      <text x="460" y="142" font-size="10.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">Điểm GBS của bệnh nhân?</text>
    </g>

    <!-- Left: GBS 0-1 Low Risk -> Outpatient -->
    <path d="M 270 130 L 140 130 L 140 190" fill="none" stroke="var(--color-success, #22c55e)" stroke-width="2" marker-end="url(#arr-u1-act)"/>
    <g>
      <rect x="150" y="118" width="80" height="20" rx="4" fill="var(--color-surface, #ffffff)" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="190" y="132" font-size="10" font-weight="600" fill="var(--color-success, #16a34a)" text-anchor="middle">GBS = 0 – 1</text>
    </g>
    <g class="flow-node">
      <rect x="30" y="190" width="220" height="85" rx="8" fill="var(--color-success-subtle, rgba(34,197,94,0.12))" stroke="var(--color-success, #22c55e)" stroke-width="1.8"/>
      <text x="140" y="213" font-size="12.5" font-weight="700" fill="var(--color-success, #16a34a)" text-anchor="middle">NGUY CƠ CỰC THẤP (≤ 1%)</text>
      <text x="140" y="233" font-size="10.5" fill="var(--color-text, #334155)" text-anchor="middle">Nguy cơ tử vong / can thiệp &lt; 1%</text>
      <text x="140" y="250" font-size="10.5" font-weight="600" fill="var(--color-success, #16a34a)" text-anchor="middle">Xuất viện sớm an toàn</text>
      <text x="140" y="265" font-size="9.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">Theo dõi và hẹn soi ngoại trú</text>
    </g>

    <!-- Right: GBS >= 2 High Risk -> Inpatient Resuscitation -->
    <path d="M 650 130 L 760 130 L 760 190" fill="none" stroke="var(--color-danger, #ef4444)" stroke-width="2" marker-end="url(#arr-u1-act)"/>
    <g>
      <rect x="670" y="118" width="70" height="20" rx="4" fill="var(--color-surface, #ffffff)" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="705" y="132" font-size="10" font-weight="600" fill="var(--color-danger, #ef4444)" text-anchor="middle">GBS ≥ 2</text>
    </g>
    <g class="flow-node">
      <rect x="620" y="190" width="280" height="85" rx="8" fill="var(--color-danger-subtle, rgba(239,68,68,0.12))" stroke="var(--color-danger, #ef4444)" stroke-width="1.8"/>
      <text x="760" y="213" font-size="12.5" font-weight="700" fill="var(--color-danger, #ef4444)" text-anchor="middle">CẦN NHẬP VIỆN &amp; HỒI SỨC</text>
      <text x="760" y="233" font-size="10.5" fill="var(--color-text, #334155)" text-anchor="middle">2 đường truyền lớn • Duy trì MAP ≥ 65</text>
      <text x="760" y="250" font-size="10.5" fill="var(--color-text, #334155)" text-anchor="middle">Truyền máu hạn chế khi Hb &lt; 7 g/dL</text>
      <text x="760" y="265" font-size="9.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">Erythromycin 250mg IV trước soi 30-90p</text>
    </g>

    <!-- Connect High Risk to Endoscopy Timing -->
    <path d="M 760 275 L 760 310 L 460 310 L 460 335" fill="none" stroke="var(--color-primary, #0284c7)" stroke-width="2" marker-end="url(#arr-u1-act)"/>

    <!-- Timing Node -->
    <g class="flow-node">
      <rect x="230" y="335" width="460" height="50" rx="8" fill="var(--color-surface, #ffffff)" stroke="var(--color-primary, #0284c7)" stroke-width="1.8"/>
      <text x="460" y="357" font-size="13" font-weight="700" fill="var(--color-primary, #0284c7)" text-anchor="middle">NỘI SOI TRONG VÒNG 24H (KHI HUYẾT ĐỘNG ỔN ĐỊNH)</text>
      <text x="460" y="374" font-size="10.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">KHÔNG khuyến cáo soi khẩn cấp &lt; 6 giờ khi chưa hồi sức ổn định</text>
    </g>

    <path d="M 460 385 L 460 415" fill="none" stroke="var(--color-primary, #0284c7)" stroke-width="2" marker-end="url(#arr-u1-act)"/>

    <!-- Forrest Decision -->
    <g class="flow-node">
      <polygon points="460,415 650,448 460,481 270,448" fill="var(--color-warning-subtle, rgba(245,158,11,0.12))" stroke="var(--color-warning, #f59e0b)" stroke-width="2"/>
      <text x="460" y="444" font-size="12" font-weight="700" fill="var(--color-warning, #d97706)" text-anchor="middle">Phân Loại Tổn Thương Theo Forrest?</text>
      <text x="460" y="460" font-size="10.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">Đánh giá nguy cơ tái xuất huyết ổ loét</text>
    </g>

    <!-- Bottom Left: Forrest IIc, III -> Low risk -->
    <path d="M 270 448 L 160 448 L 160 495" fill="none" stroke="var(--color-success, #22c55e)" stroke-width="1.8" marker-end="url(#arr-u1-act)"/>
    <g class="flow-node">
      <rect x="40" y="495" width="240" height="40" rx="6" fill="var(--color-success-subtle, rgba(34,197,94,0.12))" stroke="var(--color-success, #22c55e)" stroke-width="1.5"/>
      <text x="160" y="515" font-size="11" font-weight="700" fill="var(--color-success, #16a34a)" text-anchor="middle">Forrest IIc, III: Không can thiệp nội soi</text>
      <text x="160" y="528" font-size="9.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">PPI uống chuẩn • Xuất viện sớm</text>
    </g>

    <!-- Bottom Right: Forrest Ia, Ib, IIa, IIb -> Endoscopic Therapy -->
    <path d="M 650 448 L 760 448 L 760 495" fill="none" stroke="var(--color-danger, #ef4444)" stroke-width="1.8" marker-end="url(#arr-u1-act)"/>
    <g class="flow-node">
      <rect x="620" y="495" width="280" height="40" rx="6" fill="var(--color-danger-subtle, rgba(239,68,68,0.12))" stroke="var(--color-danger, #ef4444)" stroke-width="1.5"/>
      <text x="760" y="515" font-size="11" font-weight="700" fill="var(--color-danger, #ef4444)" text-anchor="middle">Forrest Ia, Ib, IIa, IIb: Can thiệp cầm máu</text>
      <text x="760" y="528" font-size="9.5" fill="var(--color-text-muted, #64748b)" text-anchor="middle">Hemoclip / Nhiệt + PPI IV liều cao 72h</text>
    </g>
  </svg>
  </div>
  ...
  <div class="flowchart-legend-row">
    ...
    <section class="sec-card" id="sec-4">
      <div class="sec-hdr"><i class="fa-solid fa-microscope sec-hdr-icon" style="color: var(--color-purple, #8b5cf6);"></i> <h2 class="sec-title">4. Kỹ Thuật Can Thiệp Nội Soi Cầm Máu Cho Loét Nguy Cơ Cao</h2></div>
      <div class="sec-body">
        ...
        <div class="table-wrapper">
          <table class="med-table">
            ...
            <tbody>
              <tr style="background: var(--color-surface-2, #f8fafc); font-weight: 700;">
    ...
    <section class="sec-card" id="sec-5">
      <div class="sec-hdr"><i class="fa-solid fa-pills sec-hdr-icon" style="color: var(--color-teal, #0d9488);"></i> <h2 class="sec-title">5. Phác Đồ Kháng Tiết Acid (PPI) Sau Can Thiệp Nội Soi</h2></div>
      <div class="sec-body">
    ...
    <section class="sec-card" id="sec-6">
      <div class="sec-hdr"><i class="fa-solid fa-triangle-exclamation sec-hdr-icon" style="color: var(--color-warning, #f59e0b);"></i> <h2 class="sec-title">6. Xử Trí Tái Xuất Huyết &amp; Thất Bại Điều Trị Nội Soi</h2></div>
      <div class="sec-body">
        ...
        <p style="font-size: 0.78rem; color: var(--color-text-muted, #64748b); margin-top: 0.4rem;"><em>Ghi chú:</em> Biến chứng nặng bao gồm suy hô hấp, nhồi máu cơ tim, loạn nhịp, đột quỵ, viêm phổi, toác vết mổ, suy thận cấp. Phần lớn biến chứng ở nhóm nội soi chỉ xảy ra sau khi phải chuyển sang mổ cứu vãn do nội soi lần 2 thất bại.</p>
