...
<div class="page-content">
  ...
  <div class="sec-card" id="sec-nilda-baveno-vi">
    ...
    <div class="sec-body">
      ...
      <div style="margin-top: 1rem;">
        <FlowchartViewer
          title="Lưu Đồ Phân Tầng cACLD & Tiếp Cận CSPH Không Xâm Lấn (AASLD 2024 / Baveno VI)"
          code={`graph TD
  START["BỆNH NHÂN CÓ BỆNH GAN MẠN TÍNH<br/><small>Đo độ cứng gan (LSM) bằng FibroScan/TE + Số lượng tiểu cầu</small>"]:::start --> LSM_CHECK{"Đánh Giá Ngưỡng Độ Cứng Gan (LSM)?"}:::question

  LSM_CHECK -- "LSM < 10 kPa" --> RULE_OUT["LOẠI TRỪ cACLD<br/><small>Nguy cơ biến chứng gan rất thấp • Tiếp tục điều trị nguyên nhân nền</small>"]:::success
  
  LSM_CHECK -- "LSM 10 - 14.9 kPa" --> SUSPECT["NGHI NGỜ cACLD<br/><small>Theo dõi định kỳ hàng năm hoặc làm thêm test chuyên sâu</small>"]:::action

  LSM_CHECK -- "LSM ≥ 15 kPa" --> CONFIRM_CACLD["XÁC CHẨN cACLD (Xơ gan còn bù)<br/><small>Phân tầng nguy cơ tăng áp lực tĩnh mạch cửa có ý nghĩa (CSPH)</small>"]:::warning

  CONFIRM_CACLD --> CSPH_CHECK{"Tiêu Chuẩn CSPH Không Xâm Lấn?"}:::question

  CSPH_CHECK -- "LSM ≥ 25 kPa HOẶC<br/>(LSM 20-24.9 & Tiểu cầu < 150) HOẶC<br/>(LSM 15-19.9 & Tiểu cầu < 110)" --> HAS_CSPH["XÁC CHẨN CÓ CSPH<br/><small>Khởi trị ngay Carvedilol 6.25 - 12.5 mg/ngày<br/>• Ngăn ngừa mất bù đầu tiên (cổ trướng, vỡ giãn)<br/>• KHÔNG CẦN NỘI SOI DẠ DÀY SÀNG LỌC</small>"]:::danger

  CSPH_CHECK -- "LSM < 20 kPa & Tiểu cầu ≥ 150" --> BAVENO6["ĐẠT TIÊU CHUẨN BAVENO VI<br/><small>Nguy cơ giãn TM nguy cơ cao < 5%<br/>• TRÁNH NỘI SOI SÀNG LỌC AN TOÀN<br/>• Theo dõi lại LSM và tiểu cầu hàng năm</small>"]:::success

  CSPH_CHECK -- "LSM 20 - 24.9 & Tiểu cầu ≥ 150<br/>(Vùng xám không thỏa Baveno VI)" --> EGD_NEEDED["CHỈ ĐỊNH NỘI SOI THỰC QUẢN - DẠ DÀY<br/><small>Nếu có búi giãn nguy cơ cao: Khởi trị Carvedilol hoặc Thắt EVL<br/>Nếu không búi giãn: Nội soi lại sau 1-2 năm</small>"]:::action`}
        />
      </div>
  ...
  <div class="sec-card" id="sec-xuathuyetcap-avh">
    ...
    <div class="sec-body">
      ...
      <div style="margin-top: 1rem;">
        <FlowchartViewer
          title="Lưu Đồ Xử Trí Cấp Cứu Xuất Huyết Vỡ Giãn Tĩnh Mạch (AVH) & Preemptive TIPS (AASLD 2024)"
          code={`graph TD
  START["CẤP CỨU XUẤT HUYẾT TIÊU HÓA TRÊN NGHI DO VỠ GIÃN TM (AVH)<br/><small>Nôn máu đỏ tươi / Đi ngoài phân đen • Tiền sử bệnh gan mạn</small>"]:::start --> RESUS["GÓI HỒI SỨC BAN ĐẦU (RESUSCITATION BUNDLE)<br/><small>• Khí đạo: Đặt NKQ nếu suy hô hấp/hôn mê • 2 đường truyền lớn<br/>• Truyền máu hạn chế: Đích Hb 7 - 8 g/dL (Không truyền FFP thường quy)<br/>• Thuốc co mạch tạng: Octreotide / Somatostatin / Terlipressin ngay<br/>• Kháng sinh dự phòng: Ceftriaxone 1g/ngày IV</small>"]:::danger

  RESUS --> EGD["NỘI SOI DẠ DÀY TRONG VÒNG 12 GIỜ ĐẦU<br/><small>Sau khi đã hồi sức ổn định huyết động</small>"]:::action

  EGD --> SOURCE{"Vị Trí Tổn Thương Chảy Máu Trên Nội Soi?"}:::question

  SOURCE -- "Giãn TM Thực quản (GOV1 / EV)" --> EV_TX["THẮT VÒNG CAO SU (EVL)<br/><small>Thắt các búi giãn đang chảy máu hoặc có nút tiểu cầu</small>"]:::action

  SOURCE -- "Giãn TM Phình vị (GOV2 / IGV1)" --> GV_TX["TIÊM KEO CYANOACRYLATE<br/><small>Hoặc cân nhắc can thiệp mạch BRTO / TIPS sớm</small>"]:::action

  EV_TX --> RISK_STRAT{"Phân Tầng Nguy Cơ Thất Bại / Tử Vong Cao?"}:::question
  GV_TX --> RISK_STRAT

  RISK_STRAT -- "NGUY CƠ CAO (Child-Pugh C hoặc Child-Pugh B > 7 có máu chảy)" --> PREEMPT_TIPS["ĐẶT PREEMPTIVE TIPS TRONG 24 - 72 GIỜ ĐẦU<br/><small>• Sử dụng stent có màng bọc polytetrafluoroethylene (ePTFE)<br/>• Giảm ngoạn mục nguy cơ tái xuất huyết và cải thiện tỷ lệ sống còn</small>"]:::danger

  RISK_STRAT -- "NGUY CƠ TIÊU CHUẨN (Child-Pugh A hoặc Child-Pugh B ≤ 7)" --> STD_CARE["DUY TRÌ ĐIỀU TRỊ CHUẨN<br/><small>• Tiếp tục thuốc co mạch tạng 2 - 5 ngày • Kháng sinh 7 ngày<br/>• Bắt đầu Carvedilol sau khi ngừng thuốc co mạch & ổn định<br/>• Thắt EVL định kỳ mỗi 2-4 tuần cho đến khi triệt tiêu búi giãn</small>"]:::success`}
        />
      </div>
