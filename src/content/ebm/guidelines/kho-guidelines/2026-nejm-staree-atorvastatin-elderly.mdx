...
<div class="module-badge-group study-badges">
  <span class="badge badge-indigo"><i class="fa-solid fa-flask-vial"></i> Landmark RCT (Dự Phòng Tiên Phát)</span>
  <span class="badge badge-blue"><i class="fa-solid fa-newspaper"></i> The New England Journal of Medicine</span>
  <span class="badge badge-amber"><i class="fa-solid fa-scale-balanced"></i> Practice-Informing (Cá Thể Hóa Lão Khoa)</span>
  <span class="badge badge-teal"><i class="fa-solid fa-id-card-clip"></i> ClinicalTrials.gov (NCT04026217)</span>
</div>

<section class="stats-strip theme-trial">
  <div class="stats-grid">
    <div class="stat-card">
      <div class="stat-val emerald">HR 0.70 (↓ 30%)</div>
      <div class="stat-lbl">Biến cố Tim mạch Chính (P &lt; 0.001; NNT = 37 sau 5.9 năm)</div>
    </div>
    <div class="stat-card">
      <div class="stat-val amber">HR 0.94 (P = 0.25)</div>
      <div class="stat-lbl">Sống sót không tàn tật (Disability-Free Survival; Không đổi)</div>
    </div>
    <div class="stat-card">
      <div class="stat-val emerald">HR 0.57 (↓ 43%)</div>
      <div class="stat-lbl">Nhồi máu cơ tim &amp; Can thiệp tái thông mạch vành</div>
    </div>
    <div class="stat-card">
      <div class="stat-val rose">3.3% vs 0.9%</div>
      <div class="stat-lbl">Rối loạn gan mật (Tăng ALT/AST &gt; 3x: 1.4% vs 0.3%)</div>
    </div>
  </div>
</section>
    <div class="stat-card">
  ...
  <!-- ==================== SECTION 8 ==================== -->
    ...
    <div class="verdict-box practice-changing">
      <div class="verdict-header">
        ...
        <div class="verdict-title">Đúc Kết Lâm Sàng: Ý Nghĩa Thực Hành Lão Khoa (EBM Clinical Translation)</div>
      </div>
      <div class="verdict-content">
        <div class="verdict-qna">
          <div class="qna-item">
            <div class="qna-q"><i class="fa-solid fa-circle-question"></i> STAREE giải đáp câu hỏi lớn nào trong y học lão khoa?</div>
            <div class="qna-a">STAREE là nghiên cứu ngẫu nhiên mù đôi lớn nhất ở người cao tuổi sống tại cộng đồng (≥ 70 tuổi) chưa từng mắc bệnh tim mạch. Nghiên cứu xác nhận Atorvastatin 40 mg giúp giảm mạnh 30% biến cố tim mạch và 43% nhồi máu cơ tim, nhưng <strong>hoàn toàn không kéo dài tuổi thọ không tàn tật</strong> (Disability-free survival) do tử vong ở lứa tuổi này chủ yếu vì nguyên nhân ngoài tim mạch (ung thư, sa sút trí tuệ, nhiễm trùng).</div>
          </div>
          <div class="qna-item">
            <div class="qna-q"><i class="fa-solid fa-book-medical"></i> Thái độ thực hành lâm sàng đúng mực là gì?</div>
            <div class="qna-a">Không kê đơn Statin thường quy cho mọi người cao tuổi khỏe mạnh. Thay vào đó, cần cá thể hóa dựa trên nguy cơ tim mạch xơ vữa thực tế, kỳ vọng sống, gánh nặng đa bệnh lý, tương tác đa thuốc (polypharmacy) và chia sẻ quyết định (shared decision-making) cùng người bệnh.</div>
          </div>
        </div>
      </div>
    </div>
