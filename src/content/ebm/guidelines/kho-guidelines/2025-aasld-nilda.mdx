        ...
        <div class="update-card">
          ...
          <div class="update-card-body">
            <ul style="margin-left: 1rem; line-height: 1.7;">
              ...
              <li><strong>Viêm gan C trẻ em</strong>: APRI rất kém (AUROC 0.49). Ngược lại, <strong>FibroTest</strong> tương quan chặt chẽ (hệ số tương quan r = 0,81); ngưỡng <strong>&ge; 0.25</strong> có AUROC 0.97 cho &ge;F2; ngưỡng <strong>0.54</strong> có AUROC 0.92 cho F3-4.</li>
            </ul>
          </div>
