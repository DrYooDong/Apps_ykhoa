      ...
      <div class="sec-body">
        ...
        <div class="flowchart-card">
          <div class="flowchart-card-hdr">
            <div class="flowchart-card-hdr-title"><i class="fa-solid fa-diagram-project"></i> Sơ đồ Thuật toán Lâm sàng Leo Thang &amp; Hạ Bậc MCS</div>
            <span class="badge">Escalation &amp; De-escalation Protocol</span>
          </div>
          <div class="flowchart-card-body" style="overflow-x: auto; padding: 1rem;">
            <svg viewBox="0 0 900 400" width="100%" height="400" xmlns="http://www.w3.org/2000/svg" style="max-width: 100%; height: auto; display: block; font-family: 'Inter', system-ui, sans-serif;">
              <defs>
