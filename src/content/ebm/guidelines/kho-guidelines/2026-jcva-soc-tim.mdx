...
<div class="module-badge-group study-badges">
  <span class="badge badge-rose"><i class="fa-solid fa-heart-crack"></i> Cardiothoracic &amp; Vascular Anesthesia Review</span>
  <span class="badge badge-blue"><i class="fa-solid fa-newspaper"></i> JCVA Journal</span>
  <span class="badge badge-emerald"><i class="fa-solid fa-chart-line"></i> Phân Tầng Nguy Cơ SCAI Shock</span>
  <span class="badge badge-teal"><i class="fa-solid fa-heart-pulse"></i> Inotrope, Vận Mạch &amp; Hỗ Trợ Cơ Học MCS</span>
</div>

<section class="stats-strip theme-trial">
  <div class="stats-grid">
    <div class="stat-card">
      <div class="stat-val green">Chẩn Đoán & Phân Loại SCAI</div>
      <div class="stat-lbl">Nhận diện sớm từ Giai đoạn A đến E, đánh giá lặp lại liên tục thay vì chỉ ghi nhận một</div>
    </div>
    <div class="stat-card">
      <div class="stat-val blue">Giám Sát PAC Huyết Động</div>
      <div class="stat-lbl">Đánh giá chi tiết CVP, PCWP, CO, CPO, PAPi và tỷ số RA/PCWP để xác định chính xác kiểu</div>
    </div>
    <div class="stat-card">
      <div class="stat-val amber">Hỗ Trợ Cơ Học (MCS)</div>
      <div class="stat-lbl">Lựa chọn cá thể hóa IABP, Impella (2.5/CP/5.0/5.5), VA-ECMO dựa trên kiểu suy thất và mục</div>
    </div>
    <div class="stat-card">
      <div class="stat-val red">Giải Áp Thất Trái (LV Unloading)</div>
      <div class="stat-lbl">Phối hợp chủ động Impella (ECMELLA) hoặc IABP khi chạy VA-ECMO ngăn chặn quá tải áp lực</div>
    </div>
  </div>
</section>
