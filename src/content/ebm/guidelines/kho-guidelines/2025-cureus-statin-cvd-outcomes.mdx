...
<div class="module-badge-group study-badges">
  ...
  <span class="badge badge-blue"><i class="fa-solid fa-newspaper"></i> Cureus Journal of Medical Science</span>
  <span class="badge badge-emerald"><i class="fa-solid fa-users"></i> N = 506,813 Bệnh Nhân Gộp (7 Nghiên Cứu)</span>
  <span class="badge badge-teal"><i class="fa-solid fa-filter"></i> PRISMA 2009 Compliant</span>
</div>

<section class="stats-strip theme-trial">
  <div class="stats-grid">
    <div class="stat-card">
      <div class="stat-val emerald">RR 0.60 (↓ 40%)</div>
      <div class="stat-lbl">Tử vong do mọi nguyên nhân (95% CI 0.43–0.83; P = 0.002)</div>
    </div>
    <div class="stat-card">
      <div class="stat-val emerald">RR 0.79 (↓ 21%)</div>
      <div class="stat-lbl">Biến cố Tim mạch Chính MACE (95% CI 0.71–0.87; P &lt; 0.00001)</div>
    </div>
    <div class="stat-card">
      <div class="stat-val amber">RR 0.74 (P = 0.07)</div>
      <div class="stat-lbl">Tử vong do nguyên nhân Tim mạch (Xu hướng giảm 26%)</div>
    </div>
    <div class="stat-card">
      <div class="stat-val rose">RR 0.97 (I² = 0%)</div>
      <div class="stat-lbl">Tái nhập viện do Tim mạch (P = 0.68; Hoàn toàn không đổi)</div>
    </div>
  </div>
</section>
    <div class="stat-card">
  ...
  <!-- ==================== SECTION 8 ==================== -->
    ...
    <div class="verdict-box practice-changing">
      <div class="verdict-header">
        ...
        <div class="verdict-title">Đúc Kết Lâm Sàng: Ý Nghĩa Tổng Quan Hệ Thống (EBM Meta-Analysis Translation)</div>
      </div>
      <div class="verdict-content">
        <div class="verdict-qna">
          <div class="qna-item">
            <div class="qna-q"><i class="fa-solid fa-circle-question"></i> Phân tích gộp trên nửa triệu bệnh nhân này khẳng định điều gì?</div>
            <div class="qna-a">Khẳng định vững chắc lợi ích sống còn của liệu pháp Statin trong việc giảm 40% tử vong chung và 21% biến cố MACE với mức độ không đồng nhất I² rất thấp (27%). Điều này củng cố nền tảng Statin là liệu pháp trụ cột bất khả thay thế trong tim mạch học phòng ngừa.</div>
          </div>
          <div class="qna-item">
            <div class="qna-q"><i class="fa-solid fa-triangle-exclamation"></i> Tại sao Statin thất bại trên tiêu chí tái nhập viện (RR 0.97)?</div>
            <div class="qna-a">Statin kiểm soát mảng xơ vữa nhưng không ngăn ngừa được đợt cấp suy tim, rối loạn nhịp tim hoặc rối loạn chuyển hóa đồng mắc. Để giảm tỷ lệ tái nhập viện, cần kết hợp quản lý đa chuyên khoa, phục hồi chức năng tim mạch và tối ưu hóa tuân thủ thuốc thay vì chỉ trông cậy vào đơn trị liệu Statin.</div>
          </div>
        </div>
      </div>
    </div>
