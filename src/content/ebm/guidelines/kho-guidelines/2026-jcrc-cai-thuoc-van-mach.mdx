...
<div class="module-badge-group study-badges">
  <span class="badge badge-rose"><i class="fa-solid fa-scale-balanced"></i> Critical Care Trial Synthesis</span>
  <span class="badge badge-blue"><i class="fa-solid fa-newspaper"></i> Journal of Critical Care (JCRC) / SSC</span>
  <span class="badge badge-emerald"><i class="fa-solid fa-arrows-down-to-line"></i> Trình Tự Cai Thuốc Vận Mạch</span>
  <span class="badge badge-purple"><i class="fa-solid fa-wave-square"></i> Tiếp Cận Theo Kiểu Hình Huyết Động</span>
</div>
