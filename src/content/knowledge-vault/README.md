...
│   ├── symptoms/                       # Danh mục triệu chứng phân tách 12 hệ cơ quan
│   │   ├── toan-than.json              # Toàn thân (33 triệu chứng)
│   │   ├── tim-mach.json               # Tim mạch (21 triệu chứng)
│   │   ├── ho-hap.json                 # Hô hấp (27 triệu chứng)
│   │   ├── tieu-hoa.json               # Tiêu hóa - Gan mật (45 triệu chứng)
│   │   ├── tiet-nieu.json              # Tiết niệu - Thận (10 triệu chứng)
│   │   ├── noi-tiet.json               # Nội tiết - Chuyển hóa (9 triệu chứng)
│   │   ├── than-kinh.json              # Thần kinh - Tri giác (25 triệu chứng)
│   │   ├── da-niem.json                # Da niêm - Giác mạc (18 triệu chứng)
│   │   ├── huyet-hoc.json              # Huyết học (3 triệu chứng)
│   │   ├── san-phu-khoa.json           # Sản phụ khoa (4 triệu chứng)
│   │   ├── can-lam-sang.json           # Cận lâm sàng & Hình ảnh học (111 triệu chứng)
│   │   ├── tien-can.json               # Tiền căn & Dịch tễ (17 triệu chứng)
│   │   └── index.ts                    # TypeScript Registry & Unified Array Export
│   ├── clinical-rules-symptoms.json    # Master Symptoms Bundle Sync (323 triệu chứng)
