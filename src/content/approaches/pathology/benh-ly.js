...
function setupStudioEvents() {
    ...
    if (btnEmbedCode) {
        btnEmbedCode.addEventListener('click', () => {
            const embedSnippet = `<iframe src="${window.location.origin}/src/components/clinical-flow-studio.html" width="100%" height="600" frameborder="0" allowfullscreen></iframe>`;
