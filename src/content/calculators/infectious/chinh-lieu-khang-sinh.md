...
Đối chiếu với tài liệu hướng dẫn phát triển hệ thống [AGENTS.md](../../../../.agents/AGENTS.md), tệp tin này hiện đang hoạt động như một trang độc lập và chưa tích hợp đầy đủ vào hệ sinh thái của dự án:
