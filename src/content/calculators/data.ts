/**
 * CliniPortal — Calculators Database & Metadata (TypeScript Module)
 */
import { ClinicalTool, ToolPartMeta, LabValueItem, LabCategory } from './types';

export const CLINICAL_TOOLS_DATA: ClinicalTool[] = [
  // Phần 1: Chung
  {
    id: "benh-an-noi-khoa",
...
export const PART_METADATA: Record<string, ToolPartMeta> = {
...
export const LAB_VALUES_DATA: Record<LabCategory, LabValueItem[]> = {
  hemato: [
