...
export const CLINICAL_CASES: CaseChallenge[] = [
  // 1. TIM MẠCH: SUY TIM
  {
    ...
    relatedModule: '#/basic-medical/simulators',
    readArticleLink: '#/basic-medical/cases/slb-ccbs-hf'
  },
  ...
  // 2. MẠCH VÀNH: NHỒI MÁU CƠ TIM CẤP
  {
    ...
    relatedModule: '#/basic-medical/simulators',
    readArticleLink: '#/basic-medical/cases/slb-ccbs-acs'
  },
  ...
  // 3. HÔ HẤP: HEN PHẾ QUẢN CẤP
  {
    ...
    relatedModule: '#/basic-medical/simulators',
    readArticleLink: '#/basic-medical/cases/slb-ccbs-hen'
  },
  ...
  // 4. HÔ HẤP NGUY KỊCH: ARDS
  {
    ...
    relatedModule: '#/basic-medical/simulators',
    readArticleLink: '#/basic-medical/cases/slb-ccbs-ards'
  },
  ...
  // 5. TIÊU HÓA - GAN: XƠ GAN & TĂNG ÁP CỬA
  {
    ...
    relatedModule: '#/basic-medical/simulators',
    readArticleLink: '#/basic-medical/cases/slb-ccbs-xg'
  },
  ...
  // 6. TIÊU HÓA: DẠ DÀY & H. PYLORI
  {
    ...
    relatedModule: '#/basic-medical/biochemistry',
    readArticleLink: '#/basic-medical/cases/slb-ccbs-pud'
  },
  ...
  // 7. TIÊU HÓA: VIÊM TỤY CẤP
  {
    ...
    relatedModule: '#/basic-medical/biochemistry',
    readArticleLink: '#/basic-medical/cases/slb-ccbs-vtc'
  },
  ...
  // 8. THẬN: TỔN THƯƠNG THẬN CẤP (AKI)
  {
    ...
    relatedModule: '#/basic-medical/simulators',
    readArticleLink: '#/basic-medical/cases/slb-ccbs-aki'
  },
  ...
  // 9. THẬN: BỆNH THẬN MẠN & LOẠN DƯỠNG XƯƠNG
  {
    ...
    relatedModule: '#/basic-medical/biochemistry',
    readArticleLink: '#/basic-medical/cases/slb-ccbs-ckd'
  },
  ...
  // 10. NỘI TIẾT: DKA
  {
    ...
    relatedModule: '#/basic-medical/biochemistry',
    readArticleLink: '#/basic-medical/cases/slb-ccbs-dka'
  },
  ...
  // 11. NỘI TIẾT: CƠN BÃO GIÁP
  {
    ...
    relatedModule: '#/basic-medical/biochemistry',
    readArticleLink: '#/basic-medical/biochemistry/block2-catalysis-signaling'
  },
  ...
  // 12. HUYẾT HỌC: THIẾU G6PD
  {
    ...
    relatedModule: '#/basic-medical/biochemistry',
    readArticleLink: '#/basic-medical/biochemistry/block4-intermediary-metabolism'
  },
  ...
  // 14. MIỄN DỊCH: SỐC PHẢN VỆ
  {
    ...
    relatedModule: '#/basic-medical/simulators',
    readArticleLink: '#/basic-medical/cases/slb-ccbs-anaphylaxis'
  },
