    ...
    <div class="promax-wrapper" id="mainContent">
      ...
      <div class="hub-tabs-container" style="margin-bottom: 1.5rem;">
        <div class="hub-tabs" style="display: flex; gap: 8px; border-bottom: 2px solid var(--color-border, #e2e8f0); padding-bottom: 8px; overflow-x: auto;">
          ...
          <a href="#/basic-medical/hoa-sinh" class="hub-tab-btn" style="padding: 0.65rem 1.3rem; font-size: 0.95rem; font-weight: 700; border: none; background: transparent; cursor: pointer; border-radius: 10px; display: inline-flex; align-items: center; gap: 0.5rem; text-decoration: none; color: inherit; white-space: nowrap;">
            <i class="fa-solid fa-flask-vial" style="color: #8b5cf6;"></i>
            <span>3. Hóa Sinh Y Học (7 Khối, 31 Bài)</span>
          </a>
          <a href="#/basic-medical/dich-te-hoc" class="hub-tab-btn" style="padding: 0.65rem 1.3rem; font-size: 0.95rem; font-weight: 700; border: none; background: transparent; cursor: pointer; border-radius: 10px; display: inline-flex; align-items: center; gap: 0.5rem; text-decoration: none; color: inherit; white-space: nowrap;">
            <i class="fa-solid fa-virus-covid" style="color: #0d9488;"></i>
            <span>4. Dịch Tễ Học (6 Khối, 2×2 Solver)</span>
          </a>
        </div>
      </div>
      ...
      <div class="dashboard-layout">
        ...
        <main class="layout-content-area" id="lessons-container">
          ...
          <div id="patho-tab-content" class="tab-content ${activeTab === 'ccbs' ? 'active' : ''}">
            ...
            <div class="specialty-grid">
              <a href="#/basic-medical/co-che-benh-sinh" class="specialty-card">
                <div class="specialty-card-top">
