...
<div class="module-badge-group">
  ...
  <span class="badge badge-red"><i class="fa-solid fa-heart-pulse"></i> Tim Mạch &amp; Tuần Hoàn</span>
  <span class="badge badge-amber"><i class="fa-solid fa-triangle-exclamation"></i> Mảng Xơ Vữa Không Ổn Định (TCFA)</span>
  <span class="badge badge-blue"><i class="fa-solid fa-dna"></i> Tắc Mạch Cấp &amp; Hoại Tử Cơ Tim</span>
</div>
...
## 1. Tổng Quan Hội Chứng Vành Cấp & Phân Loại Lâm Sàng (ECG - Troponin)
...
<div class="flowchart-card">
  <div class="flowchart-header">
    <div class="flowchart-title"><i class="fa-solid fa-route" style="color: var(--color-primary, #0284c7);"></i> SƠ ĐỒ LÂM SÀNG: MẢNG XƠ VỮA ĐỘNG MẠCH VÀNH KHÔNG ỔN ĐỊNH</div>
  ...
  <div class="flowchart-svg-container">
    <svg class="flowchart-svg" viewBox="0 0 880 624" width="880" height="624" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Single Node: MẢNG XƠ VỮA ĐỘNG MẠCH VÀNH KHÔ */}
      <rect x="220" y="20" width="440" height="46" rx="10" fill="rgba(16, 185, 129, 0.08)" stroke="var(--color-success, #10b981)" stroke-width="1.8"/>
      <text x="440" y="42" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--color-success, #10b981)">MẢNG XƠ VỮA ĐỘNG MẠCH VÀNH KHÔNG ỔN ĐỊNH</text>
      <line x1="440" y1="66" x2="440" y2="94" stroke="#0284c7" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      {/* Single Node: GIÁN ĐOẠN BỀ MẶT: NỨT VỠ / XÓI */}
      <rect x="180" y="94" width="520" height="46" rx="10" fill="var(--red-bg, #fef2f2)" stroke="var(--red, #ef4444)" stroke-width="1.8"/>
      <text x="440" y="116" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--red, #dc2626)">GIÁN ĐOẠN BỀ MẶT: NỨT VỠ / XÓI MÒN / NỐT VÔI HÓA</text>
      <line x1="440" y1="140" x2="440" y2="168" stroke="#0284c7" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      {/* Single Node: HOẠT HÓA TIỂU CẦU + DÒNG THÁC  */}
      <rect x="185" y="168" width="510" height="46" rx="10" fill="var(--color-surface-2, #f8fafc)" stroke="var(--color-border, #cbd5e1)" stroke-width="1.8"/>
      <text x="440" y="190" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--color-text, #0f172a)">HOẠT HÓA TIỂU CẦU + DÒNG THÁC ĐÔNG MÁU NỘI MẠCH</text>
      <line x1="440" y1="214" x2="440" y2="242" stroke="#0284c7" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      {/* Single Node: HÌNH THÀNH HUYẾT KHỐI CẤP TÍNH */}
      <rect x="170" y="242" width="540" height="46" rx="10" fill="var(--red-bg, #fef2f2)" stroke="var(--red, #ef4444)" stroke-width="1.8"/>
      <text x="440" y="264" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--red, #dc2626)">HÌNH THÀNH HUYẾT KHỐI CẤP TÍNH GÂY NGHẼN LÒNG MẠCH</text>
      {/* Bifurcation Path */}
      <path d="M 440 288 L 440 302 L 235 302 L 235 316" fill="none" stroke="var(--red, #ef4444)" stroke-width="1.8" marker-end="url(#arrRed)"/>
      <path d="M 440 302 L 645 302 L 645 316" fill="none" stroke="var(--red, #ef4444)" stroke-width="1.8" marker-end="url(#arrRed)"/>
      {/* Left Column: TẮC NGHẼN HOÀN TOÀN &amp; LIÊN TỤC */}
      <rect x="40" y="316" width="390" height="152" rx="10" fill="var(--red-bg, #fef2f2)" stroke="var(--red, #ef4444)" stroke-width="1.5"/>
      <text x="235" y="338" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--red, #dc2626)">TẮC NGHẼN HOÀN TOÀN &amp; LIÊN TỤC</text>
      <line x1="60" y1="352" x2="410" y2="352" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="60" y="368" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Thiếu máu xuyên thành (Transmural)</text>
      <text x="60" y="386" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• ST chênh lên vòm trên ECG</text>
      <text x="60" y="404" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Troponin tim tăng rất cao</text>
      {/* Right Column: TẮC NGHẼN BÁN PHẦN / TẠM THỜI */}
      <rect x="450" y="316" width="390" height="152" rx="10" fill="var(--red-bg, #fef2f2)" stroke="var(--red, #ef4444)" stroke-width="1.5"/>
      <text x="645" y="338" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--red, #dc2626)">TẮC NGHẼN BÁN PHẦN / TẠM THỜI</text>
      <line x1="470" y1="352" x2="820" y2="352" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="470" y="368" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Thiếu máu dưới nội tâm mạc</text>
      <text x="470" y="386" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• (Subendocardial)</text>
      <text x="470" y="404" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• ST chênh xuống / Sóng T âm / ECG bình</text>
      <text x="470" y="422" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• thường</text>
      <text x="470" y="440" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Troponin tăng (NSTEMI) hoặc bình</text>
      <text x="470" y="458" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• thường (UA)</text>
      {/* Bifurcation Path */}
      <path d="M 440 468 L 440 482 L 235 482 L 235 496" fill="none" stroke="var(--color-border, #cbd5e1)" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      <path d="M 440 482 L 645 482 L 645 496" fill="none" stroke="var(--color-border, #cbd5e1)" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      {/* Left Column: STEMI CẤP CỨU */}
      <rect x="40" y="496" width="390" height="90" rx="10" fill="var(--color-surface-2, #f8fafc)" stroke="var(--color-border, #cbd5e1)" stroke-width="1.5"/>
      <text x="235" y="518" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--color-text, #0f172a)">STEMI CẤP CỨU</text>
      <line x1="60" y1="532" x2="410" y2="532" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      {/* Right Column: NSTE-ACS: NSTEMI / UA */}
      <rect x="450" y="496" width="390" height="90" rx="10" fill="var(--color-surface-2, #f8fafc)" stroke="var(--color-border, #cbd5e1)" stroke-width="1.5"/>
      <text x="645" y="518" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--color-text, #0f172a)">NSTE-ACS: NSTEMI / UA</text>
...
## 2. Ba Cơ Chế Huyết Khối Xơ Vữa Tại Chỗ (Nứt Vỡ, Xói Mòn & Nốt Vôi Hóa)
...
<div class="flowchart-card">
  <div class="flowchart-header">
    <div class="flowchart-title"><i class="fa-solid fa-route" style="color: var(--color-primary, #0284c7);"></i> SƠ ĐỒ LÂM SÀNG: CÁC CƠ CHẾ SINH HUYẾT KHỐI TẠI CHỖ TRONG HCVC</div>
    <span class="badge badge-blue">Pure Orthogonal SVG</span>
  </div>
  <div class="flowchart-svg-container">
    <svg class="flowchart-svg" viewBox="0 0 880 230" width="880" height="230" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Single Node: CÁC CƠ CHẾ SINH HUYẾT KHỐI TẠI */}
      <rect x="195" y="20" width="490" height="46" rx="10" fill="var(--red-bg, #fef2f2)" stroke="var(--red, #ef4444)" stroke-width="1.8"/>
      <text x="440" y="42" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--red, #dc2626)">CÁC CƠ CHẾ SINH HUYẾT KHỐI TẠI CHỖ TRONG HCVC</text>
      ...
      <text x="155" y="116" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="11.5" fill="var(--red, #dc2626)">NỨT VỠ MẢNG XƠ VỮA (55-60%)</text>
      <line x1="45" y1="124" x2="265" y2="124" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="42" y="140" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• Vỏ xơ mỏng (TCFA &amp;lt; 65 µm)</text>
      <text x="42" y="158" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• Lõi hoại tử lipid &amp;gt; 40%</text>
      <text x="42" y="176" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• Đại thực bào tiết MMP-1,8,13</text>
      <text x="42" y="194" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• Lộ Tissue Factor ➔ Huyết khối đỏ</text>
      <rect x="315" y="94" width="250" height="98" rx="8" fill="var(--red-bg, #fef2f2)" stroke="var(--red, #ef4444)" stroke-width="1.5"/>
      <text x="440" y="116" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="11.5" fill="var(--red, #dc2626)">XÓI MÒN MẢNG XƠ VỮA (30-40%)</text>
      <line x1="330" y1="124" x2="550" y2="124" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="327" y="140" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• Vỏ xơ dày, NGUYÊN VẸN</text>
      <text x="327" y="158" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• Rối loạn dòng chảy ➔ TLR2</text>
      <text x="327" y="176" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• Tróc nội mạc + Bạch cầu ➔ N</text>
      <text x="327" y="194" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• Huyết khối trắng giàu tiểu cầ</text>
      <rect x="600" y="94" width="250" height="98" rx="8" fill="var(--blue-bg, #eff6ff)" stroke="var(--blue, #0284c7)" stroke-width="1.5"/>
      <text x="725" y="116" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="11.5" fill="var(--color-primary, #0284c7)">NỐT VÔI HÓA (5-8%)</text>
      <line x1="615" y1="124" x2="835" y2="124" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="612" y="140" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• Khối calci dạng hạt thô ráp</text>
      <text x="612" y="158" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• Lực cơ học uốn bẻ chu kỳ tim</text>
      <text x="612" y="176" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• ETs      - Đâm xuyên qua lớp vỏ xơ</text>
      <text x="612" y="194" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• u       - Thất bại can thiệp PCI cao</text>
    </svg>
  </div>
</div>
...
## 3. Chuyển Dịch Mô Hình: Khái Niệm "Bệnh Nhân Dễ Tổn Thương" (Vulnerable Patient)
<div class="infobox warning">
  <div class="infobox-title">⚠️ Nghịch Lý Mảng Xơ Vữa Vỏ Mỏng (TCFA Paradox — Thử Nghiệm PROSPECT)</div>
  <div class="infobox-body">
    ...
    Đại đa số các mảng TCFA tự ổn định, tự lành qua các chu kỳ lắng đọng collagen mới hoặc biến đổi thành các mảng xơ hóa lành tính mà không gây ra bất kỳ triệu chứng nào. Điều này chứng minh rằng **sự hiện diện đơn thuần của một mảng xơ vữa không ổn định tại chỗ là điều kiện cần nhưng CHƯA ĐỦ** để kích hoạt một biến cố tắc nghẽn mạch vành cấp tính trên lâm sàng.
  </div>
</div>
...
<div class="flowchart-card">
  <div class="flowchart-header">
    <div class="flowchart-title"><i class="fa-solid fa-route" style="color: var(--color-primary, #0284c7);"></i> SƠ ĐỒ LÂM SÀNG: BỆNH NHÂN DỄ TỔN THƯƠNG</div>
    <span class="badge badge-blue">Pure Orthogonal SVG</span>
  </div>
  <div class="flowchart-svg-container">
    <svg class="flowchart-svg" viewBox="0 0 880 248" width="880" height="248" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Single Node: BỆNH NHÂN DỄ TỔN THƯƠNG */}
      ...
      <text x="440" y="42" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--color-text, #0f172a)">BỆNH NHÂN DỄ TỔN THƯƠNG</text>
      ...
      <text x="155" y="116" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="11.5" fill="var(--color-text, #0f172a)">MẢNG XƠ VỮA DỄ TỔN THƯƠNG</text>
      <line x1="45" y1="124" x2="265" y2="124" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="42" y="140" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text-muted, #475569)">• (Vulnerable Plaque)</text>
      <text x="42" y="158" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text-muted, #475569)">• TCFA vỏ mỏng &amp;lt; 65 µm</text>
      <text x="42" y="176" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text-muted, #475569)">• Xói mòn mảng nội mạc</text>
      <text x="42" y="194" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text-muted, #475569)">• Nốt vôi hóa đâm xuyên</text>
      <text x="42" y="212" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text-muted, #475569)">• Viêm hoạt động (hs-CRP)</text>
      <rect x="315" y="94" width="250" height="116" rx="8" fill="var(--amber-bg, #fffbeb)" stroke="var(--amber, #f59e0b)" stroke-width="1.5"/>
      <text x="440" y="116" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="11.5" fill="var(--amber, #d97706)">DÒNG MÁU DỄ ĐÔNG</text>
      <line x1="330" y1="124" x2="550" y2="124" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="327" y="140" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• (Vulnerable Blood)</text>
      <text x="327" y="158" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• Tăng hoạt tính tiểu cầu</text>
      <text x="327" y="176" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• Tăng các yếu tố đông máu</text>
      <text x="327" y="194" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• Suy giảm tiêu sợi huyết</text>
      <text x="327" y="212" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• Tăng dấu ấn MPO, PAI-1</text>
      <rect x="600" y="94" width="250" height="116" rx="8" fill="rgba(16, 185, 129, 0.08)" stroke="var(--color-success, #10b981)" stroke-width="1.5"/>
      <text x="725" y="116" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="11.5" fill="var(--color-success, #10b981)">CƠ TIM DỄ TỔN THƯƠNG</text>
      <line x1="615" y1="124" x2="835" y2="124" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="612" y="140" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• (Vulnerable Myocardium)</text>
      <text x="612" y="158" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• Nhạy cảm thiếu máu cục bộ</text>
      <text x="612" y="176" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• Phì đại thất trái / Xơ hóa kẽ</text>
      <text x="612" y="194" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• Bất ổn định điện học ➔</text>
      <text x="612" y="212" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• Rung thất, đột tử do tim</text>
    </svg>
  </div>
</div>
...
## 4. Phân Loại Mới Nhồi Máu Cơ Tim Theo Sinh Lý Bệnh (UDMI-V 2026)
...
## 5. Hội Chứng Vành Cấp Không Do Xơ Vữa Động Mạch (Non-Atherosclerotic ACS)
...
<div class="flowchart-card">
  <div class="flowchart-header">
    <div class="flowchart-title"><i class="fa-solid fa-route" style="color: var(--color-primary, #0284c7);"></i> SƠ ĐỒ LÂM SÀNG: CÁC NGUYÊN NHÂN HCVC KHÔNG DO XƠ VỮA ĐỘNG MẠCH</div>
    <span class="badge badge-blue">Pure Orthogonal SVG</span>
  </div>
  <div class="flowchart-svg-container">
    <svg class="flowchart-svg" viewBox="0 0 880 226" width="880" height="226" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Single Node: CÁC NGUYÊN NHÂN HCVC KHÔNG DO  */}
      <rect x="165" y="20" width="550" height="168" rx="10" fill="var(--amber-bg, #fffbeb)" stroke="var(--amber, #f59e0b)" stroke-width="1.8"/>
      <text x="440" y="42" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--amber, #d97706)">CÁC NGUYÊN NHÂN HCVC KHÔNG DO XƠ VỮA ĐỘNG MẠCH</text>
      <text x="189" y="64" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• [CO THẮT] [SCAD] [CẦU CƠ TIM] [THUYÊN TẮC] [TAKOTSUBO]</text>
      <text x="189" y="82" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Giảm NO - Lòng giả đè thật - LAD ngầm trong cơ - Trực tiếp -</text>
      <text x="189" y="100" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Bão Catecholamine</text>
      <text x="189" y="118" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Tăng RhoK - Outside-In vasa - Siết kỳ tâm thu - Nghịch</text>
      <text x="189" y="136" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• thường- Co thắt vi mạch</text>
      <text x="189" y="154" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Test ACh - Tránh đặt stent - Tổn thương nội mạc - PFO / Rung</text>
      <text x="189" y="172" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• nhĩ- Choáng váng cơ tim</text>
    </svg>
  </div>
</div>
...
## 6. Hội Chứng Làm Việc MINOCA & Lưu Đồ Chẩn Đoán Đa Phương Tiện (CMR / OCT)
...
<div class="flowchart-card">
  <div class="flowchart-header">
    <div class="flowchart-title"><i class="fa-solid fa-route" style="color: var(--color-primary, #0284c7);"></i> SƠ ĐỒ LÂM SÀNG: CHỤP MẠCH VÀNH XÂM LẤN (ICA): HẸP &amp;lt; 50%</div>
    <span class="badge badge-blue">Pure Orthogonal SVG</span>
  </div>
  <div class="flowchart-svg-container">
    <svg class="flowchart-svg" viewBox="0 0 880 436" width="880" height="436" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Single Node: CHỤP MẠCH VÀNH XÂM LẤN (ICA):  */}
      <rect x="210" y="20" width="460" height="60" rx="10" fill="var(--color-surface-2, #f8fafc)" stroke="var(--color-border, #cbd5e1)" stroke-width="1.8"/>
      <text x="440" y="42" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--color-text, #0f172a)">CHỤP MẠCH VÀNH XÂM LẤN (ICA): HẸP &amp;lt; 50%</text>
      <text x="234" y="64" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text-muted, #475569)">• ▼ (Pha 1: Loại trừ sai sót tại phòng DSA)</text>
      <line x1="440" y1="80" x2="440" y2="108" stroke="#0284c7" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      {/* Single Node: ĐÁNH GIÁ LẠI HÌNH ẢNH MẠCH VÀN */}
      ...
      <text x="440" y="130" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--color-text, #0f172a)">ĐÁNH GIÁ LẠI HÌNH ẢNH MẠCH VÀNH + CHỤP BUỒNG THẤT TRÁI</text>
      <text x="174" y="152" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text-muted, #475569)">• ▼ (Pha 2: Khảo sát hình ảnh nội mạch)</text>
      <line x1="440" y1="168" x2="440" y2="196" stroke="#0284c7" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      {/* Single Node: OCT / IVUS */}
      <rect x="250" y="196" width="380" height="60" rx="10" fill="rgba(16, 185, 129, 0.08)" stroke="var(--color-success, #10b981)" stroke-width="1.8"/>
      <text x="440" y="218" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--color-success, #10b981)">OCT / IVUS</text>
      <text x="274" y="240" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• ▼ (Pha 3: Tiêu chuẩn vàng phân biệt)</text>
      <line x1="440" y1="256" x2="440" y2="284" stroke="#0284c7" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      {/* Single Node: CHỤP CỘNG HƯỞNG TỪ TIM (CMR) T */}
      <rect x="150" y="284" width="580" height="114" rx="10" fill="var(--color-surface-2, #f8fafc)" stroke="var(--color-border, #cbd5e1)" stroke-width="1.8"/>
      <text x="440" y="306" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--color-text, #0f172a)">CHỤP CỘNG HƯỞNG TỪ TIM (CMR) THỰC HIỆN SỚM &amp;lt; 2 TUẦN</text>
      <text x="174" y="328" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text-muted, #475569)">• LGE Dưới nội tâm mạc / Xuyên thành ► NMCT THỰC SỰ (Căn</text>
      <text x="174" y="346" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text-muted, #475569)">• nguyên mạch vành)</text>
      <text x="174" y="364" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text-muted, #475569)">• LGE Dưới màng ngoài tim / Lớp giữa ► VIÊM CƠ TIM CẤP</text>
      <text x="174" y="382" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text-muted, #475569)">• (Myocarditis)</text>
    </svg>
  </div>
</div>
...
## 7. Sinh Lý Bệnh Vi Tuần Hoàn, Tổn Thương Tái Tưới Máu & Hiện Tượng No-Reflow
...
## 8. Ứng Dụng Lâm Sàng & Liệu Pháp Điều Trị Nhắm Đích Cơ Chế (Stentless / Kháng Viêm)
...
<div class="flowchart-card">
  <div class="flowchart-header">
    <div class="flowchart-title"><i class="fa-solid fa-route" style="color: var(--color-primary, #0284c7);"></i> SƠ ĐỒ LÂM SÀNG: CÁ THỂ HÓA ĐIỀU TRỊ DỰA TRÊN SINH LÝ BỆNH</div>
    <span class="badge badge-blue">Pure Orthogonal SVG</span>
  </div>
  <div class="flowchart-svg-container">
    <svg class="flowchart-svg" viewBox="0 0 880 356" width="880" height="356" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <marker id="arrBlue" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
          <path d="M 0 1.5 L 8 5 L 0 8.5 z" fill="#0284c7"/>
        </marker>
      ...
      {/* Single Node: CÁ THỂ HÓA ĐIỀU TRỊ DỰA TRÊN S */}
      <rect x="215" y="20" width="450" height="46" rx="10" fill="rgba(16, 185, 129, 0.08)" stroke="var(--color-success, #10b981)" stroke-width="1.8"/>
      <text x="440" y="42" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--color-success, #10b981)">CÁ THỂ HÓA ĐIỀU TRỊ DỰA TRÊN SINH LÝ BỆNH</text>
      {/* Bifurcation Path */}
      ...
      {/* Left Column: CHIẾN LƯỢC STENTLESS TRONG XÓI */}
      <rect x="40" y="94" width="390" height="224" rx="10" fill="var(--red-bg, #fef2f2)" stroke="var(--red, #ef4444)" stroke-width="1.5"/>
      <text x="235" y="116" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--red, #dc2626)">CHIẾN LƯỢC STENTLESS TRONG XÓI MÒN</text>
      <line x1="60" y1="130" x2="410" y2="130" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="60" y="146" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• (Thử nghiệm EROSION &amp;amp; EROSION III)</text>
      <text x="60" y="164" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Khẳng định vỏ xơ nguyên vẹn qua OCT</text>
      <text x="60" y="182" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Hẹp &amp;lt; 70% + Dòng chảy TIMI 3</text>
      <text x="60" y="200" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• DAPT mạnh (Aspirin + Ticagrelor) +</text>
      <text x="60" y="218" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Heparin</text>
      <text x="60" y="236" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• 78.3% giảm &amp;gt; 50% huyết khối sau 1</text>
      <text x="60" y="254" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• tháng</text>
      <text x="60" y="272" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Tránh biến chứng huyết khối/tái hẹp</text>
      <text x="60" y="290" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• stent</text>
      {/* Right Column: LIỆU PHÁP KHÁNG VIÊM HỆ THỐNG */}
      <rect x="450" y="94" width="390" height="224" rx="10" fill="var(--red-bg, #fef2f2)" stroke="var(--red, #ef4444)" stroke-width="1.5"/>
      <text x="645" y="116" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--red, #dc2626)">LIỆU PHÁP KHÁNG VIÊM HỆ THỐNG</text>
      <line x1="470" y1="130" x2="820" y2="130" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="470" y="146" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• (Thử nghiệm COLCOT &amp;amp; LoDoCo2)</text>
      <text x="470" y="164" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Đại thực bào tiết MMP-1,8,13 làm rách</text>
      <text x="470" y="182" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• vỏ</text>
      <text x="470" y="200" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Ứng dụng Colchicine liều thấp (0.5</text>
      <text x="470" y="218" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• mg/ngày)</text>
      <text x="470" y="236" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Ức chế thể viêm NLRP3 và thoái biến vi</text>
      <text x="470" y="254" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• ống</text>
      <text x="470" y="272" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Giảm nồng độ hs-CRP, giảm tái phát</text>
      <text x="470" y="290" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• MACE</text>
      <text x="470" y="308" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Ổn định bền vững vỏ xơ mảng xơ vữa</text>
    </svg>
  </div>
</div>
