...
[NHIỄM HCV MẠN TÍNH]
        │
        ├──► 1. TÁC ĐỘNG TRỰC TIẾP CỦA PROTEIN VIRUS (Đặc biệt Genotype 3a)
        │      • Protein Core & NS5A bám lên bề mặt giọt mỡ (Lipid droplets).
        │      • Ức chế trực tiếp enzym MTP ➔ Tắc nghẽn xuất khẩu VLDL.
        │
        ├──► 2. TĂNG HẤP THU & TỔNG HỢP AXIT BÉO (De Novo Lipogenesis)
        │      • Đề kháng insulin kích hoạt phân giải mỡ ngoại vi ➔ Tăng nạp FFA vào gan.
        │      • Tăng đường phân kích hoạt SREBP-1c tăng tổng hợp triglyceride.
        │
        └──► 3. RỐI LOẠN CHỨC NĂNG TY THỂ & STRESS OXY HÓA (ROS)
               • Protein Core gây tổn thương màng ty thể ➔ Giảm β-oxy hóa axit béo.
               • Bùng phát các gốc oxy hóa tự do ROS ➔ Hủy hoại tế bào gan!
```
...
```diagram
[STRESS OXY HÓA (ROS) DO TY THỂ & HCV]
                │
                ├──► OXY HÓA LIPID (Lipid Peroxidation)
                │      ├── Giải phóng Malondialdehyde (MDA) & 4-Hydroxynonenal (4-HNE)
                │      └── Tiết Cytokine tiền viêm: IL-8, TNF-α, FasL
                │              │
                │              ▼
                │      [HÓA HƯỚNG ĐỘNG BẠCH CẦU TRUNG TÍNH & LYMPHO]
                │      (Gây Viêm Hoại Tử Tiểu Thùy - Necroinflammation)
                │
                └──► KÍCH HOẠT TẾ BÀO HÌNH SAO GAN (Hepatic Stellate Cells - HSCs)
                       ├── TGF-β1 (Yếu tố kích thích mạnh nhất)
                       ├── MDA & 4-HNE
                       └── Insulin máu cao (Gắn thụ thể insulin trên HSCs ➔ Tiết CTGF)
                               │
                               ▼
                       [HSCs BIẾN ĐỔI THÀNH NGUYÊN BÀO SỢI CƠ (Myofibroblasts)]
                               │
                               ▼
                       [TỔNG HỢP & LẮNG ĐỌNG COLLAGEN TYPE I/III KHÔNG HỒI PHỤC]
                               │
                               ▼
                       [XƠ HÓA GAN TIẾN TRIỂN ➔ XƠ GAN (CIRRHOSIS)]
```
