...
<div class="flowchart-card">
  <div class="flowchart-header">
    <div class="flowchart-title"><i class="fa-solid fa-route" style="color: var(--color-primary, #0284c7);"></i> SƠ ĐỒ LÂM SÀNG: 1.1. Định Nghĩa &amp; Sự Chuyển Dịch Mô Hình Sinh Bệnh Học</div>
  ...
  <div class="flowchart-svg-container">
    <svg class="flowchart-svg" viewBox="0 0 880 154" width="880" height="154" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- Single Node: SỰ CHUYỂN DỊCH QUAN NIỆM SINH  -->
      <rect x="80" y="20" width="720" height="96" rx="10" fill="var(--blue-bg, #eff6ff)" stroke="var(--blue, #0284c7)" stroke-width="1.8"/>
      <text x="440" y="42" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--color-primary, #0284c7)">SỰ CHUYỂN DỊCH QUAN NIỆM SINH LÝ BỆNH HỘI CHỨNG VÀNH</text>
      <text x="440" y="60" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="600" font-size="12" fill="var(--color-primary, #0284c7)">MẠN (CCS) │</text>
...
<div class="flowchart-card">
  <div class="flowchart-header">
    <div class="flowchart-title"><i class="fa-solid fa-route" style="color: var(--color-primary, #0284c7);"></i> SƠ ĐỒ LÂM SÀNG: ĐAU THẮNG NGỰC / TRIỆU CHỨNG LÂM SÀNG</div>
    <span class="badge badge-blue">Pure Orthogonal SVG</span>
  </div>
  <div class="flowchart-svg-container">
    <svg class="flowchart-svg" viewBox="0 0 880 382" width="880" height="382" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <marker id="arrBlue" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
          <path d="M 0 1.5 L 8 5 L 0 8.5 z" fill="#0284c7"/>
        </marker>
      ...
      <!-- Single Node: ĐAU THẮNG NGỰC / TRIỆU CHỨNG L -->
      <rect x="235" y="20" width="410" height="60" rx="10" fill="var(--color-surface-2, #f8fafc)" stroke="var(--color-border, #cbd5e1)" stroke-width="1.8"/>
      <text x="440" y="42" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--color-text, #0f172a)">ĐAU THẮNG NGỰC / TRIỆU CHỨNG LÂM SÀNG</text>
      <text x="259" y="64" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text-muted, #475569)">• (Đỉnh Thác - Xuất hiện muộn nhất)</text>
      <line x1="440" y1="80" x2="440" y2="108" stroke="#0284c7" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      <!-- Single Node: RỐI LOẠN CHỨC NĂNG TÂM THU VÙN -->
      <rect x="165" y="108" width="550" height="60" rx="10" fill="var(--amber-bg, #fffbeb)" stroke="var(--amber, #f59e0b)" stroke-width="1.8"/>
      <text x="440" y="130" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--amber, #d97706)">RỐI LOẠN CHỨC NĂNG TÂM THU VÙNG (REGIONAL SYSTOLIC)</text>
      <text x="189" y="152" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• (Giảm vận động, vô động vùng thành tim)</text>
      <line x1="440" y1="168" x2="440" y2="196" stroke="#0284c7" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      <!-- Single Node: RỐI LOẠN CHỨC NĂNG TÂM TRƯƠNG  -->
      <rect x="155" y="196" width="570" height="60" rx="10" fill="var(--amber-bg, #fffbeb)" stroke="var(--amber, #f59e0b)" stroke-width="1.8"/>
      <text x="440" y="218" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--amber, #d97706)">RỐI LOẠN CHỨC NĂNG TÂM TRƯƠNG (DIASTOLIC DYSFUNCTION)</text>
      <text x="179" y="240" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• (Giảm thư giãn chủ động do thiếu ATP tế bào)</text>
      <line x1="440" y1="256" x2="440" y2="284" stroke="#0284c7" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      <!-- Single Node: BẤT THƯỜNG TƯỚI MÁU CƠ TIM (PE -->
      <rect x="160" y="284" width="560" height="60" rx="10" fill="var(--color-surface-2, #f8fafc)" stroke="var(--color-border, #cbd5e1)" stroke-width="1.8"/>
      <text x="440" y="306" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--color-text, #0f172a)">BẤT THƯỜNG TƯỚI MÁU CƠ TIM (PERFUSION ABNORMALITIES)</text>
      <text x="184" y="328" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text-muted, #475569)">• (Đáy Thác - Thay đổi sớm nhất ở mức vi mô)</text>
    </svg>
  </div>
</div>
...
<figure class="physio-figure" style="display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; margin: 2rem auto;">
  <img src="./images/ccs-natural-history-risk-esc.png" 
...
<figure class="physio-figure" style="display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; margin: 2rem auto;">
  <img src="./images/ccs-anoca-inoca-prevalence-icft-esc2024.png" 
...
<figure class="physio-figure" style="display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; margin: 2rem auto;">
  <img src="./images/ccs-icft-diagnostic-algorithm-esc2024.png" 
...
<figure class="physio-figure" style="display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; margin: 2rem auto;">
  <img src="./images/ccs-acetylcholine-spasm-provocation-esc2024.png" 
