...
| Trang Hub Sinh lý & Sinh lý bệnh | `../co-che-benh-sinh.html` |
...
<body>
    ...
    <div class="app-container">
        ...
        <aside class="app-sidebar" id="appSidebar">
            ...
            <nav class="sidebar-nav" aria-label="Điều hướng chính">
                <ul class="nav-list" role="list">
                    ...
                    <li><a href="../co-che-benh-sinh.html" class="nav-item active" title="Sinh lý & Sinh lý bệnh"><span class="nav-icon">🧬</span><span class="nav-text">Sinh lý & Sinh lý bệnh</span></a></li>
        ...
        <div class="main-wrapper" id="mainContent">
            <!-- BREADCRUMB -->
            <clini-breadcrumb items='[{"label": "🏠 Home", "url": "../../../../index.html"}, {"label": "Sinh lý & sinh lý bệnh", "url": "../co-che-benh-sinh.html"}, {"label": "Sinh lý bệnh & Cơ chế bệnh sinh [Tên Bệnh]"}]'></clini-breadcrumb>
