...
<PathoAlert type="pearl" title="Điểm Ngọc Lâm Sàng (Clinical Pearls)">
  <ul>
    <li>2. Hóa Sinh Chuyển Hóa Bilirubin</li>
    <li>3. Di Truyền Học &amp; Đột Biến UGT1A1</li>
    <li>4. Yếu Tố Kích Hoạt (Nhịn Ăn &amp; Stress)</li>
    <li>5. Dược Lý Học &amp; Độc Tính Irinotecan (SN-38)</li>
  </ul>
</PathoAlert>
