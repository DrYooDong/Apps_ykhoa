...
<div class="module-badge-group">
  ...
  <span class="badge badge-amber"><i class="fa-solid fa-heart-crack"></i> Tái Cấu Trúc Thất Trái (HFrEF vs HFpEF)</span>
  <span class="badge badge-blue"><i class="fa-solid fa-pills"></i> Tứ Trụ Điều Trị Chuẩn EBM 2026</span>
</div>
...
## 1. Đại Cương Huyết Động & Định Nghĩa Suy Tim (Universal Definition 2026)
...
<div class="flowchart-card">
  <div class="flowchart-header">
    <div class="flowchart-title"><i class="fa-solid fa-route" style="color: var(--color-primary, #0284c7);"></i> SƠ ĐỒ LÂM SÀNG: CÁC TÁC NHÂN TỔN THƯƠNG BAN ĐẦU</div>
    <span class="badge badge-blue">Pure Orthogonal SVG</span>
  </div>
  <div class="flowchart-svg-container">
    <svg class="flowchart-svg" viewBox="0 0 880 334" width="880" height="334" xmlns="http://www.w3.org/2000/svg">
      <defs>
      ...
      {/* Single Node: CÁC TÁC NHÂN TỔN THƯƠNG BAN ĐẦ */}
      <rect x="169.25" y="20" width="541.5" height="78" rx="10" fill="var(--amber-bg, #fffbeb)" stroke="var(--amber, #f59e0b)" stroke-width="1.8"/>
      <text x="440" y="42" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--amber, #d97706)">CÁC TÁC NHÂN TỔN THƯƠNG BAN ĐẦU</text>
      <text x="193.25" y="64" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• (Bệnh Mạch Vành, Tăng Huyết Áp, Độc Chất, Viêm Cơ Tim, Bệnh</text>
      <text x="193.25" y="82" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Chuyển Hóa)</text>
      <line x1="440" y1="98" x2="440" y2="126" stroke="#0284c7" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      {/* Single Node: BẤT THƯỜNG CẤU TRÚC VÀ/HOẶC CH */}
      <rect x="215" y="126" width="450" height="46" rx="10" fill="var(--color-surface-2, #f8fafc)" stroke="var(--color-border, #cbd5e1)" stroke-width="1.8"/>
      <text x="440" y="148" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--color-text, #0f172a)">BẤT THƯỜNG CẤU TRÚC VÀ/HOẶC CHỨC NĂNG TIM</text>
      <line x1="440" y1="172" x2="440" y2="200" stroke="#0284c7" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      {/* Single Node: KÍCH HOẠT DÒNG THÁC THẦN KINH  */}
      <rect x="185" y="200" width="510" height="96" rx="10" fill="var(--amber-bg, #fffbeb)" stroke="var(--amber, #f59e0b)" stroke-width="1.8"/>
      <text x="440" y="222" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--amber, #d97706)">KÍCH HOẠT DÒNG THÁC THẦN KINH - THỂ DỊCH BÙ TRỪ</text>
      <text x="209" y="244" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Hệ Thần Kinh Giao Cảm (SNS: Norepinephrine)</text>
      <text x="209" y="262" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Hệ Renin - Angiotensin - Aldosterone (RAAS)</text>
      <text x="209" y="280" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• ▼ (Vòng xoắn bệnh lý kéo dài)</text>
    </svg>
  </div>
</div>
...
## 2. Cơ Chế Bệnh Sinh & Tái Cấu Trúc Cơ Tim Trong HFrEF (LVEF &lt; 50%)
...
## 3. Cơ Chế Bệnh Sinh HFpEF: Viêm Hệ Thống, Rối Loạn Vi Mạch & Độc Tính Chuyển Hóa
...
<div class="flowchart-card">
  <div class="flowchart-header">
    <div class="flowchart-title"><i class="fa-solid fa-route" style="color: var(--color-primary, #0284c7);"></i> SƠ ĐỒ LÂM SÀNG: BỆNH LÝ ĐỒNG MẮC CHUYỂN HÓA: BÉO PHÌ, ĐÁI THÁO ĐƯỜNG TYPE 2, THA, CKD</div>
    <span class="badge badge-blue">Pure Orthogonal SVG</span>
  </div>
  <div class="flowchart-svg-container">
    <svg class="flowchart-svg" viewBox="0 0 880 706" width="880" height="706" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <marker id="arrBlue" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
          <path d="M 0 1.5 L 8 5 L 0 8.5 z" fill="#0284c7"/>
        </marker>
      ...
      {/* Single Node: BỆNH LÝ ĐỒNG MẮC CHUYỂN HÓA: B */}
      ...
      <text x="440" y="42" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--color-text, #0f172a)">BỆNH LÝ ĐỒNG MẮC CHUYỂN HÓA: BÉO PHÌ, ĐÁI THÁO ĐƯỜNG</text>
      <text x="440" y="60" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="600" font-size="12" fill="var(--color-text, #0f172a)">TYPE 2, THA, CKD</text>
      <line x1="440" y1="80" x2="440" y2="108" stroke="#0284c7" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      {/* Single Node: HỘI CHỨNG VIÊM HỆ THỐNG MẠN TÍ */}
      ...
      <text x="440" y="130" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--color-text, #0f172a)">HỘI CHỨNG VIÊM HỆ THỐNG MẠN TÍNH MỨC ĐỘ THẤP (SYSTEMIC</text>
      <text x="440" y="148" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="600" font-size="12" fill="var(--color-text, #0f172a)">INFLAMMATION)</text>
      <line x1="440" y1="168" x2="440" y2="196" stroke="#0284c7" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      {/* Single Node: TẾ BÀO NỘI MÔ VI MẠCH VÀNH BỊ  */}
      <rect x="160" y="196" width="560" height="60" rx="10" fill="var(--amber-bg, #fffbeb)" stroke="var(--amber, #f59e0b)" stroke-width="1.8"/>
      <text x="440" y="218" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--amber, #d97706)">TẾ BÀO NỘI MÔ VI MẠCH VÀNH BỊ TỔN THƯƠNG ➔ GIẢM SINH</text>
      <text x="440" y="236" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="600" font-size="12" fill="var(--amber, #d97706)">KHẢ DỤNG NITRIC OXIDE (NO)</text>
      <line x1="440" y1="256" x2="440" y2="284" stroke="#0284c7" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      {/* Single Node: SUY GIẢM CON ĐƯỜNG sGC - cGMP  */}
      <rect x="150" y="284" width="580" height="46" rx="10" fill="var(--amber-bg, #fffbeb)" stroke="var(--amber, #f59e0b)" stroke-width="1.8"/>
      <text x="440" y="306" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--amber, #d97706)">SUY GIẢM CON ĐƯỜNG sGC - cGMP - PROTEIN KINASE G (PKG)</text>
      {/* Bifurcation Path */}
      ...
      <path d="M 440 344 L 645 344 L 645 358" fill="none" stroke="var(--amber, #f59e0b)" stroke-width="1.8" marker-end="url(#arrAmber)"/>
      {/* Left Column: GIẢM PHOSPHORYLATION TITIN */}
      <rect x="40" y="358" width="390" height="134" rx="10" fill="var(--amber-bg, #fffbeb)" stroke="var(--amber, #f59e0b)" stroke-width="1.5"/>
      <text x="235" y="380" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--amber, #d97706)">GIẢM PHOSPHORYLATION TITIN</text>
      <line x1="60" y1="394" x2="410" y2="394" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="60" y="410" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Sợi Titin bị cứng như lò xo sắt</text>
      <text x="60" y="428" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Tăng độ cứng nội tại tế bào cơ tim</text>
      {/* Right Column: TĂNG TIẾT TGF-β1 TỪ ĐẠI THỰC B */}
      <rect x="450" y="358" width="390" height="134" rx="10" fill="var(--amber-bg, #fffbeb)" stroke="var(--amber, #f59e0b)" stroke-width="1.5"/>
      <text x="645" y="380" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--amber, #d97706)">TĂNG TIẾT TGF-β1 TỪ ĐẠI THỰC BÀO</text>
      <line x1="470" y1="394" x2="820" y2="394" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="470" y="410" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Biệt hóa nguyên bào sợi thành</text>
      <text x="470" y="428" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• myofibroblast</text>
      <text x="470" y="446" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• Lắng đọng Collagen type I &amp; III vào mô</text>
      <text x="470" y="464" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">• kẽ</text>
      <line x1="440" y1="492" x2="440" y2="520" stroke="#0284c7" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      {/* Single Node: TĂNG ĐỘ CỨNG TÂM THẤT TRÁI &amp; S */}
      <rect x="145" y="520" width="590" height="60" rx="10" fill="var(--amber-bg, #fffbeb)" stroke="var(--amber, #f59e0b)" stroke-width="1.8"/>
      <text x="440" y="542" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--amber, #d97706)">TĂNG ĐỘ CỨNG TÂM THẤT TRÁI &amp; SUY GIẢM ĐỔ ĐẦY TÂM TRƯƠNG</text>
      <text x="440" y="560" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="600" font-size="12" fill="var(--amber, #d97706)">(DIASTOLIC DYSFUNCTION)</text>
      <line x1="440" y1="580" x2="440" y2="608" stroke="#0284c7" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      {/* Single Node: ÁP LỰC ĐỔ ĐẦY TĂNG VỌT KHI GẮN */}
      <rect x="145" y="608" width="590" height="60" rx="10" fill="var(--amber-bg, #fffbeb)" stroke="var(--amber, #f59e0b)" stroke-width="1.8"/>
      <text x="440" y="630" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--amber, #d97706)">ÁP LỰC ĐỔ ĐẦY TĂNG VỌT KHI GẮNG SỨC (LVEDP &amp; PCWP TĂNG)</text>
      <text x="440" y="648" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="600" font-size="12" fill="var(--amber, #d97706)">➔ SUNG HUYẾT PHỔI</text>
    </svg>
  </div>
</div>
...
## 4. Hệ Thống Thần Kinh - Thể Dịch & Vai Trò Phản Điều Hòa Của Peptide Bài Niệu
Khi cung lượng tim suy giảm hoặc áp lực thành tim tăng cao, cơ thể kích hoạt ba hệ thống nội tiết chính:


<div class="flowchart-card">
  <div class="flowchart-header">
    <div class="flowchart-title"><i class="fa-solid fa-route" style="color: var(--color-primary, #0284c7);"></i> SƠ ĐỒ LÂM SÀNG: GIẢM CUNG LƯỢNG TIM &amp; TĂNG ÁP LỰC THÀNH TIM</div>
    <span class="badge badge-blue">Pure Orthogonal SVG</span>
  </div>
  <div class="flowchart-svg-container">
    <svg class="flowchart-svg" viewBox="0 0 880 436" width="880" height="436" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Single Node: GIẢM CUNG LƯỢNG TIM &amp; TĂNG ÁP  */}
      <rect x="205" y="20" width="470" height="46" rx="10" fill="var(--amber-bg, #fffbeb)" stroke="var(--amber, #f59e0b)" stroke-width="1.8"/>
      <text x="440" y="42" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--amber, #d97706)">GIẢM CUNG LƯỢNG TIM &amp; TĂNG ÁP LỰC THÀNH TIM</text>
      ...
      <text x="155" y="116" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="11.5" fill="var(--amber, #d97706)">HỆ THẦN KINH GIAO CẢM (SNS)</text>
      <line x1="45" y1="124" x2="265" y2="124" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="42" y="140" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• 1. Tiết Norepinephrine tăng vọt</text>
      <text x="42" y="158" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• 2. Co mạch hệ thống (Tăng hậu tải)</text>
      <text x="42" y="176" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• 3. Tăng nhịp tim &amp; Thể tích nhát bóp</text>
      <text x="42" y="194" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• 4. GÂY ĐỘC TRỰC TIẾP CƠ TIM</text>
      <rect x="315" y="94" width="250" height="98" rx="8" fill="var(--amber-bg, #fffbeb)" stroke="var(--amber, #f59e0b)" stroke-width="1.5"/>
      <text x="440" y="116" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="11.5" fill="var(--amber, #d97706)">HỆ RAAS &amp; ALDOSTERONE</text>
      <line x1="330" y1="124" x2="550" y2="124" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="327" y="140" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• 1. Tiết Renin ➔ Angiotensin II</text>
      <text x="327" y="158" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• 2. Co mạch mạnh mẽ (Tăng hậu tải)</text>
      <text x="327" y="176" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• 3. Tiết Aldosterone giữ muối nước</text>
      <text x="327" y="194" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• 4. Gây xơ hóa cơ tim, phì đại thất</text>
      <rect x="600" y="94" width="250" height="98" rx="8" fill="var(--amber-bg, #fffbeb)" stroke="var(--amber, #f59e0b)" stroke-width="1.5"/>
      <text x="725" y="116" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="11.5" fill="var(--amber, #d97706)">HỆ PEPTIDE BÀI NIỆU (NP)</text>
      <line x1="615" y1="124" x2="835" y2="124" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="612" y="140" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• 1. Căng thành tim ➔ Tiết ProBNP</text>
      <text x="612" y="158" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• 2. Cắt thành BNP và NT-proBNP</text>
      <text x="612" y="176" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• 3. Giãn mạch, bài tiết Natri</text>
      <text x="612" y="194" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text, #0f172a)">• 4. Ức chế ngược hệ RAAS &amp; SNS</text>
      <path d="M 440 192 L 440 206 L 155 206 L 155 220" fill="none" stroke="var(--color-border, #cbd5e1)" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      <path d="M 440 206 L 440 206 L 440 220" fill="none" stroke="var(--color-border, #cbd5e1)" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      <path d="M 440 206 L 725 206 L 725 220" fill="none" stroke="var(--color-border, #cbd5e1)" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      <rect x="30" y="220" width="250" height="90" rx="8" fill="var(--color-surface-2, #f8fafc)" stroke="var(--color-border, #cbd5e1)" stroke-width="1.5"/>
      <text x="155" y="242" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="11.5" fill="var(--color-text, #0f172a)">TÁI CẤU TRÚC BỆNH LÝ &amp; LOẠN NHỊP</text>
      <line x1="45" y1="250" x2="265" y2="250" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="42" y="268" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text-muted, #475569)">• Độc tế bào cơ tim, phì đại thất trái</text>
      <text x="42" y="286" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text-muted, #475569)">• Kích hoạt loạn nhịp thất chết người</text>
      <rect x="315" y="220" width="250" height="90" rx="8" fill="var(--color-surface-2, #f8fafc)" stroke="var(--color-border, #cbd5e1)" stroke-width="1.5"/>
      <text x="440" y="242" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="11.5" fill="var(--color-text, #0f172a)">QUÁ TẢI THỂ TÍCH &amp; XƠ HÓA</text>
      <line x1="330" y1="250" x2="550" y2="250" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="327" y="268" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text-muted, #475569)">• Ứ muối nước, tăng tiền tải tuần hoàn</text>
      <text x="327" y="286" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text-muted, #475569)">• Xơ hóa khoảng kẽ, giảm đàn hồi thất</text>
      <rect x="600" y="220" width="250" height="90" rx="8" fill="var(--color-surface-2, #f8fafc)" stroke="var(--color-border, #cbd5e1)" stroke-width="1.5"/>
      <text x="725" y="242" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="11.5" fill="var(--color-text, #0f172a)">BỊ PHÂN HỦY BỞI NEPRILYSIN</text>
      <line x1="615" y1="250" x2="835" y2="250" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="612" y="268" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text-muted, #475569)">• Neprilysin bất hoạt các peptide NP</text>
      <text x="612" y="286" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text-muted, #475569)">• Mất cơ chế bù trừ giãn mạch, bài niệu</text>
      <line x1="440" y1="310" x2="440" y2="338" stroke="#0284c7" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      {/* Single Node: VÒNG XOẮN SUY TIM TIẾN TRIỂN ➔ */}
      <rect x="165" y="338" width="550" height="60" rx="10" fill="var(--red-bg, #fef2f2)" stroke="var(--red, #ef4444)" stroke-width="1.8"/>
      <text x="440" y="360" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--red, #dc2626)">VÒNG XOẮN SUY TIM TIẾN TRIỂN ➔ ĐÍCH NHẮM CỦA TỨ TRỤ</text>
      <text x="440" y="378" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="600" font-size="12" fill="var(--red, #dc2626)">ARNI, Beta-blocker, MRA, SGLT2i</text>
    </svg>
  </div>
</div>
...
## 5. Cơ Chế Tế Bào: Rối Loạn Ty Thể, Đói Năng Lượng & Hệ Thống Autophagy
...
## 6. Sinh Lý Bệnh Sung Huyết Cấp: Quá Tải Thể Tích vs. Tái Phân Bố Dịch
...
## 7. Quy Trình Tiếp Cận Chẩn Đoán & Kiểm Soát Sung Huyết Cá Thể Hóa (ESC 2026)
...
## 8. Cơ Sở Sinh Lý Học Của Các Liệu Pháp Điều Trị Trúng Đích Hiện Đại
...
<div class="flowchart-card">
  <div class="flowchart-header">
    <div class="flowchart-title"><i class="fa-solid fa-route" style="color: var(--color-primary, #0284c7);"></i> SƠ ĐỒ LÂM SÀNG: 8.1. &quot;Tứ Trụ&quot; Điều Trị HFrEF &amp; Đảo Ngược Tái Cấu Trúc (Reverse Remodeling)</div>
    <span class="badge badge-blue">Pure Orthogonal SVG</span>
  </div>
  <div class="flowchart-svg-container">
    <svg class="flowchart-svg" viewBox="0 0 880 210" width="880" height="210" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Header Banner */}
      <rect x="20" y="10" width="840" height="30" rx="6" fill="var(--red-bg, #fef2f2)" stroke="var(--red, #ef4444)" stroke-width="1.5"/>
      <text x="440" y="30" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--red, #dc2626)">&quot;TỨ TRỤ&quot; ĐIỀU TRỊ SUY TIM HFrEF THEO CƠ CHẾ BỆNH SINH (ESC / AHA 2026)</text>

      {/* Cột 1: ARNI */}
      <rect x="20" y="48" width="200" height="150" rx="8" fill="var(--color-surface-2, #f8fafc)" stroke="var(--color-primary, #0284c7)" stroke-width="1.5"/>
      <text x="120" y="70" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="11.5" fill="var(--color-primary, #0284c7)">1. ARNI (Sacubitril / Val)</text>
      <line x1="30" y1="78" x2="210" y2="78" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="30" y="96" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Ức chế Neprilysin + Chẹn AT1</text>
      <text x="30" y="114" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Tăng Peptide bài niệu nội sinh</text>
      <text x="30" y="132" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Giãn mạch, hạ áp, giảm tiền/hậu tải</text>
      <text x="30" y="150" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Đảo ngược tái cấu trúc thất (LVEF ↑)</text>
      <text x="30" y="180" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="10" fill="var(--color-primary, #0284c7)">➔ Giảm 20% tử vong tim mạch</text>

      {/* Cột 2: BETA-BLOCKER */}
      <rect x="233" y="48" width="200" height="150" rx="8" fill="var(--color-surface-2, #f8fafc)" stroke="var(--amber, #d97706)" stroke-width="1.5"/>
      <text x="333" y="70" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="11.5" fill="var(--amber, #d97706)">2. BETA-BLOCKER</text>
      <line x1="243" y1="78" x2="423" y2="78" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="243" y="96" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Chẹn chọn lọc thụ thể β1</text>
      <text x="243" y="114" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Ngăn độc tính quá tải canxi</text>
      <text x="243" y="132" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Giảm tiêu thụ O2, chậm nhịp tim</text>
      <text x="243" y="150" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Ổn định điện thế màng sợi cơ tim</text>
      <text x="243" y="180" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="10" fill="var(--amber, #d97706)">➔ Giảm 35% đột tử do loạn nhịp</text>

      {/* Cột 3: MRA */}
      <rect x="446" y="48" width="200" height="150" rx="8" fill="var(--color-surface-2, #f8fafc)" stroke="var(--green, #059669)" stroke-width="1.5"/>
      <text x="546" y="70" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="11.5" fill="var(--green, #059669)">3. MRA (Spironolactone)</text>
      <line x1="456" y1="78" x2="636" y2="78" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="456" y="96" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Kháng Aldosterone chọn lọc</text>
      <text x="456" y="114" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Ức chế nguyên bào sợi tổng hợp collagen</text>
      <text x="456" y="132" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Ngăn chặn xơ hóa mô kẽ cơ tim</text>
      <text x="456" y="150" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Giảm thải Kali &amp; Magie qua ống thận</text>
      <text x="456" y="180" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="10" fill="var(--green, #059669)">➔ Giảm 30% tử vong toàn bộ</text>

      {/* Cột 4: SGLT2i */}
      <rect x="660" y="48" width="200" height="150" rx="8" fill="var(--color-surface-2, #f8fafc)" stroke="var(--purple, #7c3aed)" stroke-width="1.5"/>
      <text x="760" y="70" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="11.5" fill="var(--purple, #7c3aed)">4. SGLT2i (Dapa / Empa)</text>
      <line x1="670" y1="78" x2="850" y2="78" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="670" y="96" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Bài niệu thẩm thấu &amp; thải Natri</text>
      <text x="670" y="114" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Giảm áp lực mao mạch phổi bít</text>
      <text x="670" y="132" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Chuyển đổi nhiên liệu sang Ketone</text>
      <text x="670" y="150" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Bảo vệ chức năng cầu thận lâu dài</text>
      <text x="670" y="180" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="10" fill="var(--purple, #7c3aed)">➔ Giảm nhập viện trên mọi phổ EF</text>
    </svg>
  </div>
</div>
