...
<PathoAlert type="pearl" title="Điểm Ngọc Lâm Sàng (Clinical Pearls)">
  <ul>
    <li>Hàng rào chất nhầy - Bicarbonate (Mucus-HCO3- barrier): Lớp gel nhầy ưa nước liên kết chặt với ion HCO3- tạo ra một gradient pH trung tính (pH ~7.0) ngay sát bề mặt tế bào biểu mô, bất chấp pH trong lòng dạ dày có thể rơi xuống mức 1.0 - 2.0.</li>
    <li>Dòng máu tưới niêm mạc (Mucosal Blood Flow): Đảm bảo cung cấp oxy, glucose, đồng thời cuốn trôi và trung hòa nhanh chóng lượng ion H+ thẩm thấu ngược vào lớp đệm.</li>
    <li>Prostaglandin E2 (PGE2) và PGI2: Chất điều hòa thể dịch chỉ huy tối cao, kích thích tế bào biểu mô tiết chất nhầy, tiết HCO3-, duy trì tưới máu vi mạch và ức chế trực tiếp bài tiết acid từ tế bào thành.</li>
    <li>Acid Clohydric (HCl): Được bài tiết bởi tế bào thành (parietal cells) qua bơm proton H+/K+-ATPase, đóng vai trò hoạt hóa pepsinogen và phân giải liên kết ngoại bào.</li>
  </ul>
</PathoAlert>
