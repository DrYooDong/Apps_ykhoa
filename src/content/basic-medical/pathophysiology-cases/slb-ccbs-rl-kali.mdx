...
<PathoAlert type="pearl" title="Điểm Ngọc Lâm Sàng (Clinical Pearls)">
  <ul>
    <li>Nồng độ nội bào duy trì rất cao: 140 vàndash; 150 mEq/L.</li>
    <li>Tạo nên bể dự trữ kali khổng lồ, đóng vai trò là hệ đệm dung lượng cao để ổn định nồng độ ngoại bào.</li>
    <li>Chỉ chứa khoảng 2% tổng lượng kali cơ thể.</li>
    <li>Nồng độ huyết thanh bình thường duy trì trong khoảng hẹp: 3.5 vàndash; 5.0 mEq/L (hoặc đến 5.2 mEq/L tùy phòng xét nghiệm).</li>
  </ul>
</PathoAlert>
