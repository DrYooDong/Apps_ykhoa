...
## 1. Đặc Điểm Vi-rút Học, Genotype & Dạng eHAV {#sec-1}
...
```diagram
[HỌ PICORNAVIRIDAE] ──► [CHI HEPATOVIRUS] ──► [1 SEROTYPE DUY NHẤT]
                                                       │
         ┌─────────────────────────────────────────────┴─────────────────────────────────────────────┐
         ▼                                                                                           ▼
[GENOTYPES NGUỒN GỐC NGƯỜI]                                                 [GENOTYPES LINH TRƯỞNG]
  ├── Genotype I (IA, IB: Chiếm >80% toàn cầu)                                ├── Genotype IV
  ├── Genotype II (IIA, IIB)                                                  ├── Genotype V
  ├── Genotype III (IIIA, IIIB)                                               └── Genotype VI
  └── Genotype VII
```
...
## 2. Cơ Chế Miễn Dịch Bệnh Học Gây Hủy Hoại Gan {#sec-2}
...
```diagram
[HAV NHÂN LÊN TRONG TẾ BÀO GAN] (Giai đoạn ủ bệnh: Hoàn toàn không tổn thương mô, ALT bình thường)
                │
                ▼
   [KÍCH HOẠT HỆ MIỄN DỊCH VẬT CHỦ] (Sau 2 - 4 tuần)
                │
        ┌───────┴────────────────────────────────────────┐
        ▼                                                ▼
[CON ĐƯỜNG MIỄN DỊCH BẨM SINH]                  [CON ĐƯỜNG MIỄN DỊCH THÍCH ỨNG]
(Cell-intrinsic Apoptosis)                      (Adaptive Immunopathology)
  • Cảm biến RNA nhận diện sợi kép                • Tế bào T CD8+ gây độc (CTLs) thâm nhiễm
  • Kích hoạt trục MAVS - IRF3/IRF7              • Nhận diện kháng nguyên HAV qua MHC-I
  • Cảm ứng gen ISGs proapoptotic                 • Tiết Perforin, Granzyme & Fas/FasL
  • Tế bào gan tự kích hoạt tự chết               • Tiêu diệt tế bào gan nhiễm ➔ Bùng phát ALT!
```
...
## 3. 6 Đặc Điểm Mô Bệnh Học Kinh Điển & Bệnh Học So Sánh {#sec-3}
...
## 4. Tương Quan Lâm Sàng, Động Học Huyết Thanh & Phác Đồ EBM {#sec-4}

### Động Học Các Chỉ Dấu Huyết Thanh Học (Serological Kinetics)

```diagram
[PHƠI NHIỄM PHÂN - MIỆNG]
        │
        ├──► Tuần 1 - 2: Bắt đầu bài tiết HAV trong phân (Fecal shedding đạt đỉnh trước khi tăng men gan).
        │
        ├──► Tuần 3 - 4: Xuất hiện đợt nhiễm eHAV trong máu (Viremia) ➔ Khởi phát ALT/AST bùng phát vọt đỉnh.
        │
        ├──► Tuần 4: Kháng thể IgM anti-HAV xuất hiện đồng thời với triệu chứng lâm sàng (Dấu ấn chẩn đoán xác định cấp).
        │            (Tồn tại kéo dài 3 - 6 tháng rồi thoái lui).
        │
        └──► Tuần 6 - 8: Kháng thể IgG anti-HAV xuất hiện, thay thế IgM và tồn tại suốt đời (Miễn dịch bảo vệ vĩnh viễn).
```
...
## 5. Tài Liệu Tham Khảo Y Văn AMA {#sec-5}
