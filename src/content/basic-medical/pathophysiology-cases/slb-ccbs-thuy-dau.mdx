...
```diagram
[VZV XÂM NHẬP] ──► [BÁM MÀNG & HÒA MÀNG] ──► [BƠM DNA QUA LỖ NHÂN] ──► [PHIÊN MÃ IE ➔ E ➔ L] ──► [ĐÓNG GÓI CAPSID] ──► [TẠO VỎ TẠI TRANS-GOLGI & XUẤT BÀO]
      │                     │                          │                        │                      │                       │
 (Khí dung / Tiếp xúc)  (gB + gH/gL gắn IDE / HS) (Capsid cập bến)     (IE62/IE63 hoạt hóa)     (Lắp ráp trong nhân)     (TGN bao bọc / Post-Golgi)
```
...
```diagram
[PHƠI NHIỄM KHÍ DUNG] (Ngày 0)
        │
        ▼
[NHÂN LÊN NIÊM MẠC HÔ HẤP TRÊN] (Ngày 0 - 2)
        │
        ▼
[LÂY NHIỄM AMIDAN / VÒNG WALDEYER] ──► [CHUYỂN GIAO SANG TẾ BÀO T] (Ngày 2 - 4)
        │
        ▼
[NHIỄM VIRUS HUYẾT TIÊN PHÁT] (Primary Viremia) ──► [GAN, LÁCH, HỆ LƯỚI NỘI MÔ] (Ngày 4 - 6)
        │
        ▼
[NHIỄM VIRUS HUYẾT THỨ PHÁT] (Secondary Viremia) ──► [BIỂU BÌ DA TOÀN THÂN] (Ngày 10 - 12)
        │
        ▼
[PHÁT BAN THỦY ĐẬU ĐA LỨA TUỔI] (Ngày 14 - 16)
```
...
```diagram
[ĐỘ BAO PHỦ VẮC-XIN CỘNG ĐỒNG]
       │
       ├──► < 20%: Chưa đủ tạo tác động dịch tễ học rõ rệt.
       │
       ├──► 20% - 80% [VÙNG NGUY HIỂM: DỊCH CHUYỂN TUỔI (Age Shift)]:
       │      • Virus hoang dại giảm lưu hành nhưng không đủ tạo miễn dịch cộng đồng.
       │      • Tích lũy người nhạy cảm sang tuổi thanh thiếu niên và người lớn.
       │      • Tăng tỷ lệ biến chứng nặng, viêm phổi và tử vong toàn quốc!
       │
       └──► ≥ 80% [MỤC TIÊU BẮT BUỘC]:
              • Cắt đứt chuỗi lây truyền cộng đồng bền vững (Herd Immunity).
              • Giảm triệt để số ca mắc và tử vong ở mọi lứa tuổi.
```
...
```diagram
[PHƠI NHIỄM VỚI BỆNH NHÂN THỦY ĐẬU / ZONA]
                    │
                    ▼
       [ĐÁNH GIÁ BẰNG CHỨNG MIỄN DỊCH]
       (Đã tiêm đủ 2 mũi / Kháng thể (+) / Tiền sử mắc xác định)
                    │
        ┌───────────┴───────────┐
      [CÓ]                    [KHÔNG]
        │                       │
[KHÔNG CẦN PEP]                 ▼
                 [PHÂN TẦNG ĐỐI TƯỢNG NGUY CƠ]
                                │
   ┌────────────────────────────┼────────────────────────────┐
   │                            │                            │
   ▼                            ▼                            ▼
[NGƯỜI KHỎE MẠNH ≥ 12 THÁNG]  [TRẺ NHỎ KHỎE MẠNH < 12 THÁNG] [NHÓM NGUY CƠ CAO (CHỐNG CHỈ ĐỊNH VẮC-XIN SỐNG)]
   │                            │                            • Phụ nữ mang thai chưa có miễn dịch
[TIÊM VẮC-XIN THỦY ĐẬU]       [THEO DÕI LÂM SÀNG]            • Người suy giảm miễn dịch nặng
(Tối ưu trong 72h,             (Không tiêm vắc-xin)          • Trẻ sơ sinh mẹ mắc thủy đậu sát sinh (-5 đến +2 ngày)
 dùng được đến 120h/5 ngày)                                  • Trẻ sinh non nằm viện nguy cơ cao
                                                             │
                                                             ▼
                                                [ĐÁNH GIÁ KHẢ NĂNG TIẾP CẬN THUỐC]
                                                             │
                              ┌──────────────────────────────┼──────────────────────────────┐
                              │                              │                              │
                              ▼                              ▼                              ▼
                       [ƯU TIÊN 1: VZIG]              [ƯU TIÊN 2: IVIG]           [ƯU TIÊN 3: PREEMPTIVE ANTIVIRAL]
                      (Tiêm bắp trong 96h,          (Khi không có VZIG)           (Khi không có VZIG & IVIG hoặc quá 10 ngày)
                      dùng được đến 10 ngày)                 │                              │
                              │                     Liều 400 - 500 mg/kg          [ACYCLOVIR HOẶC VALACYCLOVIR]
                      Liều 125 U / 10 kg                 truyền TM duy nhất        (Bắt đầu từ ngày thứ 7 - 10 sau phơi nhiễm,
                      (Tối đa 625 U / 5 lọ)                                        kéo dài liên tục trong 7 ngày)
```
