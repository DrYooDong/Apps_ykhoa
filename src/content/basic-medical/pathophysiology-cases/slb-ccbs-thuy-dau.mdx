...
<div class="module-badge-group">
  ...
  <span class="badge badge-teal"><i class="fa-solid fa-virus"></i> Varicella-Zoster Virus Hướng Thần Kinh</span>
  <span class="badge badge-amber"><i class="fa-solid fa-bolt"></i> Ẩn Nấp Hạch Rễ Sau &amp; Đau Thần Kinh (PHN)</span>
</div>
...
<section class="stats-strip theme-patho">
  <div class="stats-grid">
    <div class="stat-card">
      <div class="stat-val teal">Nhiễm Trùng Nguyên Phát</div>
      <div class="stat-lbl">Lây qua giọt bắn hô hấp nhân lên tại hạch hạnh nhân và đường thở trên trước khi vào máu</div>
    </div>
    <div class="stat-card">
      <div class="stat-val emerald">Cư Trú Hạch Rễ Sau</div>
      <div class="stat-lbl">VZV di chuyển ngược dòng sợi trục thần kinh cảm giác, ẩn nấp bền vững suốt đời trong DRG</div>
    </div>
    <div class="stat-card">
      <div class="stat-val amber">Tái Hoạt Zona Thần Kinh</div>
      <div class="stat-lbl">Suy giảm miễn dịch tế bào kích hoạt virus nhân lên, phân bố ban bọng nước theo dermatome</div>
    </div>
    <div class="stat-card">
      <div class="stat-val rose">Đau Thần Kinh PHN</div>
      <div class="stat-lbl">Biến chứng đau sau Zona kéo dài &gt; 90 ngày; dự phòng hữu hiệu bằng vắc-xin Shingrix 97%</div>
    </div>
  </div>
</section>
...
## 1. Cấu Trúc Virion VZV & Vòng Đời Tế Bào
...
## 2. Sinh Bệnh Học Toàn Thân, Hướng Tế Bào T & Hướng Da
...
## 3. Hướng Thần Kinh, Trạng Thái Ẩn Nấp & Tái Hoạt Zona
...
## 4. Chiến Lược Vắc-Xin & Dự Phòng Sau Phơi Nhiễm (PEP)
...
<div class="flowchart-card">
  ...
  <div class="flowchart-svg-container">
    <svg class="flowchart-svg" viewBox="0 0 880 1018" width="880" height="1018" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="30" y="766" width="250" height="90" rx="8" fill="var(--color-surface-2, #f8fafc)" stroke="var(--color-primary, #0284c7)" stroke-width="1.5"/>
      <text x="155" y="788" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="11.5" fill="var(--color-primary, #0284c7)">ƯU TIÊN 1: VZIG (VariZIG)</text>
      <line x1="45" y1="796" x2="265" y2="796" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="42" y="814" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Tiêm bắp trong 96h (tối đa 10 ngày)</text>
      <text x="42" y="832" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Liều: 125 U / 10 kg (max 625 U)</text>
      <text x="42" y="850" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text-muted, #475569)">• Bảo vệ thụ động kéo dài ~3 tuần</text>
      <rect x="315" y="766" width="250" height="90" rx="8" fill="var(--color-surface-2, #f8fafc)" stroke="var(--amber, #d97706)" stroke-width="1.5"/>
      <text x="440" y="788" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="11.5" fill="var(--amber, #d97706)">ƯU TIÊN 2: IVIG THAY THẾ</text>
      <line x1="330" y1="796" x2="550" y2="796" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="327" y="814" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Khi không có sẵn chế phẩm VZIG</text>
      <text x="327" y="832" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Liều: IVIG 400 - 500 mg/kg truyền TM</text>
      <text x="327" y="850" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text-muted, #475569)">• Chỉ định trong vòng 10 ngày phơi nhiễm</text>
      <rect x="600" y="766" width="250" height="90" rx="8" fill="var(--color-surface-2, #f8fafc)" stroke="var(--purple, #7c3aed)" stroke-width="1.5"/>
      <text x="725" y="788" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="700" font-size="11.5" fill="var(--purple, #7c3aed)">ƯU TIÊN 3: PREEMPTIVE ANTIVIRAL</text>
      <line x1="615" y1="796" x2="835" y2="796" stroke="var(--color-border, #cbd5e1)" stroke-width="1"/>
      <text x="612" y="814" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Khi không có VZIG / IVIG hoặc &gt; 10 ngày</text>
      <text x="612" y="832" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text, #0f172a)">• Khởi động từ ngày thứ 7 sau tiếp xúc</text>
      <text x="612" y="850" text-anchor="start" font-family="'Plus Jakarta Sans', sans-serif" font-size="10" fill="var(--color-text-muted, #475569)">• Chặn đỉnh Viraemia thứ cấp đợt 2</text>
      <line x1="725" y1="856" x2="725" y2="870 L 440 870 L 440 884" stroke="var(--purple, #7c3aed)" stroke-width="1.8" marker-end="url(#arrBlue)"/>
      {/* Single Node: ACYCLOVIR HOẶC VALACYCLOVIR */}
      <rect x="165" y="884" width="550" height="74" rx="10" fill="var(--color-surface-2, #f8fafc)" stroke="var(--purple, #7c3aed)" stroke-width="1.8"/>
      <text x="440" y="906" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-weight="800" font-size="12" fill="var(--purple, #7c3aed)">PHÁC ĐỒ KHÁNG VIRUS PHÒNG NGỪA ĐÓN ĐẦU (PREEMPTIVE)</text>
      <text x="440" y="926" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-size="11" fill="var(--color-text, #0f172a)">Acyclovir 80 mg/kg/ngày (chia 4 lần) hoặc Valacyclovir 20 mg/kg/liều (x 3 lần/ngày)</text>
      <text x="440" y="944" text-anchor="middle" font-family="'Plus Jakarta Sans', sans-serif" font-size="10.5" fill="var(--color-text-muted, #475569)">Bắt đầu từ ngày thứ 7 - 10 sau phơi nhiễm, uống liên tục trong 7 ngày</text>
    </svg>
  </div>
</div>
...
## 5. Trích Dẫn Y Văn AMA & Liên Kết Đa Chuyên Khoa
