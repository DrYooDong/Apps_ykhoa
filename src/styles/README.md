...
*   **Quy trình Design-to-Code (Figma → Vanilla CSS)**: Mọi thông số lấy từ Figma Inspect (mã màu, padding, radius, shadow) bắt buộc phải chuyển đổi thành biến CSS Variables (`var(--color-primary)`, `var(--radius-lg)`...). Chi tiết xem tại [docs/DESIGN_TO_CODE.md](../docs/DESIGN_TO_CODE.md).
