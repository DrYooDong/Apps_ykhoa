    ...
    <footer class="global-footer">
      <div class="footer-main-content">
        ...
        <div class="footer-section footer-links">
          ...
          <ul class="footer-nav-list">
            <li><a href="${root}#/docspace">⚡ Command Bar (Ctrl + K)</a></li>
            <li><a href="${root}#/docspace">🧮 Thang điểm Smart Tools</a></li>
            <li><a href="${root}#/docspace">💊 Dược thư &amp; Tương tác thuốc</a></li>
            <li><a href="${root}#/docspace">🔬 Phân tích Khí máu ABG</a></li>
            <li><a href="${root}#/docspace/sbar">📑 Báo cáo SBAR &amp; Giao ca</a></li>
          </ul>
        </div>
