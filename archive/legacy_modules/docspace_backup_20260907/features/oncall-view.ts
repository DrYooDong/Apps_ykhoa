          ...
          <div style="background:var(--color-surface); border-radius:12px; padding:24px; box-shadow:0 4px 6px rgba(0,0,0,0.05);">
            ...
            <div style="margin-top: 32px; border-top: 1px dashed var(--color-border); padding-top: 20px;">
              <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:12px;">
                ...
                <a href="#/vault" style="font-size:11px; color:var(--color-primary); text-decoration:none; font-weight:700;">
                  Xem tất cả 2.250+ bài <i class="fa-solid fa-arrow-up-right-from-square"></i>
                </a>
              </div>
              <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(240px, 1fr)); gap:10px;">
                <a href="#/vault?search=Hội chứng vành cấp" class="dsp-card" style="padding:10px 12px; text-decoration:none; color:inherit; border:1px solid rgba(239,68,68,0.25); background:rgba(239,68,68,0.02); display:flex; align-items:center; gap:10px;">
                ...
                <a href="#/vault?search=COPD" class="dsp-card" style="padding:10px 12px; text-decoration:none; color:inherit; border:1px solid rgba(2,132,199,0.25); background:rgba(2,132,199,0.02); display:flex; align-items:center; gap:10px;">
                ...
                <a href="#/vault?search=Sốc nhiễm" class="dsp-card" style="padding:10px 12px; text-decoration:none; color:inherit; border:1px solid rgba(245,158,11,0.25); background:rgba(245,158,11,0.02); display:flex; align-items:center; gap:10px;">
                ...
                <a href="#/vault?search=DKA" class="dsp-card" style="padding:10px 12px; text-decoration:none; color:inherit; border:1px solid rgba(139,92,246,0.25); background:rgba(139,92,246,0.02); display:flex; align-items:center; gap:10px;">
