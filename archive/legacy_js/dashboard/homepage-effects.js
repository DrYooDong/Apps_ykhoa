...
(function () {
  ...
  function initHeroClock() {
    ...
    function updateDayScoreBadge(now) {
      if (window.GoodDayCalculator) {
        if (typeof window.GoodDayCalculator.updateDayScoreBadge === 'function') {
          window.GoodDayCalculator.updateDayScoreBadge(now);
        }
        if (typeof window.GoodDayCalculator.updateHeroEnergyBadge === 'function') {
          window.GoodDayCalculator.updateHeroEnergyBadge(now);
        }
      }
    }

    function openDayScoreModal() {
      if (window.GoodDayCalculator && typeof window.GoodDayCalculator.openDayScoreModal === 'function') {
        window.GoodDayCalculator.openDayScoreModal(new Date(), 'day');
      }
    }

    function openEnergyModal() {
      if (window.GoodDayCalculator && typeof window.GoodDayCalculator.openEnergyModal === 'function') {
        window.GoodDayCalculator.openEnergyModal();
      }
    }
    ...
    // Attach click listeners for Hero Badges
