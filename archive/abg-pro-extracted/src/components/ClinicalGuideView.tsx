        ...
        <div className="flex items-start sm:items-center space-x-3.5">
          ...
          <div>
            ...
            <p className="text-xs text-indigo-200 mt-1">
              Hợp nhất trọn vẹn phương pháp tiếp cận 6 bước, lưu đồ tương tác, cây quyết định Hennessey (Hình 16, 22, 23) và cẩm nang kỹ thuật lấy máu.
            </p>
          </div>
        </div>
        ...
        {onOpenGlossary && (
          <div className="flex items-center space-x-2 shrink-0 self-start md:self-auto">
            <button
              ...
              className="flex items-center space-x-2 px-3.5 py-2.5 rounded-xl text-xs font-bold bg-white/10 hover:bg-white/20 text-indigo-100 border border-white/20 transition-all hover:scale-102 cursor-pointer shadow-xs"
              title="Tra cứu nhanh định nghĩa, công thức & viết tắt"
            >
