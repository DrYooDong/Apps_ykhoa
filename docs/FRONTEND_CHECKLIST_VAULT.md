...
- [ ] **2.3 Thẻ Đóng Mở Toàn Vẹn**: Chạy script `node scratch/check_tags.js <file.html>` đảm bảo **0 lỗi unclosed tags**.
...
- [ ] **7.5 Registry Synchronized**: Đã thêm file mới vào `docs/FILE_MAP.md` và các file Data Registry (`guidelinesdata.js`, `benh-ly.js`, `cong-cu.html`).
