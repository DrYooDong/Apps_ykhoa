---
title: "Công thức CKD-EPI 2021 Ước tính Độ lọc cầu thận (eGFR)"
aliases: ["Công thức CKD-EPI 2021 Ước tính Độ lọc cầu thận (eGFR)", "CKD_EPI", "CKD-EPI", "eGFR", "độ lọc cầu thận", "bệnh thận mạn", "creatinine"]
keywords: ["CKD-EPI", "eGFR", "độ lọc cầu thận", "bệnh thận mạn", "creatinine"]
icd10: ["N18"]
specialty: "Thận - Tiết niệu"
tags: ["CliniPortal", "ClinicalCalculator", "KhoCongCu", "Thận - Tiết niệu"]
type: "calculator"
---

# Công thức CKD-EPI 2021 Ước tính Độ lọc cầu thận (eGFR)

> [!NOTE]
> **Chuyên khoa:** Thận - Tiết niệu | **Mã ICD-10:** N18 | **Phân hệ:** Kho Công Cụ Lâm Sàng

## 1. Mục Đích & Ý Nghĩa Lâm Sàng
Thang điểm / công thức **Công thức CKD-EPI 2021 Ước tính Độ lọc cầu thận (eGFR)** được áp dụng rộng rãi trong thực hành lâm sàng nhằm lượng hóa nguy cơ, hỗ trợ ra quyết định phân tầng bệnh nhân và hướng dẫn xử trí chính xác theo khuyến cáo Y học Chứng cứ (EBM).
