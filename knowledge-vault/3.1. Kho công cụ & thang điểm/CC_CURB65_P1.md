---
title: "CURB-65 Phân tầng độ nặng Viêm phổi"
aliases: ["CURB-65 Phân tầng độ nặng Viêm phổi", "CURB65", "CURB-65", "viêm phổi", "CAP", "độ nặng", "nhập viện"]
keywords: ["CURB-65", "viêm phổi", "CAP", "độ nặng", "nhập viện"]
icd10: ["J18"]
specialty: "Hô hấp & Cấp cứu"
tags: ["CliniPortal", "ClinicalCalculator", "KhoCongCu", "Hô hấp & Cấp cứu"]
type: "calculator"
---

# CURB-65 Phân tầng độ nặng Viêm phổi

> [!NOTE]
> **Chuyên khoa:** Hô hấp & Cấp cứu | **Mã ICD-10:** J18 | **Phân hệ:** Kho Công Cụ Lâm Sàng

## 1. Mục Đích & Ý Nghĩa Lâm Sàng
Thang điểm / công thức **CURB-65 Phân tầng độ nặng Viêm phổi** được áp dụng rộng rãi trong thực hành lâm sàng nhằm lượng hóa nguy cơ, hỗ trợ ra quyết định phân tầng bệnh nhân và hướng dẫn xử trí chính xác theo khuyến cáo Y học Chứng cứ (EBM).
