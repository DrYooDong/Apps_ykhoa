---
title: "Thang điểm Đột quỵ Não NIHSS"
aliases: ["Thang điểm Đột quỵ Não NIHSS", "NIHSS", "NIHSS", "đột quỵ", "nhồi máu não", "tiêu sợi huyết", "r-tPA"]
keywords: ["NIHSS", "đột quỵ", "nhồi máu não", "tiêu sợi huyết", "r-tPA"]
icd10: ["I63"]
specialty: "Thần kinh & Cấp cứu"
tags: ["CliniPortal", "ClinicalCalculator", "KhoCongCu", "Thần kinh & Cấp cứu"]
type: "calculator"
---
...
> [!NOTE]
> **Chuyên khoa:** Thần kinh & Cấp cứu | **Mã ICD-10:** I63 | **Phân hệ:** Kho Công Cụ Lâm Sàng

## 1. Mục Đích & Ý Nghĩa Lâm Sàng
Thang điểm / công thức **Thang điểm Đột quỵ Não NIHSS** được áp dụng rộng rãi trong thực hành lâm sàng nhằm lượng hóa nguy cơ, hỗ trợ ra quyết định phân tầng bệnh nhân và hướng dẫn xử trí chính xác theo khuyến cáo Y học Chứng cứ (EBM).
