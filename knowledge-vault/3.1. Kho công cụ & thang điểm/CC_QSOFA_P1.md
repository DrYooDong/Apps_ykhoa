---
title: "Thang điểm qSOFA Sàng lọc nhanh Sốc nhiễm khuẩn"
aliases: ["Thang điểm qSOFA Sàng lọc nhanh Sốc nhiễm khuẩn", "QSOFA", "qSOFA", "sepsis", "nhiễm trùng huyết", "sốc nhiễm khuẩn"]
keywords: ["qSOFA", "sepsis", "nhiễm trùng huyết", "sốc nhiễm khuẩn"]
icd10: ["A41.9", "R57.2"]
specialty: "Hồi sức - Cấp cứu"
tags: ["CliniPortal", "ClinicalCalculator", "KhoCongCu", "Hồi sức - Cấp cứu"]
type: "calculator"
---

# Thang điểm qSOFA Sàng lọc nhanh Sốc nhiễm khuẩn

> [!NOTE]
> **Chuyên khoa:** Hồi sức - Cấp cứu | **Mã ICD-10:** A41.9, R57.2 | **Phân hệ:** Kho Công Cụ Lâm Sàng

## 1. Mục Đích & Ý Nghĩa Lâm Sàng
Thang điểm / công thức **Thang điểm qSOFA Sàng lọc nhanh Sốc nhiễm khuẩn** được áp dụng rộng rãi trong thực hành lâm sàng nhằm lượng hóa nguy cơ, hỗ trợ ra quyết định phân tầng bệnh nhân và hướng dẫn xử trí chính xác theo khuyến cáo Y học Chứng cứ (EBM).
