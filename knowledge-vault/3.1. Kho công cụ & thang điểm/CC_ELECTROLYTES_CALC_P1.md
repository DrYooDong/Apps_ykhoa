---
title: "Công thức Bù Điện giải & Nâng Natri an toàn"
aliases: ["Công thức Bù Điện giải & Nâng Natri an toàn", "ELECTROLYTES_CALC", "bù natri", "hạ natri", "tăng kali", "Adrogue-Madias", "FWD"]
keywords: ["bù natri", "hạ natri", "tăng kali", "Adrogue-Madias", "FWD"]
icd10: ["E87.1", "E87.5"]
specialty: "Hồi sức & Thận"
tags: ["CliniPortal", "ClinicalCalculator", "KhoCongCu", "Hồi sức & Thận"]
type: "calculator"
---

# Công thức Bù Điện giải & Nâng Natri an toàn

> [!NOTE]
> **Chuyên khoa:** Hồi sức & Thận | **Mã ICD-10:** E87.1, E87.5 | **Phân hệ:** Kho Công Cụ Lâm Sàng

## 1. Mục Đích & Ý Nghĩa Lâm Sàng
Thang điểm / công thức **Công thức Bù Điện giải & Nâng Natri an toàn** được áp dụng rộng rãi trong thực hành lâm sàng nhằm lượng hóa nguy cơ, hỗ trợ ra quyết định phân tầng bệnh nhân và hướng dẫn xử trí chính xác theo khuyến cáo Y học Chứng cứ (EBM).
