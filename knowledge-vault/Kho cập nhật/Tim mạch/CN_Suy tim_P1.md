...
Sự phát triển của y học cá thể hóa đã làm thay đổi cách chúng ta phân loại và nhìn nhận bệnh suy tim:
...
Trong năm 2026, phác đồ quản lý suy tim cấp nhập viện đã chuyển dịch từ mô hình cũ (nhập viện giải quyết xung huyết $\rightarrow$ xuất viện $\rightarrow$ chỉnh liều chậm tại phòng khám) sang một **mô hình mới (New Paradigm)**:

- **Khởi trị Tứ trụ và Tối ưu hóa sớm trong viện:** Bệnh nhân cần được đánh giá tình trạng xung huyết, tiến hành giải quyết xung huyết đồng thời với việc khởi trị hoặc tái khởi trị các thuốc điều trị nội khoa nền tảng (GDMT) ngay trong thời gian nằm viện, và tăng liều nhanh chóng nếu dung nạp.
- **Vai trò của SGLT2i trong 24 giờ đầu:** 
	- SGLT2i hiện là nhóm thuốc duy nhất được đồng thuận khởi trị ==cực sớm== (ngay trong vòng 24 giờ đầu khi nhập viện) kể cả khi bệnh nhân mới vừa ổn định huyết động hoặc đang dùng lợi tiểu quai đường tĩnh mạch. 
	- Cơ chế của SGLT2i là làm giảm chọn lọc dịch mô kẽ mà ít ảnh hưởng đến thể tích nội mạch, giúp hiệp đồng với lợi tiểu quai để giảm xung huyết, bảo vệ thận và tạo tiền đề để dùng các thuốc tứ trụ khác (như ARNI, MRA) mà không gây tụt huyết áp nghiêm trọng.

# 3. Kỷ Nguyên Của Các Liệu Pháp Mới Trong Suy Tim HFmrEF và HFpEF

Sự thiếu hụt phương pháp điều trị cho nhóm bệnh nhân có EF > 40% nay đã được giải quyết bằng ba trụ cột mới được cập nhật vào năm 2025-2026:

## 3.1. Thuốc ức chế SGLT2 (SGLT2i)

SGLT2i đã chính thức trở thành chỉ định **Class 1 (Mức độ bằng chứng A)**, là nền tảng đầu tay (first-line) bắt buộc đối với tất cả bệnh nhân suy tim bất kể phân suất tống máu, nhằm giảm tử vong tim mạch và nhập viện do suy tim.

## 3.2. Liệu pháp dựa trên Incretin (Đồng vận GLP-1 và GLP-1/GIP)

Các nghiên cứu bản lề như STEP-HFpEF (Semaglutide) và SUMMIT (Tirzepatide) công bố năm 2024-2025 đã làm thay đổi cục diện điều trị cho kiểu hình "Suy tim HFpEF đi kèm Béo phì".

- **Ứng dụng lâm sàng:** Hướng dẫn 2026 khuyến cáo mạnh mẽ việc bổ sung nhóm thuốc đồng vận GLP-1 (như Semaglutide) cho bệnh nhân HFpEF có kèm béo phì (hoặc đái tháo đường) nhằm giảm triệu chứng, cải thiện khả năng gắng sức và giảm các biến cố suy tim.
- **Cơ chế:** Các thuốc này không chỉ giúp giảm cân (giảm tải cơ học) mà còn có tác dụng chống viêm trực tiếp lên cơ tim và màng ngoài tim, đảo ngược tình trạng xơ hóa mô kẽ do mỡ ngoại tâm mạc gây ra ở bệnh nhân béo phì.

## 3.3. Thuốc đối kháng thụ thể Mineralocorticoid không steroid (nsMRA)

Dựa trên kết quả từ thử nghiệm FINEARTS-HF công bố gần đây, Finerenone (một nsMRA) đã chứng minh hiệu quả giảm nguy cơ tử vong tim mạch và biến cố suy tim ở nhóm bệnh nhân HFmrEF và HFpEF. Khuyến cáo 2026 đã đưa Finerenone vào ứng dụng lâm sàng cho bệnh nhân suy tim EF > 40% có kèm đái tháo đường và bệnh thận mạn có albumin niệu, nhằm cải thiện đồng thời tiên lượng tim và thận. Ngược lại với MRA steroid (Spironolactone), Finerenone ít gây tác dụng phụ tăng kali máu và kháng androgen (như chứng vú to ở nam giới).
