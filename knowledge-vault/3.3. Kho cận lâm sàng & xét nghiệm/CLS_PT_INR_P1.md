---
title: "Cận lâm sàng: Thời gian Prothrombin & Tỷ số INR (PT/INR)"
aliases: ["Thời gian Prothrombin & Tỷ số INR (PT/INR)", "PT_INR", "PT", "INR", "đông máu ngoại sinh", "Warfarin"]
keywords: ["PT", "INR", "đông máu ngoại sinh", "Warfarin"]
icd10: ["Z01.89"]
specialty: "Tim mạch & Huyết học"
tags: ["CliniPortal", "Diagnostics", "KhoCanLamSang", "Tim mạch & Huyết học"]
type: "lab_test"
---

# Cận Lâm Sàng: Thời gian Prothrombin & Tỷ số INR (PT/INR)

> [!NOTE]
> **Nhóm xét nghiệm:** Đông máu | **Đơn vị đo:** Ratio | **Chuyên khoa:** Tim mạch & Huyết học

## 1. Mục Đích & Chỉ Định Lâm Sàng
Xét nghiệm **Thời gian Prothrombin & Tỷ số INR (PT/INR)** được chỉ định để chẩn đoán, theo dõi tiến triển bệnh, đánh giá mức độ tổn thương cơ quan đích và hướng dẫn điều chỉnh phác đồ điều trị kịp thời.
