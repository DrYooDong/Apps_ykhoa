---
title: "Cận lâm sàng: Natri máu (Na+)"
aliases: ["Natri máu (Na+)", "SODIUM", "Natri", "Na+", "hạ natri", "tăng natri", "phù não"]
keywords: ["Natri", "Na+", "hạ natri", "tăng natri", "phù não"]
icd10: ["Z01.89"]
specialty: "Hồi sức & Thận"
tags: ["CliniPortal", "Diagnostics", "KhoCanLamSang", "Hồi sức & Thận"]
type: "lab_test"
---

# Cận Lâm Sàng: Natri máu (Na+)

> [!NOTE]
> **Nhóm xét nghiệm:** Điện giải | **Đơn vị đo:** mmol/L | **Chuyên khoa:** Hồi sức & Thận

## 1. Mục Đích & Chỉ Định Lâm Sàng
Xét nghiệm **Natri máu (Na+)** được chỉ định để chẩn đoán, theo dõi tiến triển bệnh, đánh giá mức độ tổn thương cơ quan đích và hướng dẫn điều chỉnh phác đồ điều trị kịp thời.
