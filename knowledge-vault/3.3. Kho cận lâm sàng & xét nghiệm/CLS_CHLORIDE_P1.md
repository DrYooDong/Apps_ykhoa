---
title: "Cận lâm sàng: Clo máu (Cl-)"
aliases: ["Clo máu (Cl-)", "CHLORIDE", "Clo", "Cl-", "Anion Gap", "toan chuyển hóa"]
keywords: ["Clo", "Cl-", "Anion Gap", "toan chuyển hóa"]
icd10: ["Z01.89"]
...
# Cận Lâm Sàng: Clo máu (Cl-)

> [!NOTE]
> **Nhóm xét nghiệm:** Điện giải | **Đơn vị đo:** mmol/L | **Chuyên khoa:** Hồi sức & Thận

## 1. Mục Đích & Chỉ Định Lâm Sàng
Xét nghiệm **Clo máu (Cl-)** được chỉ định để chẩn đoán, theo dõi tiến triển bệnh, đánh giá mức độ tổn thương cơ quan đích và hướng dẫn điều chỉnh phác đồ điều trị kịp thời.
