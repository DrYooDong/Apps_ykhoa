---
title: "Cận lâm sàng: Urea máu & Blood Urea Nitrogen (BUN)"
aliases: ["Urea máu & Blood Urea Nitrogen (BUN)", "UREA_BUN", "Urea", "BUN", "tỷ số BUN/Cr", "xuất huyết tiêu hóa"]
keywords: ["Urea", "BUN", "tỷ số BUN/Cr", "xuất huyết tiêu hóa"]
icd10: ["Z01.89"]
specialty: "Thận & Cấp cứu"
tags: ["CliniPortal", "Diagnostics", "KhoCanLamSang", "Thận & Cấp cứu"]
type: "lab_test"
---

# Cận Lâm Sàng: Urea máu & Blood Urea Nitrogen (BUN)

> [!NOTE]
> **Nhóm xét nghiệm:** Sinh hóa Thận | **Đơn vị đo:** mmol/L | **Chuyên khoa:** Thận & Cấp cứu

## 1. Mục Đích & Chỉ Định Lâm Sàng
Xét nghiệm **Urea máu & Blood Urea Nitrogen (BUN)** được chỉ định để chẩn đoán, theo dõi tiến triển bệnh, đánh giá mức độ tổn thương cơ quan đích và hướng dẫn điều chỉnh phác đồ điều trị kịp thời.
