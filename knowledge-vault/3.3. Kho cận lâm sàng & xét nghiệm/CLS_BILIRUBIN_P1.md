---
title: "Cận lâm sàng: Bilirubin toàn phần & Trực tiếp"
aliases: ["Bilirubin toàn phần & Trực tiếp", "BILIRUBIN", "Bilirubin", "vàng da", "tắc mật", "tán huyết"]
keywords: ["Bilirubin", "vàng da", "tắc mật", "tán huyết"]
icd10: ["Z01.89"]
specialty: "Tiêu hóa & Gan mật"
tags: ["CliniPortal", "Diagnostics", "KhoCanLamSang", "Tiêu hóa & Gan mật"]
type: "lab_test"
---

# Cận Lâm Sàng: Bilirubin toàn phần & Trực tiếp

> [!NOTE]
> **Nhóm xét nghiệm:** Sinh hóa Gan | **Đơn vị đo:** µmol/L | **Chuyên khoa:** Tiêu hóa & Gan mật

## 1. Mục Đích & Chỉ Định Lâm Sàng
Xét nghiệm **Bilirubin toàn phần & Trực tiếp** được chỉ định để chẩn đoán, theo dõi tiến triển bệnh, đánh giá mức độ tổn thương cơ quan đích và hướng dẫn điều chỉnh phác đồ điều trị kịp thời.
