...
- **Số lượng phế nang**:
    ...
    - Sau 3 tuổi, tốc độ tăng sinh giảm đáng kể và hầu như rất ít phế nang mới được tạo thêm sau 8 tuổi.
...
#### 2.2. Thông Khí Bàng Hệ Và Lỗ Phế Nang (Lỗ Kohn)

- **Các cấu trúc thông khí bàng hệ**: Bao gồm các **lỗ phế nang (lỗ Kohn)** nằm giữa các phế nang liền kề, các **kênh tiểu phế quản – phế nang (kênh Lambert)** và các **kênh liên tiểu phế quản (kênh Martin)**. Các cấu trúc này giúp duy trì sự cân bằng áp lực khí giữa các phế nang và các vùng phổi lân cận.
...
- **Đặc điểm mô học và sự tái cấu trúc mạch máu phổi**:
    - Về mô học, động mạch phổi được phân thành: động mạch đàn hồi, động mạch có cơ, động mạch có một phần cơ và động mạch không cơ.
    - Sự trưởng thành và tái cấu trúc mạch máu phổi diễn ra trong $2 - 3\text{ năm}$ đầu sau sinh. Sự cơ hóa thành động mạch diễn ra chậm hơn sự nhân lên của phế nang và sự xuất hiện các động mạch mới.
- **Đặc điểm sức cản mạch máu phổi ở thai nhi và trẻ sơ sinh**:
    - Ở thai nhi và trẻ mới sinh, số lượng động mạch phổi có cơ trơn chiếm tỷ lệ cao và lòng mạch bị co thắt do phân áp oxy máu ($PaO_2$) thấp ($< 30\text{ mmHg}$). Điều này tạo ra **sức cản động mạch phổi rất cao**, là đặc trưng sinh lý giúp duy trì luồng thông (shunt) Phải – Trái qua ống động mạch trong tuần hoàn thai nhi.
    - Sau sinh, khi trẻ bắt đầu hít thở, máu được oxy hóa tốt làm các mạch máu phổi giãn ra, giảm sức cản và tăng tưới máu phổi. Bất kể tuổi thai, lòng mạch máu phổi của trẻ sơ sinh bắt đầu rộng ra rõ rệt sau sinh khoảng 10 ngày.
- **Phân loại mạch máu nhu mô phổi theo sinh lý**:
    - _Mạch máu phế nang_: Là các mao mạch nằm ở trung tâm vách phế nang, chịu ảnh hưởng trực tiếp bởi áp lực phế nang.
    - _Mạch máu ngoài phế nang_: Là các động mạch và tĩnh mạch nằm ở góc vách phế nang, chịu tác động của áp lực âm trong khoang màng phổi.

---

#### 2.4. Hệ Thống Thần Kinh Chi Phối Phổi

Phổi được chi phối bởi cả hai nhánh của hệ thần kinh tự động thông qua đám rối phổi tập hợp quanh rốn phổi:

- **Hệ phó giao cảm (xuất phát từ dây thần kinh lang thang - dây X)**: Các sợi thần kinh đi cùng đường dẫn khí và mạch máu. Kích thích hệ phó giao cảm làm **co thắt cơ trơn đường dẫn khí**.
- **Hệ giao cảm (xuất phát từ hạch ngực trên và hạch cổ)**: Kích thích hệ giao cảm làm **dãn cơ trơn đường dẫn khí**.
- **Đặc điểm đáp ứng mạch máu phổi**: Đáp ứng của mạch máu phổi với kích thích thần kinh chịu ảnh hưởng bởi tuổi và trương lực mạch ban đầu. Ví dụ ở phổi thai nhi, kích thích phó giao cảm gây dãn mạch đáng kể, trong khi kích thích giao cảm lại gây co mạch rất nặng.

---

#### 2.5. Hậu Quả Sinh Lý Bệnh Học Và Khác Biệt Lâm Sàng Ở Trẻ Em
...
1. Nguyễn Thùy Vân Thảo. Bài 6: Đặc điểm giải phẫu và sinh lý hệ hô hấp trẻ em. Trong: _Nhi khoa YDS - Tập 1_. Bộ môn Nhi - Đại học Y Dược Thành phố Hồ Chí Minh; 2020:98-104.
