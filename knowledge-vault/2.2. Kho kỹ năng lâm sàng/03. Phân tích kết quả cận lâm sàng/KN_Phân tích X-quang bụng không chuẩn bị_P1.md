...
part: "P1"
aliases:
  - "Phân tích X-quang bụng không chuẩn bị"
keywords:
  - "phân tích x-quang bụng không chuẩn bị"
  - "tiêu hóa - gan mật"
...
**Bước 1: Đánh giá Hành chính, Kỹ thuật và Bệnh cảnh**
*   Kiểm tra tên bệnh nhân, ngày tháng chụp. 
*   Xác định tư thế chụp (nằm ngửa hay đứng). Tư thế nằm ngửa (supine) là tốt nhất để đánh giá sự phân bố khí trong ruột, trong khi **phim X-quang ngực đứng (Erect CXR) mới là phương pháp tốt nhất để phát hiện khí tự do trong ổ bụng (thủng tạng rỗng)**.

**Bước 2: Phân tích Dải khí trong ruột (Bowel Gas Pattern)**
Đây là phần quan trọng nhất của X-quang bụng. Cần phân biệt rõ hình ảnh của ruột non và ruột già:
*   **Ruột non (Small bowel):** Thường nằm ở trung tâm, khẩu kính bình thường khoảng ~2.5cm. Đặc điểm nhận dạng là các **nếp gấp vòng (Valvulae conniventes)** chạy vắt ngang qua toàn bộ lòng ruột, khoảng cách giữa các nếp gấp thường hẹp và đều nhau.
*   **Ruột già (Large bowel):** Nằm ở ngoại vi ổ bụng, khẩu kính bình thường ~5cm (riêng manh tràng có thể lên tới 10cm). Đặc trưng bởi các **nếp gấp bán nguyệt (Haustra)** không chạy ngang qua toàn bộ khẩu kính lòng ruột. Ruột già thường chứa nhiều khí và có thể thấy phân (dạng lốm đốm) ở đại tràng xuống.
*   **Dấu hiệu bệnh lý cần tìm:**
    *   **Giãn ruột:** Cả ruột non và ruột già đều có thể giãn và chứa dịch/khí trong tình trạng tắc ruột (Obstruction) hoặc liệt ruột (Ileus).
    *   **Xoắn ruột (Volvulus):** Điển hình là xoắn đại tràng sigma hoặc xoắn manh tràng, tạo ra hình ảnh dãn lớn hình "chữ U ngược" hoặc "hạt cà phê" (Coffee bean sign).
...
**Bước 5: Vôi hóa và Dị vật y tế (Calcifications & Medical Devices)**
*   **Sỏi tiết niệu:** Khoảng 90% sỏi tiết niệu cản quang và có thể nhìn thấy dọc theo đường đi của hệ niệu (phim KUB). Cần cẩn thận phân biệt sỏi niệu quản với sỏi tĩnh mạch vùng chậu (phleboliths - thường tròn, nhẵn và có trung tâm thấu quang).
*   **Sỏi mật:** Ngược lại với sỏi thận, chỉ khoảng 10% sỏi mật đủ cản quang để nhìn thấy trên X-quang bụng.
*   **Túi mật sứ (Porcelain gallbladder):** Vôi hóa toàn bộ thành túi mật do viêm mạn tính, có liên quan đến ung thư túi mật.
*   **Dị vật:** Tìm kiếm các thiết bị y tế như stent đường mật, ống thông thận (ống JJ), vòng tránh thai (IUD), clip phẫu thuật, catheter lọc màng bụng. 

**Bước 6: Xương và Khớp (Bones and Joints)**
Mặc dù không phải là phim chuyên dụng cho xương, bạn vẫn có thể phát hiện các tổn thương xương quan trọng:
