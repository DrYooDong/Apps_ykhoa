...
part: "P1"
aliases:
  - "Phân tích Sinh hóa chức năng gan"
keywords:
  - "phân tích sinh hóa chức năng gan"
  - "tiêu hóa - gan mật"
...
*   **Alkaline Phosphatase (ALP):** Là enzyme tập trung nhiều ở các vi nhung mao của tiểu quản mật. Tuy nhiên, ALP cũng có ở xương, ruột và nhau thai.
*   **Vai trò của GGT:** GGT (Gamma-glutamyl transferase) là enzyme nằm trên màng tế bào có hoạt động bài tiết cao. GGT đặc hiệu cho bệnh lý gan mật hơn vì nó không có ở xương. Do đó, việc đo GGT rất quan trọng để xác định mức tăng ALP là do ứ mật tại gan chứ không phải do bệnh lý xương (như trẻ đang phát triển hoặc bệnh Paget) hay phụ nữ có thai. 
*   **Nguyên nhân:** Tắc nghẽn đường mật (do sỏi, khối u), viêm xơ đường mật tiên phát (PSC), xơ gan ứ mật nguyên phát (PBC), thuốc, hoặc các bệnh lý thâm nhiễm (như sarcoidosis, amyloidosis). GGT cũng có thể tăng độc lập do béo phì, đái tháo đường, gan nhiễm mỡ, hoặc lạm dụng rượu.
...
Khi đã xác định được kiểu tổn thương, bước tiếp theo là tìm nguyên nhân cụ thể thông qua các marker:
*   **Xét nghiệm tự miễn:** Việc phát hiện kháng thể kháng ty thể (AMA) là tiêu chuẩn vàng để chẩn đoán xơ gan ứ mật nguyên phát (PBC). Kháng thể kháng nhân (ANA) và kháng cơ trơn (SMA) đặc trưng cho viêm gan tự miễn typ 1 (AIH-1), trong khi anti-LKM1 gợi ý AIH-2.
*   **Dấu ấn khối u (Tumor Markers):** Alpha-fetoprotein (AFP) tăng cao trong quá trình tái tạo gan hoặc ung thư biểu mô tế bào gan (HCC). CA19-9 có giá trị theo dõi sự tiến triển của viêm xơ đường mật tiên phát (PSC) thành ung thư đường mật.
*   **Bilan Sắt:** Đo nồng độ Ferritin huyết thanh và độ bão hòa Transferrin để sàng lọc bệnh ứ sắt (Hemochromatosis).

**Bước 5: Xem xét bối cảnh lâm sàng và loại trừ các yếu tố gây nhiễu**
*   **Sai số xét nghiệm:** Các yếu tố như mẫu máu bị tán huyết, huyết thanh vàng hoặc đục (do mỡ máu cao lipemia) có thể làm sai lệch các phép đo quang phổ của máy phân tích, ảnh hưởng đến kết quả GGT hoặc Albumin.
*   **Yếu tố sinh lý và môi trường:** Nồng độ ALT có sự dao động theo nhịp sinh học (chênh lệch tới 45% giữa sáng và chiều), cao hơn ở người béo phì (BMI cao) và giảm ở người hoạt động thể chất. Hút thuốc lá cũng có thể làm tăng các đồng vị của ALP.

Tóm lại, LFTs không bao giờ được phân tích một cách đơn độc. Việc chẩn đoán luôn đòi hỏi sự tích hợp giữa các kiểu hình bất thường của xét nghiệm sinh hóa với tiền sử bệnh nhân, thói quen dùng thuốc/rượu, và các biểu hiện lâm sàng.