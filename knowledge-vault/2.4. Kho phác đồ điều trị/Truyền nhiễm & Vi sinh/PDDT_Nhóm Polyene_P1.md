...
- **Nguồn gốc:** Hoạt chất đại diện của nhóm được chiết xuất tự nhiên từ vi khuẩn _Streptomyces nodosus_.
- **Phân loại & Các dạng bào chế:**
    - **Thuốc dùng toàn thân (Systemic):** **Amphotericin B** là đại diện duy nhất của nhóm được sử dụng qua đường toàn thân. Thuốc có 4 dạng bào chế chính bao gồm:
        1. Amphotericin B deoxycholate cổ điển (ABD; Fungizone).
        2. Amphotericin B dạng phân tán keo (ABCD; Amphotec hoặc Amphocil).
        3. Amphotericin B phức hợp lipid (ABLC; Abelcet).
        4. Liposomal amphotericin B (LAMB; AmBisome).
    - **Thuốc dùng tại chỗ (Topical):** Nystatin và Natamycin. Các thuốc này không được dùng toàn thân do độc tính quá cao, chỉ giới hạn ở các dạng bôi/đặt tại chỗ.
    - _Các dạng đang nghiên cứu:_ Đang có nhiều nỗ lực để phát triển Amphotericin B đường uống thông qua công nghệ hạt nano, vi nhũ tương hoặc màng bọc encochleation,.

### 2. Cơ chế tác dụng & Đề kháng (MOA & Resistance)

- **Cơ chế tác dụng:** Amphotericin B là một phân tử lưỡng phát (amphipathic) có khả năng tương tác trực tiếp với sterol trên màng tế bào nấm. Có 4 mô hình giải thích cơ chế diệt nấm của thuốc: (1) tạo lỗ thủng trên màng (pore-forming), (2) gây tổn thương oxy hóa, (3) hấp phụ bề mặt, và (4) mô hình "bọt biển" (sterol sponge) giúp chiết xuất sterol ra khỏi màng tế bào.
- **Đặc tính:** Khởi phát tác dụng cực kỳ nhanh chóng và không phụ thuộc vào tốc độ phát triển/phân chia của nấm do thuốc tấn công trực tiếp vào các cấu trúc màng đã hình thành sẵn. Thuốc còn có thể có các tác động điều hòa miễn dịch trên ký chủ.
- **Cơ chế đề kháng:** Sự đề kháng với Amphotericin B rất hiếm gặp. Các cơ chế được ghi nhận bao gồm sự đột biến các gen thuộc con đường sinh tổng hợp sphingolipid (như gen _FEN1_ và _SUR4_), làm điều hòa và thay đổi tính nhạy cảm với thuốc. Ngoài ra, nấm _Candida_ có thể phát triển đề kháng chéo giữa nhóm Triazole và Amphotericin B thông qua các đột biến ở nhánh khác của con đường sinh tổng hợp ergosterol (gen _ERG2_ và _ERG3_).
...
Tóm tắt 5 câu hỏi cốt lõi khi kê đơn Amphotericin B:

1. **Chẩn đoán có cần thiết phải dùng Polyene không?** (Thuốc thường được ưu tiên cứu mạng cho viêm màng não do _Cryptococcus_, nhiễm nấm lưỡng hình nội tạng nặng, nghi ngờ nhiễm nấm mốc _Mucorales_, hoặc sốt giảm bạch cầu hạt không rõ nguyên nhân).
2. **Đã chọn đúng dạng bào chế chưa?** (Nên ưu tiên chọn Liposomal Amphotericin B (LAMB) hoặc ABLC thay vì dạng Deoxycholate (Fungizone) để giảm thiểu rủi ro độc tính thận nếu bệnh viện có sẵn).
3. **Đã dự phòng phản ứng truyền dịch chưa?** _(Thông tin ngoài tài liệu: Đã cho y lệnh thuốc tiền mê/hạ sốt/kháng histamin trước khi điều dưỡng cắm dịch truyền chưa?)._
4. **Kế hoạch giám sát thận và điện giải?** (Đã đánh giá chức năng thận cơ bản chưa? Đã có y lệnh theo dõi và bù Kali, Magie hàng ngày, kết hợp bù dịch (pre-hydration) chưa?).
5. **Chiến lược xuống thang (Step-down)?** (Khi lâm sàng bệnh nhân đã ổn định và có kết quả cấy nấm, đã sẵn sàng chuyển sang thuốc kháng nấm đường uống an toàn hơn (ví dụ: nhóm Azole) để kết thúc liệu trình chưa?).