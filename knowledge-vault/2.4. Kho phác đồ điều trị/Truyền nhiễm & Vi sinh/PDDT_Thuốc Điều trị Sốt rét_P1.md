...
- **Động học của Artemisinin và Chiến lược Liệu pháp Phối hợp (ACT - Artemisinin Combination Therapy):**
    - _Đặc điểm PK/PD:_ Dẫn xuất Artemisinin hấp thu rất nhanh, chuyển hóa thành DHA có hoạt tính mạnh nhưng thời gian bán thải (T1/2) cực kỳ ngắn (chỉ khoảng 0.36 - 1.5 giờ).
    - _Tư duy lâm sàng:_ Do T1/2 quá ngắn, nếu dùng đơn trị, ký sinh trùng dễ dàng bùng phát lại. Vì vậy, WHO bắt buộc sử dụng ACT. Phác đồ kết hợp một chất diệt ký sinh trùng thần tốc (Artemisinin) để giảm nhanh sinh khối trong 3 ngày đầu, với một "thuốc đối tác" có T1/2 rất dài như Lumefantrine (T1/2: vài ngày) hoặc Piperaquine (T1/2: 12-28 ngày) để dọn sạch ký sinh trùng còn sót lại.
- **Chỉnh liều Artesunate tĩnh mạch (IV) theo lứa tuổi:**
    - Sinh khả dụng của DHA giảm ở trẻ nhỏ (dưới 20 kg hoặc 6-10 kg) sau khi tiêm tĩnh mạch/tiêm bắp. Do đó, thay vì liều 2.4 mg/kg như người lớn, trẻ < 20 kg cần dùng liều cao hơn là **3 mg/kg** để đạt nồng độ tối ưu.
- **Tối ưu hóa hấp thu Lumefantrine:**
    - Thuốc cực kỳ ưa lipid. Phải tư vấn bệnh nhân uống Artemether-Lumefantrine (Coartem) cùng với sữa hoặc thức ăn có chứa mỡ/dầu để tăng khả năng hấp thu thuốc, đặc biệt trong ngày thứ 2 và thứ 3 của liệu trình.

**3. Vấn đề Kháng thuốc và An toàn**

- **Sự xuất hiện của Sốt rét kháng Artemisinin:**
    - Ghi nhận sự chậm thanh thải ký sinh trùng tại vùng Tiểu vùng sông Mekong mở rộng (và nay lan sang Châu Phi). Vi khuẩn lẩn tránh bằng cách kéo dài chu kỳ vòng nhẫn. Chiến lược đối phó đang được áp dụng là liệu pháp 3 thuốc (Triple ACT), ví dụ thêm Mefloquine vào phác đồ Dihydroartemisinin-Piperaquine.
...
1. **Sốt rét ác tính = Tiêm tĩnh mạch Artesunate ngay lập tức:** Không được chậm trễ. Artesunate IV đã được chứng minh giảm tỷ lệ tử vong 35% so với Quinine ở châu Á và 22% ở châu Phi. Chỉ dùng Quinine IV nếu không có Artesunate.
...
2. Dondorp AM, Fanello CI, Hendriksen IC, et al. Artesunate versus quinine in the treatment of severe falciparum malaria in African children (AQUAMAT): an open-label, randomised trial. _Lancet_. 2010;376(9753):1647-1657.
3. Ashley EA, Dhorda M, Fairhurst RM, et al. Spread of artemisinin resistance in Plasmodium falciparum malaria. _N Engl J Med_. 2014;371(5):411-423.
4. Rolling T, Agbenyega T, Issifou S, et al. Delayed hemolysis after treatment with parenteral artesunate in African children with severe malaria--a double-center prospective study. _J Infect Dis_. 2014;209(12):1921-1928.
5. Baird JK. 8-Aminoquinoline therapy for latent malaria. _Clin Microbiol Rev_. 2019;32(4).