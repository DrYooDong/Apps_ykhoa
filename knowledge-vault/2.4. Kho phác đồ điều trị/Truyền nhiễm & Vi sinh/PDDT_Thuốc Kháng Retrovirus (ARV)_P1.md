...
- **Tên nhóm:** Nhóm ức chế enzyme Protease (Protease Inhibitors - PIs).
- **Các hoạt chất đại diện:**
    - _Trong điều trị HIV:_ Ritonavir, Atazanavir, Darunavir, Tipranavir, Lopinavir.
    - _Trong điều trị COVID-19:_ Nirmatrelvir (được bào chế phối hợp cùng Ritonavir dưới tên thương mại Paxlovid).

### 2. Cơ chế tác dụng & Đề kháng (MOA & Resistance)

- **Cơ chế tác dụng:** _(Thông tin ngoài tài liệu: Các PIs gắn trực tiếp vào vị trí xúc tác của enzyme protease của virus, ngăn chặn quá trình cắt các tiền protein (polyproteins) như gag và gag-pol thành các protein cấu trúc và enzyme chức năng. Hậu quả là virus sinh ra sẽ ở dạng các hạt không trưởng thành (immature) và không có khả năng lây nhiễm cho tế bào mới)._
- **Cơ chế đề kháng:** Sự đề kháng với nhóm PIs thường không xảy ra đột ngột mà theo kiểu tăng dần. Việc tích lũy nhiều đột biến gen khác nhau trên virus sẽ làm tăng dần mức độ kháng thuốc đối với nhóm PIs.

### 3. Phổ tác dụng (Spectrum of Activity)

- **Virus HIV:** PIs là nhóm thuốc kháng retrovirus (ARV) cực kỳ quan trọng, giúp ức chế sự nhân lên của virus HIV.
- **Virus SARS-CoV-2:** Nirmatrelvir là một chất ức chế protease đặc hiệu của virus SARS-CoV-2 gây bệnh COVID-19.

### 4. Dược động học & Dược lực học lâm sàng (PK/PD)

- **Chỉ số PK/PD quyết định:** Nồng độ đáy (Ctrough hoặc Cmin) có liên quan chặt chẽ với hiệu quả điều trị và độc tính của nhóm PIs.
...
Tóm tắt 5 câu hỏi cốt lõi khi kê đơn nhóm ức chế Protease (PIs):

1. **Đúng phác đồ & Có chất tăng cường (Booster) chưa?** (Bệnh nhân có đang dùng kèm Ritonavir để "boost" nồng độ Darunavir, Atazanavir hay Nirmatrelvir lên mức hiệu quả chưa?).
2. **Rà soát tương tác thuốc qua CYP3A?** (Bệnh nhân có đang dùng thuốc trị Lao như Rifampin làm mất tác dụng của PIs, hoặc dùng thuốc khác bị Ritonavir làm tăng độc tính không?).
3. **Có cần Giám sát nồng độ (TDM) không?** (Bệnh nhân có nguy cơ thất bại điều trị hoặc có xuất hiện tình trạng tăng Bilirubin máu khi dùng Atazanavir không?).
4. **Bệnh nhân có nguy cơ mang virus đột biến kháng PIs không?** (Nếu đã từng điều trị ARV, đã đếm số đột biến kháng thuốc và tính toán chỉ số gIQ để đảm bảo phác đồ vẫn còn hiệu lực chưa?).
5. **Theo dõi tác dụng phụ chuyển hóa?** _(Thông tin ngoài tài liệu: Đã kiểm tra mỡ máu và đường huyết định kỳ cho bệnh nhân dùng PIs dài ngày chưa?)._