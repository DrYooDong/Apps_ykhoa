...
- **Các hoạt chất đại diện:** *Ceftaroline* và *Ceftobiprole*,.
- **Đặc điểm hóa học:** 
	- Do cấu trúc cần tính ưa lipid ở vị trí C3 để có hoạt tính, các thuốc này được bào chế dưới dạng tiền thuốc (prodrug) nhằm tăng độ hòa tan trong nước (Ceftaroline fosamil và Ceftobiprole medocaril). 
	- Thuốc chỉ có đường tiêm/truyền tĩnh mạch (IV).
...
- **Vi khuẩn Gram-dương (+):** Tác dụng vượt trội so với các thế hệ trước.
    - Tuyệt vời đối với MRSA (MIC rất thấp từ 0.25 - 2 $\mu$g/mL), Tụ cầu vàng nhạy cảm methicillin (MSSA), Tụ cầu kháng trung gian Vancomycin (VISA),,.
    - Tác dụng cực mạnh trên Phế cầu (_S. pneumoniae_), bao gồm cả những chủng kháng Penicillin (PRSP) và kháng Macrolide,,.
    - Đặc biệt: Có hoạt tính trên Cầu khuẩn ruột _Enterococcus faecalis_ (các chủng còn nhạy cảm với ampicillin),. Thuốc **không** có hoạt tính trên _E. faecium_ / VRE.
- **Vi khuẩn Gram-âm (-):** Phổ tác dụng tương tự Cephalosporin thế hệ 3,.
    - Hoạt tính tốt trên _H. influenzae, M. catarrhalis_, và các vi khuẩn đường ruột (Enterobacterales) không sinh ESBL/AmpC.
    - **Khác biệt cốt lõi:** Ceftobiprole có hoạt tính trên _Pseudomonas aeruginosa_ (tương tự Ceftazidime), trong khi Ceftaroline thì **không**,.
- **Vi khuẩn kỵ khí & Không điển hình:** Kém tác dụng hoặc không có tác dụng lâm sàng đáng kể.
...
Tóm tắt 5 câu hỏi cốt lõi khi kê đơn Cephalosporin thế hệ 5:

1. **Đúng chẩn đoán & Chỉ định?** (Nhiễm trùng do MRSA, Phế cầu kháng thuốc, hoặc _E. faecalis_ nhạy Ampicillin? Thuốc là lựa chọn tuyệt vời thay thế Vancomycin).
