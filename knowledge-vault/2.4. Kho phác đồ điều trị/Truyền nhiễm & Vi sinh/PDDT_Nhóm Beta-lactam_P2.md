...
- **Cấu trúc hóa học:** Khác với các penicillins và cephalosporins có cấu trúc vòng đôi (bicyclic), Aztreonam là một $\beta$-lactam tổng hợp có cấu trúc lõi chỉ gồm một vòng đơn chứa 2-oxoazetidine-1-sulfonic acid.
    - Nhóm 1-sulfonic acid giúp kích hoạt vòng $\beta$-lactam.
    - Nhóm $4\alpha$-methyl cung cấp sự bền vững trước các enzyme $\beta$-lactamase.
    - Chuỗi bên aminothiazole oxime chịu trách nhiệm tạo ra phổ tác dụng chống lại vi khuẩn Gram-âm hiếu khí. Điểm đặc biệt là chuỗi bên này của Aztreonam có cấu trúc giống hệt với chuỗi bên của Ceftazidime và Cefiderocol.
...
- **Cơ chế đề kháng chính:**
    ...
    2. **Đột biến đích tác động (PBP3):** Việc vi khuẩn thay đổi cấu trúc PBP3 (ví dụ chèn thêm một chuỗi 4 acid amin như YRIN hoặc YRIK vào PBP3 ở _E. coli_) sẽ làm giảm khả năng gắn kết của Aztreonam, gây ra kháng thuốc.

### 3. Phổ kháng khuẩn (Spectrum of Activity)

- **Vi khuẩn Gram-âm (-):** Phổ tác dụng rất rộng trên hầu hết các trực khuẩn Gram-âm hiếu khí.
    - Tác dụng tốt trên các vi khuẩn họ ruột (Enterobacterales) nhạy cảm và không sinh ESBL/AmpC như: _E. coli_, _Klebsiella_ spp., _Proteus_, _Salmonella_, _Shigella_, _Serratia_.
    - Tác dụng tốt trên _Haemophilus influenzae_, _Moraxella catarrhalis_, _Neisseria gonorrhoeae_ và _Neisseria meningitidis_.
    - Phân điểm nhạy cảm (Breakpoint): $\le 4 \mu g/mL$ đối với Enterobacterales và $\le 8 \mu g/mL$ đối với _P. aeruginosa_.
    - Hầu hết các chủng _Acinetobacter baumannii_, _Stenotrophomonas maltophilia_ và _Burkholderia cepacia_ đều kháng lại Aztreonam.
- **Vi khuẩn Gram-dương (+) & Vi khuẩn kỵ khí:** Hoàn toàn **không có hoạt tính** trên bất kỳ vi khuẩn Gram-dương hay vi khuẩn kỵ khí nào.
...
- **Chỉ định & Điều trị kinh nghiệm:**
    - Do không bao phủ được vi khuẩn Gram-dương và kỵ khí, Aztreonam hiếm khi được sử dụng đơn độc trong điều trị kinh nghiệm. Thuốc thường được dùng phối hợp với các kháng sinh khác (để phủ Gram-dương/kỵ khí).
    - Đây là lựa chọn "cứu cánh" (drug of choice) để điều trị các nhiễm khuẩn Gram-âm cho những bệnh nhân có tiền sử dị ứng hoặc phản vệ nghiêm trọng với các $\beta$-lactam khác.
- **Chiến lược điều trị trúng đích đặc biệt (Niche in therapy):** Đặc tính độc nhất của Aztreonam là không bị thủy phân bởi Metallo-$\beta$-lactamase (MBLs). Hiện nay, nó được sử dụng theo chiến lược **phối hợp với Ceftazidime-avibactam** để điều trị các trường hợp nhiễm vi khuẩn đa kháng sinh MBLs (như NDM, VIM).
- **Liều dùng khuyến cáo:**
    - _Người lớn (chức năng thận bình thường):_ 2 g IV mỗi 8 giờ (nên cân nhắc truyền tĩnh mạch kéo dài trong 3 giờ đối với các nhiễm khuẩn nặng để tối ưu $f$T > MIC).
    - _Trẻ em (chức năng thận bình thường):_ 30 mg/kg IV mỗi 6 đến 8 giờ (tối đa 120 mg/kg/ngày); liều cao hơn có thể được sử dụng cho bệnh nhi bị xơ nang (cystic fibrosis).
...
Tóm tắt 5 câu hỏi cốt lõi khi kê đơn Aztreonam:

1. **Đúng chẩn đoán & Chỉ định?** (Bệnh nhân có nhiễm khuẩn Gram-âm và đồng thời có tiền sử dị ứng phản vệ nghiêm trọng với Penicillin/Cephalosporin nên cần dùng Aztreonam thay thế?).
2. **Đúng phổ?** (Aztreonam tuyệt đối KHÔNG có tác dụng trên Gram-dương và kỵ khí. Nếu dùng theo kinh nghiệm, đã phối hợp thêm thuốc phủ Gram-dương/kỵ khí chưa? Đã loại trừ _Acinetobacter baumannii_ chưa?).
3. **Có dị ứng chéo không?** (Bệnh nhân có tiền sử dị ứng với **Ceftazidime** hoặc **Cefiderocol** không? Nếu có, cân nhắc chống chỉ định vì thuốc có chung chuỗi bên).
4. **Đúng liều theo chức năng thận?** (Đã tính mức lọc cầu thận CrCl để hiệu chỉnh liều, hoặc đảm bảo thuốc được dùng sau khi bệnh nhân chạy thận xong chưa?).
5. **Chiến lược kháng thuốc?** (Có nghi ngờ nhiễm khuẩn tiết MBLs như NDM/VIM không? Nếu có, đã cân nhắc phác đồ phối hợp Aztreonam + Ceftazidime/avibactam chưa?).