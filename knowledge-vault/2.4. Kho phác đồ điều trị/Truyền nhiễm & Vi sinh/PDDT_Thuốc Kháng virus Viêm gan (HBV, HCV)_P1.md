---
title: "Thuốc Kháng virus Viêm gan (HBV, HCV)"
part: "P1"
aliases:
  - "Thuốc Kháng virus Viêm gan (HBV, HCV)"
keywords:
  - "thuốc kháng virus viêm gan (hbv, hcv)"
  - "tiêu hóa - gan mật"
...
- **Thuốc kháng virus Viêm [[Gan]] C (HCV):**
    ...
    - Các nhóm DAAs chính bao gồm:
        ...
        2. Chất ức chế NS5A (ví dụ: Ledipasvir, Ombitasvir).
        3. Chất ức chế polymerase NS5B dạng nucleoside/nucleotide (ví dụ: Sofosbuvir).
        4. Chất ức chế polymerase NS5B không phải nucleoside (ví dụ: Dasabuvir).
...
- **Sự dịch chuyển mô hình PK/PD của thuốc trị HCV (DAAs):**
...
- **Chiến lược phối hợp thuốc để chống kháng thuốc (Combination Therapy):**
    - HCV là một trong những ví dụ kinh điển nhất (cùng với HIV và Vi khuẩn Lao) bắt buộc phải sử dụng liệu pháp phối hợp. Việc dùng đơn trị liệu sẽ lập tức dẫn đến thảm họa đột biến kháng thuốc, biến một bệnh có thể chữa khỏi (curable) thành vô phương cứu chữa.
- **Di truyền học ký chủ (Pharmacogenomics) & Tiên lượng đáp ứng:**
    - **HCV:** Các đa hình di truyền (polymorphisms) nằm gần gen **IFNL3 (còn gọi là IL28B)** là yếu tố dự đoán cực kỳ mạnh mẽ cho khả năng cơ thể tự thanh thải HCV tự nhiên, cũng như tiên lượng sự thành công của phác đồ điều trị bằng Interferon-$\alpha$ và Ribavirin. Gen HLA-DQB1 cũng ảnh hưởng đến khả năng gắn kết và thanh thải HCV.
    - **HBV:** Tương tự, khả năng thanh thải HBV phụ thuộc nhiều vào yếu tố di truyền của bệnh nhân, bao gồm các biến thể tại vùng HLA lớp II (HLA-DP, HLA-DQ) và gen CFB (complement factor B).
- **Tương tác thuốc nghiêm trọng (DDIs) của DAAs:**
    - Các nhóm DAAs (tất cả các chất ức chế NS3/4A, NS5A và NS5B) đều có tương tác **đặc biệt nghiêm trọng** với nhóm thuốc điều trị Lao Rifamycins (Rifampin, Rifabutin, Rifapentine). Rifamycin là chất cảm ứng enzyme mạnh, làm giảm vọt nồng độ DAAs trong máu dẫn đến thất bại điều trị. Không được sử dụng chung các thuốc này.

### 4. Lưu ý thực hành / “take‑home messages”

1. **"HCV bắt buộc phải điều trị phối hợp":** Không bao giờ dùng một DAA đơn trị liệu do hàng rào bảo vệ di truyền của HCV thấp, nguy cơ kháng thuốc là rất cao và hậu quả là thảm họa.
...
_Tài liệu từ nguồn cung cấp:_

- Ge D, Fellay J, Thompson AJ, et al. Genetic variation in IL28B predicts hepatitis C treatment-induced viral clearance. _Nature_. 2009;461(7262):399–401.
- Thomas DL, Thio CL, Martin MP, et al. Genetic variation in IL28B and spontaneous clearance of hepatitis C virus. _Nature_. 2009;461(7265):798–801.
- German P, Mathias A, Brainard D, et al. Clinical pharmacokinetics and pharmacodynamics of ledipasvir/sofosbuvir, a fixed-dose combination tablet for the treatment of hepatitis C. _Clin Pharmacokinet_. 2016;55:1337–1351.
- Khatri A, Mensing S, Podsadecki T, et al. Exposure-efficacy analyses of ombitasvir, paritaprevir/ritonavir with dasabuvir +/- ribavirin in HCV genotype 1-infected patients. _Clin Drug Investig_. 2016;36:625–635.
- Lin C-W, Menon R, Liu W, et al. Exposure-safety response relationship for ombitasvir, paritaprevir/ritonavir, dasabuvir, and ribavirin in patients with chronic hepatitis C virus genotype 1 infection: analysis of data from five phase II and six phase III studies. _Clin Drug Investig_. 2017;37:647–657.
- Baciewicz AM, Chrisman CR, Finch CK, et al. Update on rifampin, rifabutin, and rifapentine drug interactions. _Curr Med Res Opin_. 2013;29:1–12.