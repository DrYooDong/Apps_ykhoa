...
### Đánh giá và Phân tầng Nguy cơ Thuyên tắc mạch: Sự Ra Đời của Thang điểm $CHA_2DS_2-VA$

Rung nhĩ là một yếu tố nguy cơ chính gây ra thuyên tắc mạch, bất kể thể lâm sàng là kịch phát, bền bỉ hay vĩnh viễn. Nếu không được điều trị, nguy cơ đột quỵ do rung nhĩ tăng gấp 5 lần. Do đó, việc sử dụng kháng đông đường uống (OAC) là tiếp cận mặc định cho mọi bệnh nhân, ngoại trừ những người có nguy cơ đột quỵ rất thấp.
...
- **Chỉ định điều trị dựa trên điểm số:**
    ...
    - Kháng đông đường uống **nên được cân nhắc** khi điểm **$CHA_2DS_2-VA = 1$** (Class IIa, Level C).
    - **Trường hợp đặc biệt:** Khuyến cáo dùng kháng đông đường uống cho **tất cả bệnh nhân rung nhĩ kèm bệnh cơ tim phì đại (HCM) hoặc bệnh thâm nhiễm tinh bột tim (cardiac amyloidosis)**, bất kể điểm số $CHA_2DS_2-VA$ (Class I, Level B).
...
- **Tránh giảm liều DOAC không [[Phù]] hợp:** Việc giảm liều DOAC tùy tiện không theo tiêu chuẩn được khuyến cáo tránh thực hiện do làm tăng nguy cơ đột quỵ mà không giảm được nguy cơ xuất huyết (Class III, Level B). Tiêu chuẩn giảm liều chuẩn được quy định nghiêm ngặt theo từng loại thuốc (Bảng 11):
    ...
    - _Rivaroxaban:_ 15 mg x 1 lần/ngày khi CrCl 15-49 mL/phút.
...
- **Quản lý xuất huyết khi đang dùng kháng đông (Hình 11):**
    ...
    - **Đảo ngược tác dụng kháng đông khi chảy máu đe dọa tính mạng hoặc ở vị trí trọng yếu:**
        - Đối với bệnh nhân dùng VKA: Cân nhắc sử dụng **phức hợp prothrombin cô đặc (PCC)** thay vì huyết tương tươi đông lạnh (FFP) do tác dụng phục hồi đông máu nhanh và ít biến chứng hơn (Class IIa, Level C).
        - Đối với bệnh nhân dùng DOAC: Cân nhắc sử dụng **chất đảo ngược đặc hiệu** (như Idarucizumab cho dabigatran, Andexanet alfa cho các thuốc ức chế yếu tố Xa) (Class IIa, Level B). Nếu không có sẵn chất đảo ngược đặc hiệu, có thể sử dụng PCC.

---

### Bít Tiểu Nhĩ Trái (LAAO) bằng Dụng cụ Qua da và Ngoại khoa

- **Bít tiểu nhĩ qua da (Percutaneous LAAO):** Có thể cân nhắc ở bệnh nhân rung nhĩ có chống chỉ định tuyệt đối kéo dài với kháng đông đường uống (Class IIb, Level C).
- **Bít tiểu nhĩ ngoại khoa (Surgical LAAO):**
    - Khuyến cáo thực hiện đóng tiểu nhĩ trái ngoại khoa như một biện pháp bổ trợ cho kháng đông ở bệnh nhân rung nhĩ đang trải qua phẫu thuật tim vì chỉ định khác (Class I, Level B).
    - Nên cân nhắc đóng tiểu nhĩ ngoại khoa bổ trợ ở bệnh nhân phẫu thuật nội soi hoặc hybrid triệt đốt rung nhĩ (Class IIa, Level C).
    - Có thể cân nhắc phẫu thuật đóng tiểu nhĩ nội soi đơn độc ở bệnh nhân có chống chỉ định với kháng đông dài hạn (Class IIb, Level C).
...
- **Bệnh động mạch vành/ngoại biên ổn định (CCS/PAD) sau 12 tháng:** Không khuyến cáo tiếp tục phối hợp thuốc kháng tiểu cầu với kháng đông đường uống đơn trị do không tăng hiệu quả bảo vệ nhưng làm tăng đáng kể nguy cơ xuất huyết nặng (Class III, Level B).

---

## 2. Trích Xuất Sơ Đồ, Lưu Đồ Cơ Chế và Hình Ảnh Minh Họa

### Hình 10: Giảm thiểu nguy cơ chảy máu liên quan đến Kháng đông đường uống (OAC)

- **Tên hình:** _Figure 10. Modifying the risk of bleeding associated with OAC_
...
### Hình 11: Quản lý xuất huyết liên quan đến kháng đông đường uống ở bệnh nhân Rung nhĩ
...
- **Nội dung mô tả dưới hình:** Sơ đồ phân loại xử trí xuất huyết dựa trên mức độ nghiêm trọng và loại thuốc kháng đông đang sử dụng (VKA hay DOAC):
    ...
    - _Nhánh VKA:_
        ...
        - _Chảy máu đe dọa tính mạng / vị trí trọng yếu:_ Bù dịch, truyền máu, sử dụng phức hợp prothrombin cô đặc (PCC) (Class IIa), dùng FFP nếu không có sẵn PCC.
    - _Nhánh DOAC:_
        - _Chảy máu nhẹ:_ Trì hoãn 1-2 liều DOAC.
        - _Chảy máu nặng không đe dọa tính mạng:_ Bù dịch, truyền máu, dùng than hoạt tính hoặc rửa dạ dày nếu mới uống DOAC trong vòng 2-4 giờ, cân nhắc dùng PCC.
        - _Chảy máu đe dọa tính mạng / vị trí trọng yếu:_ Bù dịch, truyền máu, sử dụng **chất đối kháng đặc hiệu** (antidotes) (Class IIa), dùng PCC nếu không có sẵn chất đối kháng đặc hiệu.
    - _Sau biến cố:_ Tiếp cận đa chuyên khoa, thảo luận lợi ích/nguy cơ để chủ động tái khởi động kháng đông sớm trừ khi có chống chỉ định tuyệt đối không thể giải quyết.

---

### Hình 14: Liệu pháp chống huyết khối ở bệnh nhân Rung nhĩ kèm Hội chứng mạch vành cấp hoặc mạn tính

- **Tên hình:** _Figure 14. Antithrombotic therapy in patients with AF and acute or chronic coronary syndromes_
- **Thuộc tài liệu:** _2024 ESC Guidelines for the management of atrial fibrillation developed in collaboration with the European Association for Cardio-Thoracic Surgery (EACTS)_
- **Nội dung mô tả dưới hình:** Sơ đồ hướng dẫn chi tiết việc phối hợp thuốc kháng tiểu cầu và kháng đông theo thời gian:
    1. _Nguyên tắc chung:_ Khuyến cáo dùng DOAC ưu tiên hơn VKA (Class I); sử dụng liều chuẩn đầy đủ của DOAC trừ khi có tiêu chuẩn giảm liều. Có thể cân nhắc liều giảm của rivaroxaban (15mg) hoặc dabigatran (110mg) nếu nguy cơ chảy máu vượt trội nguy cơ huyết khối (Class IIa).
    2. _Phân loại phác đồ theo bệnh cảnh lâm sàng:_
        - _ACS trải qua PCI:_ Phác đồ 3 thuốc (OAC + $P2Y_{12}$i + Aspirin) mặc định trong tối đa 1 tuần (Class I), sau đó chuyển sang phác đồ 2 thuốc (OAC + $P2Y_{12}$i) kéo dài đến 12 tháng (Class I), sau 12 tháng dùng OAC đơn trị (Class I). Nếu nguy cơ thiếu máu cục bộ rất cao, kéo dài phác đồ 3 thuốc đến 1 tháng (Class IIa).
        - _ACS điều trị nội khoa:_ Phác đồ 2 thuốc (OAC + $P2Y_{12}$i) từ thời điểm ban đầu đến 12 tháng (Class I), sau đó dùng OAC đơn trị.
        - _PCI chương (CCS):_ Phác đồ 3 thuốc trong 1 tuần (Class I), phác đồ 2 thuốc (OAC + $P2Y_{12}$i) từ tuần 1 đến 6 tháng (Class I), sau đó dùng OAC đơn trị.
        - _Bệnh mạch vành ổn định (CCS):_ Chỉ sử dụng OAC đơn trị (Class I).
