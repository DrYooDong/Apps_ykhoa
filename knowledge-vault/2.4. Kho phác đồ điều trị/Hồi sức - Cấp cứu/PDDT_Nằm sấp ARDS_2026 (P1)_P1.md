---
title: "Nằm sấp ARDS_2026 (P1)"
part: "P1"
aliases:
  - "Nằm sấp ARDS_2026 (P1)"
keywords:
  - "nằm sấp ards_2026 (p1)"
  - "tim mạch"
  - "hồi sức - cấp cứu"
...
- **Cải thiện oxy hóa máu:** Tư thế nằm sấp (PP) giúp cải thiện sự tương hợp giữa thông khí và tưới máu (\(V/Q\) matching). Khi nằm ngửa, các vùng phổi phía lưng (dorsal) chịu ảnh hưởng của trọng lực thường bị xẹp phổi (\(alveolar~collapse\)) dưới tác động của trọng lượng tim và các tạng trong ổ bụng. Việc chuyển sang nằm sấp làm tái phân bố lực trọng trường, giải phóng phổi khỏi sự chèn ép của tim và trung thất, từ đó thúc đẩy huy động phế nang (\(alveolar~recruitment\)) và giúp phổi thông khí đồng đều hơn.
...
#### Tiến Trình Lịch Sử và Thử Nghiệm Lâm Sàng Lớn
...
> - **2000:** Nghiên cứu ARMA công bố lợi ích của thông khí thể tích lưu thông thấp (Low VT trial).
> - **2001 - 2010:** Giai đoạn tiến hành 4 thử nghiệm ngẫu nhiên lớn về PP nhưng chưa tối ưu về thiết kế. Năm 2010 có thử nghiệm ACURASYS về thuốc giãn cơ (NMBA).
> - **2012:** Định nghĩa Berlin về ARDS ra đời.
> - **2013:** Công bố thử nghiệm **PROSEVA** mang lại bước ngoặt lớn cho chỉ định nằm sấp kéo dài (\(\ge 16\) giờ).
> - **2020 - 2022:** Đại dịch COVID-19 thúc đẩy việc áp dụng rộng rãi tư thế nằm sấp thức tỉnh (Awake Prone Position - APP) qua các thử nghiệm Meta-trial.
> - **Hiện tại (2023-2024):** Hướng dẫn mới đưa ra khuyến cáo mạnh mẽ (Strong recommendation) về việc sử dụng PP cho bệnh nhân ARDS mức độ trung bình-nặng.

---

#### Khuyến Cáo Thực Hành: Ai, Khi Nào và Như Thế Nào (Who, When, and How)

##### **Lựa chọn bệnh nhân (Who)**

- **Khuyến cáo mạnh mẽ:** Hội Y học Hồi sức Châu Âu (ESICM) và Hội Lồng ngực Mỹ (ATS) khuyến cáo mạnh mẽ áp dụng tư thế nằm sấp cho **bệnh nhân ARDS đặt nội khí quản mức độ trung bình đến nặng** (chỉ số \(PaO_2/FiO_2 < 150\) mmHg và \(PEEP \ge 5\) cmH2O).
- **Phối hợp thuốc:** Sử dụng đồng thời tư thế nằm sấp và an thần phối hợp thuốc giãn cơ (NMBA) sớm mang lại hiệu ứng cộng gộp bảo vệ phổi. Tuy nhiên, ESICM khuyến cáo chống lại việc truyền NMBA liên tục một cách thường quy, trong khi ATS đưa ra khuyến cáo có điều kiện đối với NMBA.

##### **Thời điểm khởi đầu (When)**

- **Can thiệp sớm:** Khuyến cáo bắt đầu nằm sấp **sớm sau khi đặt nội khí quản** và sau một giai đoạn ổn định ngắn (áp dụng thông khí thể tích lưu thông thấp và tối ưu hóa PEEP), nếu chỉ số \(PaO_2/FiO_2\) vẫn tiếp tục dưới \(150\) mmHg.

##### **Phương thức thực hiện và Theo dõi (How)**

- **Thời gian duy trì:** Mỗi phiên nằm sấp phải được duy trì **kéo dài liên tục từ 16 giờ trở lên** mỗi ngày để đạt được hiệu quả giảm tử vong.
...
> - **Thời gian duy trì (Duration):** Các phiên nằm sấp kéo dài liên tục từ 16 giờ trở lên mỗi ngày.
> - **Theo dõi (Monitoring):** Theo dõi sát huyết động liên tục (continuous hemodynamics), chỉ số oxy hóa máu (oxygenation) và các biến chứng da do đè ép (pressure-related skin complications).

---

##### **Biến cố bất lợi và Chống chỉ định**

- **Biến cố bất lợi thường gặp:** Tổn thương do đè ép/loét tì đè (\(pressure~injuries\)) là biến chứng phổ biến nhất và liên quan đến thời gian nằm sấp. Các biến chứng khác bao gồm phù mặt, rối loạn huyết động thoáng qua khi thay đổi tư thế, tuột ống nội khí quản ngoài ý muốn, tổn thương dây thần kinh ngoại biên chi trên và biến chứng ở mắt.
- **Chống chỉ định tuyệt đối:** **Tổn thương cột sống không ổn định** là chống chỉ định tuyệt đối duy nhất được đồng thuận rộng rãi.
- **Chống chỉ định tương đối:** Các yếu tố như béo phì, mới phẫu thuật ổ bụng hoặc đang đặt các loại ống dẫn lưu không nên là rào cản ngăn cản các kíp điều trị giàu kinh nghiệm thực hiện kỹ thuật này cho bệnh nhân.
- **Nguồn lực nhân sự:** Kỹ thuật đòi hỏi sự chuẩn bị kỹ lưỡng và phối hợp của kíp điều trị gồm **3 đến 5 nhân viên y tế được đào tạo bài bản** cho mỗi lần lật bệnh nhân.
...
🔄 Chúng ta có nên tiếp tục với **Phần 2: Tư thế nằm sấp thức tỉnh (Awake Prone Positioning) ở bệnh nhân chưa đặt nội khí quản** để hoàn thành toàn bộ bức tranh khuyến cáo mới 2026 này không?
