...
- **Giai đoạn 1:** SCr tăng 1.5 - 1.9 lần so với mức nền hoặc tăng $\ge$ 0.3 mg/dL; nước tiểu < 0.5 mL/kg/giờ trong 6-12 giờ.
- **Giai đoạn 2:** SCr tăng 2.0 - 2.9 lần; nước tiểu < 0.5 mL/kg/giờ trong $\ge$ 12 giờ.
- **Giai đoạn 3:** SCr tăng $\ge$ 3 lần mức nền hoặc SCr $\ge$ 4.0 mg/dL hoặc cần chạy thận nhân tạo; nước tiểu < 0.3 mL/kg/giờ trong $\ge$ 24 giờ hoặc vô niệu $\ge$ 12 giờ.
...
- **Phân biệt Trước thận và Hoại tử ống thận cấp (ATN):** Đây là bước biện luận then chốt.
...
- **Ngừng các tác nhân gây độc thận:** Ngừng ngay NSAIDs, kháng sinh gây độc (nếu có thể thay thế), thuốc cản quang. Điều chỉnh liều các thuốc đang dùng theo mức lọc cầu thận (GFR),.
- **Xử trí theo nguyên nhân (Etiology-specific):**
    - _Trước thận:_ Nếu do thiếu dịch, bù dịch tinh thể tích cực (Crystalloids như Normal Saline); nếu do suy tim (hội chứng tim-thận), tối ưu hóa cung lượng tim bằng lợi tiểu, thuốc giãn mạch hoặc thuốc tăng co bóp,.
    - _Sau thận:_ Đặt ống thông tiểu (Foley catheter) ngay lập tức để giải áp bàng quang. Có thể cần hội chẩn niệu khoa để đặt stent niệu quản hoặc mở thận ra da nếu tắc nghẽn ở vị trí cao,,.
    - _Tại thận (ATN):_ Điều trị hỗ trợ, duy trì huyết áp trung bình (MAP) $\ge$ 65 mmHg (có thể cần cao hơn ở người già) để đảm bảo áp lực tưới máu thận,. Không có bằng chứng cho thấy dùng lợi tiểu quai (như furosemide) hay dopamine liều thấp giúp cải thiện chức năng thận hoặc giảm tỷ lệ tử vong trong ATN,.
- **Chỉ định điều trị thay thế thận (RRT/Dialysis):** Khi có các chỉ định cấp cứu (AEIOU) như đã nêu ở Bước 1, bao gồm: tăng kali máu nặng, toan chuyển hóa kháng trị, quá tải thể tích không đáp ứng lợi tiểu, hoặc hội chứng ure huyết cao,,,.
...
- "Bước đầu tiên và quan trọng nhất khi tiếp cận AKI là luôn phải loại trừ nguyên nhân tắc nghẽn sau thận bằng siêu âm hoặc đo thể tích nước tiểu tồn dư, vì đây là nguyên nhân có thể dễ dàng đảo ngược bằng cách giải áp đơn giản",.
- "Các chỉ số nước tiểu (FENa, FEurea) và việc tự tay soi cặn lắng nước tiểu (tìm trụ hạt bùn nâu hoặc trụ tế bào) là những công cụ vô giá giúp bác sĩ phân biệt giữa tổn thương trước thận và hoại tử ống thận cấp (ATN)".
- "Tụt huyết áp và giảm thể tích tuần hoàn kéo dài sẽ khiến một AKI trước thận chuyển tiến thành hoại tử ống thận cấp (ATN); do đó, tối ưu hóa huyết động sớm là chìa khóa để ngăn ngừa tổn thương thận không thể đảo ngược",.
- "Rà soát kỹ lưỡng danh sách thuốc của bệnh nhân là một phản xạ bắt buộc: NSAIDs, ACEI/ARB, kháng sinh và thuốc cản quang là những thủ phạm cực kỳ phổ biến gây ra hoặc làm trầm trọng thêm AKI",,.

**5. Tài liệu tham khảo**

1. _Critical Care Medicine An Algorithmic Approach_. 2023.
...
3. Altkorn D, et al. _Symptoms to Diagnosis: An Evidence-Based Guide_. 4th ed. McGraw-Hill Education; 2020.
