...
- **Tri giác sai bản chất/ý nghĩa của vật (delusions)**.
- **Mê sảng (delirium):** Tình trạng tri giác bị kích thích bao gồm mất định hướng, kích thích, sợ hãi, rối loạn cảm nhận (ví dụ ngộ độc atropin do điều trị quá liều ngộ độc phospho hữu cơ).

##### 2. Rối Loạn Tri Giác Dạng Ức Chế

Là dạng thường gặp hơn ở trẻ em.

- **Ngủ gà:** Rối loạn tri giác nhẹ, trẻ giảm hứng thú với môi trường, phản ứng chậm chạp, luôn buồn ngủ và thường nằm ngủ nếu không lay thức.
- **Lơ mơ:** Trẻ đáp ứng ít hoặc không đáp ứng với kích thích từ môi trường trừ khi được kích thích mạnh và lặp lại.
- **Hôn mê:** Rối loạn tri giác nặng, trẻ không đáp ứng với các kích thích đau, do rối loạn chức năng hệ lưới hoặc tổn thương cả hai bán cầu não.

---

#### Đánh Giá Và Phân Độ Tri Giác

##### 1. Thang Điểm AVPU

Thang điểm AVPU được sử dụng để đánh giá nhanh chức năng của vỏ nổi:
...
##### 2. Thang Điểm Hôn Mê Glasgow (GCS)

Thang điểm Glasgow giúp đánh giá khách quan và theo dõi diễn tiến thần kinh của trẻ. Trẻ $\le 2$ tuổi sử dụng bảng điểm GCS hiệu chỉnh dành cho nhũ nhi.

> **Bảng Thông Tin:** **Tên bảng:** Bảng 86.2. Bảng điểm hôn mê Glasgow **Thuộc tài liệu:** [Book] Nhi khoa YDS - Tập 2 (2020) - HSCC.pdf **Nội dung mô tả:** Đánh giá tổng điểm dựa trên 3 nhóm đáp ứng ($3 - 15\text{ điểm}$):
> 
> - **Mở mắt (E: $1 - 4\text{ điểm}$):** Tự nhiên (4), Với lời nói (3), Với kích thích đau (2), Không mở mắt (1).
> - **Đáp ứng lời nói (V: $1 - 5\text{ điểm}$):**
>     - _Trẻ $> 2$ tuổi:_ Định hướng tốt (5), Lú lẫn (4), Từ không thích hợp (3), Âm thanh vô nghĩa (2), Không đáp ứng (1).
>     - _Nhũ nhi ($\le 2$ tuổi):_ Bập bẹ (5), Khóc dỗ nín được (4), Khóc không dỗ được (3), Âm thanh vô nghĩa/rên rỉ (2), Không đáp ứng (1).
> - **Đáp ứng vận động (M: $1 - 6\text{ điểm}$):**
>     - _Trẻ $> 2$ tuổi:_ Thực hiện theo y lệnh (6), Định vị đau đúng (5), Đáp ứng đau không chính xác (4), Gồng mất vỏ (3), Gồng mất não (2), Không đáp ứng (1).
>     - _Nhũ nhi ($\le 2$ tuổi):_ Vận động có chủ đích/Cử động tự nhiên (6), Rút chi khi sờ/Định vị đau (5), Rụt người/Đáp ứng đau không chính xác (4), Gồng mất vỏ (3), Gồng mất não (2), Không đáp ứng (1).
> - **Phân độ:** $GCS \le 8$ điểm: rối loạn tri giác nặng (hôn mê); $GCS\ 9 - 12$ điểm: rối loạn trung bình; $GCS\ 13 - 15$ điểm: rối loạn nhẹ.
...
#### Cơ Chế Bệnh Sinh & Áp Lực Nội Sọ

##### 1. Áp Lực Tưới Máu Não (CPP)

Áp lực tưới máu nổi ($CPP$) được tính bằng công thức: $CPP = MAP - ICP$ (với $MAP$ là huyết áp trung bình và $ICP$ là áp lực nội sọ).

Các yếu tố ảnh hưởng trực tiếp đến lưu lượng máu tưới não ($CBF$):

- ** $PaO_2$ động mạch:** Khi $PaO_2 < 50\text{ mmHg}$ sẽ gây giãn mạch não để đảm bảo cung cấp oxy cho não.
- ** $PaCO_2$ động mạch:** Tăng $PaCO_2$ làm giãn mạch não làm tăng dòng máu tưới nổi; giảm $PaCO_2$ làm co mạch nổi làm giảm dòng máu tưới não. Do đó, **tăng thông khí** được ứng dụng làm điều trị cấp cứu cho bệnh nhân dọa tụt não.
...
- **Giá trị ICP bình thường:** Ở trẻ sơ sinh khoảng $6\text{ mmHg}$ ($82\text{ mmH}_2\text{O}$); ở trẻ $1 - 7$ tuổi khoảng $9 - 21\text{ mmHg}$ ($12 - 28\text{ cmH}_2\text{O}$). $ICP > 20\text{ mmHg}$ ($27\text{ cmH}_2\text{O}$) kéo dài trên 5 phút được coi là bất thường và cần điều trị.

---

#### Quy Trình Tiếp Cận Ban Đầu (ABCDE) Và Điều Trị Tăng Áp Lực Nội Sọ
...
#### Tiếp Cận Đánh Giá Thứ Cấp Và Định Hướng Nguyên Nhân
...
1. Lê Phước Truyền. Bài 86: Tiếp cận trẻ rối loạn tri giác. Trong: _Nhi khoa YDS - Tập 2 (Hồi sức cấp cứu)_. Bộ môn Nhi - Đại học Y Dược Thành phố Hồ Chí Minh; 2020:452-468.
2. Lê Phước Truyền, Nguyễn Huy Luân. Bài 98: Khám và phân loại trẻ bệnh. Trong: _Nhi khoa YDS - Tập 4 (Hồi sức cấp cứu)_. Bộ môn Nhi - Đại học Y Dược Thành phố Hồ Chí Minh; 2020:718-731.
