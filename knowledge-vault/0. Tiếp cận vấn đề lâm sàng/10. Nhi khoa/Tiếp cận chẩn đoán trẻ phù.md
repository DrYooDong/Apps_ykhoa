...
Ở trẻ bình thường, hiện tượng phù không xuất hiện nhờ sự cân bằng chặt chẽ của các lực huyết động giữa lòng mạch máu và mô kẽ, cùng với chức năng bảo tồn của hệ thống mạch bạch huyết.

- **Áp lực thủy tĩnh mao mạch**: Có xu hướng đẩy và kéo dịch từ lòng mạch xuyên qua thành mạch vào trong mô kẽ.
- **Áp lực keo mao mạch**: Được tạo ra chủ yếu bởi các protein huyết tương (đặc biệt là albumin), có xu hướng giữ nước ở lại trong lòng mạch.
- **Hệ bạch huyết**: Dẫn lưu lượng dịch mô kẽ dư thừa trở về hệ thống tuần hoàn tĩnh mạch, ngăn ngừa sự tích tụ dịch.

Sự mất cân bằng giữa các lực đối kháng này hoặc sự cản trở dòng bạch huyết sẽ dẫn đến sự hình thành phù qua **4 cơ chế sinh lý bệnh chính**:
...
- **Bệnh ruột mất đạm**: Mất nghiêm trọng protein qua đường ruột (viêm ruột phì đại Ménétrier, dị ứng đạm sữa, bệnh celiac, bệnh viêm ruột), gây giảm albumin máu.
- **Tăng tính thấm thành mạch**: Các yếu tố nội tại (cytokine TNF, IL, histamine, bradykinin, prostaglandin, bổ thể) làm tăng tính thấm mao mạch, làm thoát dịch và protein từ lòng mạch vào mô kẽ. Thường gặp trong bỏng, nhiễm trùng, phản ứng dị ứng khu trú hoặc toàn thân (phù mạch).
- **Hội chứng thận hư**: Mất lượng lớn albumin qua nước tiểu (tiểu đạm ngưỡng thận hư), làm giảm áp lực keo huyết tương nặng nề, gây thoát dịch từ lòng mạch vào mô kẽ.

##### 4. Rối Loạn Chức Năng Hoặc Tắc Nghẽn Bạch Huyết

Dẫn đến phù khu trú (phù bạch huyết) do lượng dịch mô kẽ giàu đạm tích tụ vượt quá khả năng vận chuyển của hệ bạch huyết.

---

#### Khám Lâm Sàng Và Đánh Giá Trẻ Bị Phù

##### 1. Bệnh Sử Và Tiền Căn

- **Vị trí phù và thời gian xuất hiện**: Giúp phân biệt bệnh lý bẩm sinh hay mắc phải.
- **Các triệu chứng định hướng bệnh lý cơ quan**:
    - _Khó thở, vã mồ hôi khi gắng sức_: Gợi ý suy tim và/hoặc phù phổi.
    - _Vàng da, chậm tăng cân, tiêu máu, đau bụng_: Hướng đến bệnh gan mạn hoặc bệnh ruột mất đạm.
    - _Phù toàn thân tiến triển bắt đầu từ mi mắt_: Gợi ý hội chứng thận hư.
    - _Nước tiểu màu xá xị, tăng huyết áp_: Gợi ý viêm cầu thận cấp.
    - _Phù, chán ăn, chậm tăng trưởng_: Gợi ý suy thận mạn.
    - _Tiền sử gia đình có phù mạch tái phát_: Gợi ý phù mạch di truyền.
    - _Phù bàn tay và bàn chân ở trẻ gái sơ sinh_: Gợi ý hội chứng Turner.

##### 2. Thăm Khám Thực Thể

- **Đánh giá chỉ số tăng trưởng và sinh hiệu**: Đo cân nặng, chiều cao, huyết áp, nhịp tim, nhịp thở.
- **Đánh giá tính chất phù**:
    - _Phù ấn lõm_: Do sự dịch chuyển của nước mô kẽ dưới áp lực ấn, thường tập trung ở vùng thấp (chi dưới ở trẻ đi lại được, vùng xương cùng ở trẻ nằm tại chỗ).
...
#### Cận Lâm Sàng Tiếp Cận Trẻ Bị Phù
...
- **Công thức máu toàn bộ**: Đánh giá thiếu máu, nhiễm trùng hoặc đa hồng cầu.
- **Sinh hóa máu**: Định lượng Creatinin, BUN (chức năng thận), đạm toàn phần, Albumin máu, men gan, thời gian Prothrombin.

##### 3. Xét Nghiệm Chuyên Sâu Theo Định Hướng Lâm Sàng

- **Bệnh lý thận**: Định lượng bổ thể $C_3, C_4$, ASO (kháng thể kháng liên cầu), ANA, anti-dsDNA, ANCA, tầm soát virus (HBV, HCV, HIV).
- **Bệnh gan mạn hoặc bệnh ruột mất đạm**: Ở trẻ giảm albumin máu nhưng không tiểu đạm, cần đo $Alpha-1\text{ antitrypsin}$ trong phân (xét nghiệm tầm soát tốt nhất cho bệnh ruột mất đạm).
- **Huyết khối tĩnh mạch**: Bilan đông máu, định lượng Antithrombin III, Protein C, Protein S, Yếu tố V Leiden, kháng thể antiphospholipid.
- **Phù mạch**: Định lượng các thành phần bổ thể $C_1q, C_4, C_2$ và chất ức chế $C_1\text{ esterase}$ ($C_1\text{ INH}$).
...
#### Nguyên Tắc Điều Trị Hỗ Trợ Tổng Quát
...
1. Lê Phạm Thu Hà, Vũ Huy Trụ. Bài 46: Tiếp cận chẩn đoán trẻ phù. Trong: _Nhi khoa YDS - Tập 1_. Bộ môn Nhi - Đại học Y Dược Thành phố Hồ Chí Minh; 2020:606-613.