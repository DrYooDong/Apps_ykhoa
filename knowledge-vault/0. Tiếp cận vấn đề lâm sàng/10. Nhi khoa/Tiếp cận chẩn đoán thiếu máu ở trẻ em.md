...
Thiếu máu là tình trạng giảm khối lượng huyết sắc tố (hemoglobin - Hb) dưới bách phân vị thứ 5 (5th percentile) theo tuổi, hoặc dưới 2 độ lệch chuẩn (SD) so với giá trị bình thường của trẻ khỏe mạnh. Theo thống kê của Viện Dinh dưỡng Quốc gia giai đoạn 2014–2015, tỷ lệ thiếu máu ở trẻ em dưới 5 tuổi tại Việt Nam là 27,8% (trong đó tỷ lệ này cao nhất ở nhóm trẻ dưới 12 tháng tuổi với 45% và từ 12–23 tháng tuổi với 42,7%).

---

#### Hỏi Bệnh Sử Và Tiền Căn Trẻ Thiếu Máu
...
> - _Thuốc & Tiền căn gia đình:_ Tác nhân oxy hóa $\rightarrow$ Thiếu G6PD; Penytoin $\rightarrow$ Tăng nhu cầu Folate; Tiền căn di truyền lặn/trội NST $\rightarrow$ Hồng cầu hình cầu, Thalassemia, Fanconi, sỏi mật/cắt lách.

---

#### Thăm Khám Lâm Sàng Trẻ Thiếu Máu

Khi tiếp cận trẻ xanh xao, bác sĩ cần đánh giá sinh hiệu để phân loại tình trạng cấp tính nặng hay không cấp tính.
...
#### Các Xét Nghiệm Cận Lâm Sàng Đánh Giá Và Phân Loại Thiếu Máu

##### 1. Xét Nghiệm Cơ Bản

- **Tổng phân tích tế bào máu (TPTTBM):**
    - _Nồng độ Hb:_ Chẩn đoán thiếu máu. $Hb > 9\text{ g/dL}$ là thiếu máu nhẹ; $Hb < 8 - 9\text{ g/dL}$ biểu hiện thiếu máu rõ rệt trên lâm sàng.
    - _Chỉ số MCV:_ Phân loại thiếu máu hồng cầu nhỏ, to hay bình thường theo tuổi.
    - _Chỉ số RDW (độ phân bố kích thước hồng cầu):_ Bình thường $11,5 - 14,5$%. RDW tăng thể hiện hồng cầu không đều kích thước (gặp trong thiếu máu thiếu sắt, tán huyết). RDW tăng trong khi MCV bình thường gợi ý sự kết hợp giữa 2 quần thể hồng cầu to và nhỏ (thiếu sắt kết hợp thiếu $B_{12}$/folate).
- **Số lượng hồng cầu lưới (HCL):** Thể hiện khả năng đáp ứng của tủy xương. Khi thiếu máu, HCL cần được hiệu chỉnh theo nồng độ Hb: $\text{HCL hiệu chỉnh (%)} = \frac{\text{HCL đếm (%)} \times \text{Hb bệnh nhân}}{\text{Hb bình thường theo tuổi}}$ Nếu HCL hiệu chỉnh $> 2$% (hoặc HCL tuyệt đối $> 100 \times 10^9/\text{L}$ [$100\text{ K/}\mu\text{L}$]) chứng tỏ tủy xương tăng sinh phản ứng tốt (gặp trong tán huyết hoặc mất máu cấp).
- **Phết máu ngoại biên:** Quan sát hình dạng, kích thước, màu sắc hồng cầu và tìm các tế bào bất thường.

> **Bảng thông tin:** **Tên bảng:** Bảng 38.4. MCV bình thường theo tuổi **Thuộc tài liệu:** [Book] Nhi khoa YDS - Tập 1 (2020).pdf **Nội dung mô tả:** Bảng chỉ số MCV trung bình và ngưỡng dưới theo từng nhóm tuổi ở trẻ em:
> 
> - _6 tháng – 2 tuổi:_ Trung bình $77\text{ fL}$, ngưỡng dưới $70\text{ fL}$.
> - _2 – 4 tuổi:_ Trung bình $79\text{ fL}$, ngưỡng dưới $73\text{ fL}$.
> - _5 – 7 tuổi:_ Trung bình $81\text{ fL}$, ngưỡng dưới $75\text{ fL}$.
> - _8 – 11 tuổi:_ Trung bình $83\text{ fL}$, ngưỡng dưới $76\text{ fL}$.
> - _12 – 14 tuổi:_ Nữ ($85 / 78\text{ fL}$), Nam ($84 / 77\text{ fL}$).
> - _15 – 17 tuổi:_ Nữ ($87 / 79\text{ fL}$), Nam ($86 / 78\text{ fL}$).

##### 2. Xét Nghiệm Bổ Sung Và Chuyên Sâu

- **Bilan sắt:** Ferritin giảm ($< 12\text{ ng/mL}$ ở trẻ $< 5$ tuổi; $< 15\text{ ng/mL}$ ở trẻ $\ge 5$ tuổi), Sắt huyết thanh giảm ($< 100\ \mu\text{g}%$), Transferrin tăng ($> 350\ \mu\text{g/100 mL}$).
- **Điện di Hemoglobin:** Tìm Hb bất thường ($HbS, HbE...$) hoặc thay đổi tỷ lệ $HbF, HbA_2$ (chẩn đoán Thalassemia).
- **Các xét nghiệm khác:** Định lượng Vitamin $B_{12}$, acid folic, men G6PD, Coombs test (trực tiếp/gián tiếp), Haptoglobin, Hemosiderin nước tiểu, tủy đồ và sinh thiết tủy.

> **Sơ đồ cơ chế / Lưu đồ:** **Tên sơ đồ:** Lưu đồ 38.2. Lưu đồ phân loại thiếu máu ở trẻ em **Thuộc tài liệu:** [Book] Nhi khoa YDS - Tập 1 (2020).pdf **Nội dung mô tả:** Thuật toán phân loại thiếu máu dựa trên MCV và Số lượng Hồng cầu lưới (HCL):
> 
> 1. **Giảm MCV (Hồng cầu nhỏ):**
>     - Ferritin giảm $\rightarrow$ Thiếu máu thiếu sắt.
...
#### Nguyên Nhân Thiếu Máu Thường Gặp Và Chăm Sóc Ban Đầu (Theo TCYTTG)

##### 1. Nguyên Nhân Thiếu Máu Thường Gặp

- **Do giảm sản xuất hồng cầu:** Thiếu vi chất (sắt, $B_{12}$, folate), suy dinh dưỡng, nhiễm siêu vi (HIV), bệnh mạn tính, ngộ độc chì, suy thận mạn, bệnh lý ác tính xâm lấn tủy.
- **Do huyết tán:** Sốt rét, bệnh lý Hemoglobin (Thalassemia, hồng cầu liềm), thiếu men G6PD, bất đồng nhóm máu ABO/Rh sơ sinh, tán huyết tự miễn.
- **Do mất máu:** Nhiễm giun móc, chấn thương cấp, phẫu thuật, lấy máu xét nghiệm nhiều lần.

##### 2. Chăm Sóc Sức Khỏe Ban Đầu

- **Tầm soát:** Nhân viên y tế cần chủ động kiểm tra dấu hiệu lòng bàn tay nhợt và đánh giá chế độ ăn ở tất cả trẻ dưới 5 tuổi khi đến khám.
- **Xử trí tuyến cơ sở (khi trẻ có lòng bàn tay nhợt / thiếu máu trung bình):**
    - Bổ sung viên sắt/siro sắt uống liều $3\text{ mg/kg/ngày}$ sắt nguyên tố trong 2–4 tuần.
    - Cho uống thuốc xổ giun nếu trẻ $\ge 12$ tháng chưa xổ giun trong 6 tháng qua.
    - Hướng dẫn chế độ ăn dặm cân đối, giàu sắt và vitamin C.
    - Tái khám sau 2–4 tuần: nếu Hb hoặc lâm sàng cải thiện $\rightarrow$ xác định thiếu máu thiếu sắt và tiếp tục duy trì bù sắt củng cố dự trữ.
    - Nếu thiếu máu nặng $\rightarrow$ chuyển viện gấp.
- **Phòng ngừa cho mẹ:** Bổ sung sắt và acid folic cho thai phụ trong thai kỳ.

---

### 2. Trích Dẫn Tài Liệu Tham Khảo Chuẩn AMA

1. Đào Thị Thanh An, Lâm Thị Mỹ. Bài 38: Tiếp cận chẩn đoán thiếu máu ở trẻ em. Trong: _Nhi khoa YDS - Tập 1_. Bộ môn Nhi - Đại học Y Dược Thành phố Hồ Chí Minh; 2020:478-488.