---
title: "Dược thư: Bisoprolol (Concor)"
aliases: ["Bisoprolol (Concor)", "bisoprolol", "Thuốc chẹn beta-1 chọn lọc giao cảm", "C07AB07"]
keywords: ["Bisoprolol (Concor)", "Thuốc chẹn beta-1 chọn lọc giao cảm", "chỉnh liều", "tương tác thuốc", "chống chỉ định"]
icd10: ["Z51.81"]
specialty: "Tim mạch"
tags: ["CliniPortal", "Pharmacology", "KhoDuocThu", "Tim mạch"]
type: "drug"
---

# Dược Thư Lâm Sàng: Bisoprolol (Concor)

> [!NOTE]
> **Nhóm dược lý:** Thuốc chẹn beta-1 chọn lọc giao cảm | **Mã ATC:** C07AB07 | **Chuyên khoa:** Tim mạch

## 1. Cơ Chế Tác Dụng & Dược Lực Học
Bisoprolol (Concor) là hoạt chất thuộc nhóm **Thuốc chẹn beta-1 chọn lọc giao cảm**, tác động chọn lọc trên các thụ thể đích nhằm đạt hiệu quả điều trị tối ưu trong các bệnh lý tim mạch, chuyển hóa, hồi sức hoặc nhiễm khuẩn.
