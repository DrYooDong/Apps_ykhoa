---
title: "Dược thư: Enoxaparin (Lovenox)"
aliases: ["Enoxaparin (Lovenox)", "enoxaparin", "Kháng đông Heparin trọng lượng phân tử thấp (LMWH)", "B01AB05"]
keywords: ["Enoxaparin (Lovenox)", "Kháng đông Heparin trọng lượng phân tử thấp (LMWH)", "chỉnh liều", "tương tác thuốc", "chống chỉ định"]
icd10: ["Z51.81"]
specialty: "Tim mạch & Cấp cứu"
tags: ["CliniPortal", "Pharmacology", "KhoDuocThu", "Tim mạch & Cấp cứu"]
type: "drug"
---

# Dược Thư Lâm Sàng: Enoxaparin (Lovenox)

> [!NOTE]
> **Nhóm dược lý:** Kháng đông Heparin trọng lượng phân tử thấp (LMWH) | **Mã ATC:** B01AB05 | **Chuyên khoa:** Tim mạch & Cấp cứu

## 1. Cơ Chế Tác Dụng & Dược Lực Học
Enoxaparin (Lovenox) là hoạt chất thuộc nhóm **Kháng đông Heparin trọng lượng phân tử thấp (LMWH)**, tác động chọn lọc trên các thụ thể đích nhằm đạt hiệu quả điều trị tối ưu trong các bệnh lý tim mạch, chuyển hóa, hồi sức hoặc nhiễm khuẩn.
