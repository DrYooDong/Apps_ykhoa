---
title: "Dược thư: Apixaban (Eliquis)"
aliases: ["Apixaban (Eliquis)", "apixaban", "Kháng đông đường uống trực tiếp (DOAC/NOAC)", "B01AF02"]
keywords: ["Apixaban (Eliquis)", "Kháng đông đường uống trực tiếp (DOAC/NOAC)", "chỉnh liều", "tương tác thuốc", "chống chỉ định"]
icd10: ["Z51.81"]
...
# Dược Thư Lâm Sàng: Apixaban (Eliquis)

> [!NOTE]
> **Nhóm dược lý:** Kháng đông đường uống trực tiếp (DOAC/NOAC) | **Mã ATC:** B01AF02 | **Chuyên khoa:** Tim mạch & Thần kinh

## 1. Cơ Chế Tác Dụng & Dược Lực Học
Apixaban (Eliquis) là hoạt chất thuộc nhóm **Kháng đông đường uống trực tiếp (DOAC/NOAC)**, tác động chọn lọc trên các thụ thể đích nhằm đạt hiệu quả điều trị tối ưu trong các bệnh lý tim mạch, chuyển hóa, hồi sức hoặc nhiễm khuẩn.
