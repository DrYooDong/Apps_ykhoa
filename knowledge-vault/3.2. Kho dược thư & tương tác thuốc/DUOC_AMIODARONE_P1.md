---
title: "Dược thư: Amiodarone (Cordarone)"
aliases: ["Amiodarone (Cordarone)", "amiodarone", "Thuốc chống loạn nhịp tim Nhóm III", "C01BD01"]
keywords: ["Amiodarone (Cordarone)", "Thuốc chống loạn nhịp tim Nhóm III", "chỉnh liều", "tương tác thuốc", "chống chỉ định"]
icd10: ["Z51.81"]
...
# Dược Thư Lâm Sàng: Amiodarone (Cordarone)

> [!NOTE]
> **Nhóm dược lý:** Thuốc chống loạn nhịp tim Nhóm III | **Mã ATC:** C01BD01 | **Chuyên khoa:** Tim mạch & Cấp cứu

## 1. Cơ Chế Tác Dụng & Dược Lực Học
Amiodarone (Cordarone) là hoạt chất thuộc nhóm **Thuốc chống loạn nhịp tim Nhóm III**, tác động chọn lọc trên các thụ thể đích nhằm đạt hiệu quả điều trị tối ưu trong các bệnh lý tim mạch, chuyển hóa, hồi sức hoặc nhiễm khuẩn.
