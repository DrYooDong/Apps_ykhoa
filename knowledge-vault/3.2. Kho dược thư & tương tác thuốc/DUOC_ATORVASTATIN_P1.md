---
title: "Dược thư: Atorvastatin (Lipitor)"
aliases: ["Atorvastatin (Lipitor)", "atorvastatin", "Thuốc hạ lipid máu nhóm Statin", "C10AA05"]
keywords: ["Atorvastatin (Lipitor)", "Thuốc hạ lipid máu nhóm Statin", "chỉnh liều", "tương tác thuốc", "chống chỉ định"]
icd10: ["Z51.81"]
specialty: "Tim mạch & Nội tiết"
tags: ["CliniPortal", "Pharmacology", "KhoDuocThu", "Tim mạch & Nội tiết"]
type: "drug"
---

# Dược Thư Lâm Sàng: Atorvastatin (Lipitor)

> [!NOTE]
> **Nhóm dược lý:** Thuốc hạ lipid máu nhóm Statin | **Mã ATC:** C10AA05 | **Chuyên khoa:** Tim mạch & Nội tiết

## 1. Cơ Chế Tác Dụng & Dược Lực Học
Atorvastatin (Lipitor) là hoạt chất thuộc nhóm **Thuốc hạ lipid máu nhóm Statin**, tác động chọn lọc trên các thụ thể đích nhằm đạt hiệu quả điều trị tối ưu trong các bệnh lý tim mạch, chuyển hóa, hồi sức hoặc nhiễm khuẩn.
