---
title: "Dược thư: Spironolactone (Aldactone)"
aliases: ["Spironolactone (Aldactone)", "spironolactone", "Kháng thụ thể Mineralocorticoid (MRA)", "C03DA01"]
keywords: ["Spironolactone (Aldactone)", "Kháng thụ thể Mineralocorticoid (MRA)", "chỉnh liều", "tương tác thuốc", "chống chỉ định"]
icd10: ["Z51.81"]
specialty: "Tim mạch & Gan mật"
tags: ["CliniPortal", "Pharmacology", "KhoDuocThu", "Tim mạch & Gan mật"]
type: "drug"
---

# Dược Thư Lâm Sàng: Spironolactone (Aldactone)

> [!NOTE]
> **Nhóm dược lý:** Kháng thụ thể Mineralocorticoid (MRA) | **Mã ATC:** C03DA01 | **Chuyên khoa:** Tim mạch & Gan mật

## 1. Cơ Chế Tác Dụng & Dược Lực Học
Spironolactone (Aldactone) là hoạt chất thuộc nhóm **Kháng thụ thể Mineralocorticoid (MRA)**, tác động chọn lọc trên các thụ thể đích nhằm đạt hiệu quả điều trị tối ưu trong các bệnh lý tim mạch, chuyển hóa, hồi sức hoặc nhiễm khuẩn.
