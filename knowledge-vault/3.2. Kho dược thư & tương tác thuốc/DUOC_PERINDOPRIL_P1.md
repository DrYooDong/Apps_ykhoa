---
title: "Dược thư: Perindopril (Coversyl)"
aliases: ["Perindopril (Coversyl)", "perindopril", "Thuốc ức chế men chuyển (ACEi)", "C09AA04"]
keywords: ["Perindopril (Coversyl)", "Thuốc ức chế men chuyển (ACEi)", "chỉnh liều", "tương tác thuốc", "chống chỉ định"]
icd10: ["Z51.81"]
specialty: "Tim mạch & Thận"
tags: ["CliniPortal", "Pharmacology", "KhoDuocThu", "Tim mạch & Thận"]
type: "drug"
---

# Dược Thư Lâm Sàng: Perindopril (Coversyl)

> [!NOTE]
> **Nhóm dược lý:** Thuốc ức chế men chuyển (ACEi) | **Mã ATC:** C09AA04 | **Chuyên khoa:** Tim mạch & Thận

## 1. Cơ Chế Tác Dụng & Dược Lực Học
Perindopril (Coversyl) là hoạt chất thuộc nhóm **Thuốc ức chế men chuyển (ACEi)**, tác động chọn lọc trên các thụ thể đích nhằm đạt hiệu quả điều trị tối ưu trong các bệnh lý tim mạch, chuyển hóa, hồi sức hoặc nhiễm khuẩn.
