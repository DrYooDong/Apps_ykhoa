---
title: "Dược thư: Rivaroxaban (Xarelto)"
aliases: ["Rivaroxaban (Xarelto)", "rivaroxaban", "Kháng đông đường uống trực tiếp (DOAC/NOAC)", "B01AF01"]
keywords: ["Rivaroxaban (Xarelto)", "Kháng đông đường uống trực tiếp (DOAC/NOAC)", "chỉnh liều", "tương tác thuốc", "chống chỉ định"]
icd10: ["Z51.81"]
specialty: "Tim mạch & Thần kinh"
tags: ["CliniPortal", "Pharmacology", "KhoDuocThu", "Tim mạch & Thần kinh"]
type: "drug"
---

# Dược Thư Lâm Sàng: Rivaroxaban (Xarelto)

> [!NOTE]
> **Nhóm dược lý:** Kháng đông đường uống trực tiếp (DOAC/NOAC) | **Mã ATC:** B01AF01 | **Chuyên khoa:** Tim mạch & Thần kinh

## 1. Cơ Chế Tác Dụng & Dược Lực Học
Rivaroxaban (Xarelto) là hoạt chất thuộc nhóm **Kháng đông đường uống trực tiếp (DOAC/NOAC)**, tác động chọn lọc trên các thụ thể đích nhằm đạt hiệu quả điều trị tối ưu trong các bệnh lý tim mạch, chuyển hóa, hồi sức hoặc nhiễm khuẩn.
