---
title: "Dược thư: Noradrenaline (Norepinephrine)"
aliases: ["Noradrenaline (Norepinephrine)", "noradrenaline", "Thuốc vận mạch co mạch alpha-1", "C01CA03"]
keywords: ["Noradrenaline (Norepinephrine)", "Thuốc vận mạch co mạch alpha-1", "chỉnh liều", "tương tác thuốc", "chống chỉ định"]
icd10: ["Z51.81"]
specialty: "Hồi sức - Cấp cứu"
tags: ["CliniPortal", "Pharmacology", "KhoDuocThu", "Hồi sức - Cấp cứu"]
type: "drug"
---

# Dược Thư Lâm Sàng: Noradrenaline (Norepinephrine)

> [!NOTE]
> **Nhóm dược lý:** Thuốc vận mạch co mạch alpha-1 | **Mã ATC:** C01CA03 | **Chuyên khoa:** Hồi sức - Cấp cứu

## 1. Cơ Chế Tác Dụng & Dược Lực Học
Noradrenaline (Norepinephrine) là hoạt chất thuộc nhóm **Thuốc vận mạch co mạch alpha-1**, tác động chọn lọc trên các thụ thể đích nhằm đạt hiệu quả điều trị tối ưu trong các bệnh lý tim mạch, chuyển hóa, hồi sức hoặc nhiễm khuẩn.
