...
console.log('=== CHECKING ALL HEPATITIS GUIDELINES IN CSV ===');
guidelines.forEach(g => {
  if (g.conditionKey === 'hepatitis-b' || g.conditionKey === 'hepatitis-c' || g.title.includes('viêm gan') || g.title.includes('Viêm gan') || g.title.includes('Hepatitis')) {
    console.log(`ID: ${g.id} | Spec: ${g.specialty} | Cond: ${g.conditionKey} | ICD: ${g.icd10} | Title: ${g.title}`);
  }
});
