...
const symptomMappingFile = 'src/content/docspace/data/symptom-icd-mapping.ts';

const fullSymptomMappingContent = `/**
...
fs.writeFileSync(symptomMappingFile, fullSymptomMappingContent);
console.log('Successfully updated symptom-icd-mapping.ts for 30 diseases!');
