...
console.log('=== BẮT ĐẦU DI CHUYỂN & CHUẨN HÓA 4 KHO NỀN TẢNG ===');
...
console.log(`Tìm thấy ${all4Files.length} files trong 4 thư mục nền tảng.`);
...
// Save snapshot map
const mapPath = path.join(__dirname, 'migration_map_foundational.json');
...
console.log('\n=== TỔNG KẾT DI CHUYỂN 4 KHO NỀN TẢNG THÀNH CÔNG ===');
